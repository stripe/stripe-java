...
public class InvoiceTest extends BaseStripeTest {
  ...
  public void testDeserialize() throws Exception {
    ...
    final Invoice invoice = ApiResource.InternalGSON.fromJson(data, Invoice.class);
  ...
  public void testDeserializeWithArrayExpansions() throws Exception {
    ...
    assertEquals(
        invoice,
        ApiResource.InternalGSON.fromJson(ApiResource.InternalGSON.toJson(invoice), Invoice.class));
  }
}
