...
public class StripeCollectionTest extends BaseStripeTest {
  ...
  public void testPaginationWithStripeClient() throws StripeException {
    ...
    StripeResponse firstResponse =
        new StripeResponse(200, HttpHeaders.of(Collections.emptyMap()), "{\"object\": \"list\", \"url\": \"/v1/subscriptions\", \"data\": [{\"object\": \"subscription\", \"id\": \"1\"}], \"has_more\": true}");
    StripeResponse secondResponse =
        new StripeResponse(200, HttpHeaders.of(Collections.emptyMap()), "{\"object\": \"list\", \"url\": \"/v1/subscriptions\", \"data\": [{\"object\": \"subscription\", \"id\": \"2\"}], \"has_more\": false}");

  AtomicInteger count = new AtomicInteger(0);
  Mockito.doAnswer(new Answer<StripeResponse>() {
  ...
  }).when(spy).requestWithRetries(Mockito.<StripeRequest>any());
