...
class GeneratedExamples extends BaseStripeTest {
  ...
  public void testCustomerListPaymentMethods() throws StripeException {
    ...
    PaymentMethodCollection paymentMethods =
      resource.listPaymentMethods(params);
      ...
      com.stripe.param.checkout.SessionCreateParams
        ...
        .addShippingOption(
          com.stripe.param.checkout.SessionCreateParams.ShippingOption
            .builder()
            .setShippingRateData(
              com.stripe.param.checkout.SessionCreateParams.ShippingOption.ShippingRateData
                .builder()
                .setDisplayName("Standard")
                .setDeliveryEstimate(
                  com.stripe.param.checkout.SessionCreateParams.ShippingOption.ShippingRateData.DeliveryEstimate
                    .builder()
                    .setMinimum(
                      com.stripe.param.checkout.SessionCreateParams.ShippingOption.ShippingRateData.DeliveryEstimate.Minimum
                        .builder()
                        .setUnit(
                          com.stripe.param.checkout.SessionCreateParams.ShippingOption.ShippingRateData.DeliveryEstimate.Minimum.Unit.DAY
                        )
                        .setValue(5L)
                        .build()
                    )
                    .setMaximum(
                      com.stripe.param.checkout.SessionCreateParams.ShippingOption.ShippingRateData.DeliveryEstimate.Maximum
                        .builder()
                        .setUnit(
                          com.stripe.param.checkout.SessionCreateParams.ShippingOption.ShippingRateData.DeliveryEstimate.Maximum.Unit.DAY
                        )
                        .setValue(7L)
                        .build()
                    )
  ...
  public void testPaymentLinkListLineItems() throws StripeException {
    ...
    PaymentLinkListLineItemsParams params =
      PaymentLinkListLineItemsParams.builder().build();
  ...
  public void testTestClockCreate() throws StripeException {
    com.stripe.param.testhelpers.TestClockCreateParams params =
      com.stripe.param.testhelpers.TestClockCreateParams
        .builder()
        .setFrozenTime(123L)
        .setName("cogsworth")
        .build();
  ...
  public void testTestClockAdvance() throws StripeException {
    ...
    com.stripe.param.testhelpers.TestClockAdvanceParams params =
      com.stripe.param.testhelpers.TestClockAdvanceParams
        .builder()
        .setFrozenTime(142L)
        .build();
  ...
  public void testCustomerCreateFundingInstructions() throws StripeException {
        ...
        .setBankTransfer(
          CustomerCreateFundingInstructionsParams.BankTransfer
            ...
            .addRequestedAddressType(
              CustomerCreateFundingInstructionsParams.BankTransfer.RequestedAddressType.ZENGIN
            )
            .setType(
    ...
    FundingInstructions fundingInstructions =
      resource.createFundingInstructions(params);
      ...
      com.stripe.param.terminal.ConfigurationUpdateParams
        ...
        .setTipping(
          com.stripe.param.terminal.ConfigurationUpdateParams.Tipping
            .builder()
            .setUsd(
              com.stripe.param.terminal.ConfigurationUpdateParams.Tipping.Usd
                .builder()
                .addFixedAmount(10L)
                .build()
            )
  ...
  public void testAccountRefresh() throws StripeException {
    ...
    com.stripe.param.financialconnections.AccountRefreshParams params =
      com.stripe.param.financialconnections.AccountRefreshParams
        .builder()
        .addFeature(
          com.stripe.param.financialconnections.AccountRefreshParams.Feature.BALANCE
        )
        .build();
  ...
  public void testAccountDisconnect() throws StripeException {
    ...
    com.stripe.param.financialconnections.AccountDisconnectParams params =
      com.stripe.param.financialconnections.AccountDisconnectParams
        .builder()
        .build();

    com.stripe.model.financialconnections.Account account =
      resource.disconnect(params);
    assertNotNull(account);
    verifyRequest(
      ApiResource.RequestMethod.POST,
      ...
      com.stripe.param.financialconnections.SessionCreateParams
        ...
        .setAccountHolder(
          com.stripe.param.financialconnections.SessionCreateParams.AccountHolder
            .builder()
            .setType(
              com.stripe.param.financialconnections.SessionCreateParams.AccountHolder.Type.CUSTOMER
            )
            .setCustomer("cus_123")
            .build()
        )
  ...
  public void testAccountListOwners() throws StripeException {
    ...
    com.stripe.param.financialconnections.AccountListOwnersParams params =
      com.stripe.param.financialconnections.AccountListOwnersParams
        .builder()
  ...
  public void testInboundTransferFail() throws StripeException {
    ...
    com.stripe.param.treasury.InboundTransferFailParams params =
      com.stripe.param.treasury.InboundTransferFailParams
        .builder()
        .setFailureDetails(
          com.stripe.param.treasury.InboundTransferFailParams.FailureDetails
            .builder()
            .setCode(
              com.stripe.param.treasury.InboundTransferFailParams.FailureDetails.Code.ACCOUNT_CLOSED
            )
            .build()
        )
        .build();
  ...
  @Test
  public void testInboundTransferReturnInboundTransfer()
      throws StripeException {
    com.stripe.model.treasury.InboundTransfer resource =
      com.stripe.model.treasury.InboundTransfer.retrieve("ibt_123");
    com.stripe.param.treasury.InboundTransferReturnInboundTransferParams params =
      com.stripe.param.treasury.InboundTransferReturnInboundTransferParams
        .builder()
        .build();
  ...
  @Test
  public void testOutboundTransferReturnOutboundTransfer()
      throws StripeException {
    com.stripe.model.treasury.OutboundTransfer resource =
      com.stripe.model.treasury.OutboundTransfer.retrieve("obt_123");
    com.stripe.param.treasury.OutboundTransferReturnOutboundTransferParams params =
      com.stripe.param.treasury.OutboundTransferReturnOutboundTransferParams
        .builder()
        .setReturnedDetails(
          com.stripe.param.treasury.OutboundTransferReturnOutboundTransferParams.ReturnedDetails
            .builder()
            .setCode(
              com.stripe.param.treasury.OutboundTransferReturnOutboundTransferParams.ReturnedDetails.Code.ACCOUNT_CLOSED
            )
            .build()
        )
        .build();
  ...
  public void testReceivedCreditCreate() throws StripeException {
    com.stripe.param.treasury.ReceivedCreditCreateParams params =
      com.stripe.param.treasury.ReceivedCreditCreateParams
        .builder()
        .setFinancialAccount("fa_123")
        .setNetwork(
          com.stripe.param.treasury.ReceivedCreditCreateParams.Network.ACH
        )
        .setAmount(1234L)
        .setCurrency("usd")
        .build();
  ...
  public void testReceivedDebitCreate() throws StripeException {
    com.stripe.param.treasury.ReceivedDebitCreateParams params =
      com.stripe.param.treasury.ReceivedDebitCreateParams
        .builder()
        .setFinancialAccount("fa_123")
        .setNetwork(
          com.stripe.param.treasury.ReceivedDebitCreateParams.Network.ACH
        )
        .setAmount(1234L)
        .setCurrency("usd")
        .build();
      ...
      com.stripe.param.apps.SecretCreateParams
        ...
        .setScope(
          com.stripe.param.apps.SecretCreateParams.Scope
            .builder()
            .setType(
              com.stripe.param.apps.SecretCreateParams.Scope.Type.ACCOUNT
            )
            .build()
        )
        .build();

    com.stripe.model.apps.Secret secret =
      com.stripe.model.apps.Secret.create(params);
  ...
  public void testSecretFind() throws StripeException {
    ...
    com.stripe.model.apps.Secret secret =
      com.stripe.model.apps.Secret.find(params);
    assertNotNull(secret);
    verifyRequest(
      ApiResource.RequestMethod.GET,
  ...
  public void testSecretDeleteWhere() throws StripeException {
      ...
      com.stripe.param.apps.SecretDeleteWhereParams
        ...
        .setScope(
          com.stripe.param.apps.SecretDeleteWhereParams.Scope
            .builder()
            .setType(
              com.stripe.param.apps.SecretDeleteWhereParams.Scope.Type.ACCOUNT
            )
            .build()
        )
        .build();
    ...
    com.stripe.model.apps.Secret secret =
      com.stripe.model.apps.Secret.deleteWhere(params);
    assertNotNull(secret);
    verifyRequest(
      ApiResource.RequestMethod.POST,
  ...
  public void testCustomerList() throws StripeException {
    CustomerListParams params =
      CustomerListParams.builder().setLimit(3L).build();
  ...
  public void testFileLinkList() throws StripeException {
    FileLinkListParams params =
      FileLinkListParams.builder().setLimit(3L).build();
  ...
  public void testSetupIntentList() throws StripeException {
    SetupIntentListParams params =
      SetupIntentListParams.builder().setLimit(3L).build();
  ...
  public void testRefundCreate() throws StripeException {
    RefundCreateParams params =
      RefundCreateParams.builder().setCharge("ch_xxxxxxxxxxxxx").build();
  ...
  public void testTokenCreate3() throws StripeException {
    TokenCreateParams params =
      TokenCreateParams
        .builder()
        .setPii(
          TokenCreateParams.Pii.builder().setIdNumber("000000000").build()
        )
        .build();
  ...
  public void testTokenCreate6() throws StripeException {
    TokenCreateParams params =
      TokenCreateParams
        .builder()
        .setCvcUpdate(
          TokenCreateParams.CvcUpdate.builder().setCvc("123").build()
        )
        .build();
  ...
  public void testTaxRateUpdate() throws StripeException {
    ...
    TaxRateUpdateParams params =
      TaxRateUpdateParams.builder().setActive(false).build();
  ...
  public void testSessionList() throws StripeException {
    com.stripe.param.checkout.SessionListParams params =
      com.stripe.param.checkout.SessionListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testPaymentLinkUpdate() throws StripeException {
    ...
    PaymentLinkUpdateParams params =
      PaymentLinkUpdateParams.builder().setActive(false).build();
  ...
  public void testPaymentLinkList() throws StripeException {
    PaymentLinkListParams params =
      PaymentLinkListParams.builder().setLimit(3L).build();
  ...
  public void testCreditNoteRetrieve() throws StripeException {
    ...
    verifyRequest(
      ApiResource.RequestMethod.GET,
      "/v1/credit_notes/cn_xxxxxxxxxxxxx"
    );
  }
  @Test
  ...
  public void testCreditNoteLineItemList() throws StripeException {
    ...
    CreditNoteLineItemCollection creditNoteLineItems =
      creditNote.getLines().list(params);
  ...
  public void testCreditNoteList() throws StripeException {
    CreditNoteListParams params =
      CreditNoteListParams.builder().setLimit(3L).build();
      ...
      com.stripe.param.billingportal.ConfigurationCreateParams
        ...
        .setFeatures(
          com.stripe.param.billingportal.ConfigurationCreateParams.Features
            .builder()
            .setCustomerUpdate(
              com.stripe.param.billingportal.ConfigurationCreateParams.Features.CustomerUpdate
                .builder()
                .addAllowedUpdate(
                  com.stripe.param.billingportal.ConfigurationCreateParams.Features.CustomerUpdate.AllowedUpdate.EMAIL
                )
                .addAllowedUpdate(
                  com.stripe.param.billingportal.ConfigurationCreateParams.Features.CustomerUpdate.AllowedUpdate.TAX_ID
                )
                .setEnabled(true)
                .build()
            )
            .setInvoiceHistory(
              com.stripe.param.billingportal.ConfigurationCreateParams.Features.InvoiceHistory
                .builder()
                .setEnabled(true)
                .build()
            )
        ...
        .setBusinessProfile(
          com.stripe.param.billingportal.ConfigurationCreateParams.BusinessProfile
            .builder()
  ...
  public void testConfigurationUpdate2() throws StripeException {
    com.stripe.model.billingportal.Configuration resource =
      com.stripe.model.billingportal.Configuration.retrieve(
        "bpc_xxxxxxxxxxxxx"
      );
  ...
  public void testConfigurationList2() throws StripeException {
    com.stripe.param.billingportal.ConfigurationListParams params =
      com.stripe.param.billingportal.ConfigurationListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testInvoiceVoidInvoice() throws StripeException {
    ...
    InvoiceVoidInvoiceParams params =
      InvoiceVoidInvoiceParams.builder().build();
  ...
  public void testInvoiceItemList() throws StripeException {
    InvoiceItemListParams params =
      InvoiceItemListParams.builder().setLimit(3L).build();
  ...
  public void testQuoteFinalizeQuote() throws StripeException {
    Quote resource = Quote.retrieve("qt_xxxxxxxxxxxxx");
    QuoteFinalizeQuoteParams params =
      QuoteFinalizeQuoteParams.builder().build();
  ...
  public void testSubscriptionItemRetrieve() throws StripeException {
    SubscriptionItem subscriptionItem =
      SubscriptionItem.retrieve("si_xxxxxxxxxxxxx");
    assertNotNull(subscriptionItem);
    verifyRequest(
      ApiResource.RequestMethod.GET,
  ...
  public void testSubscriptionItemDelete() throws StripeException {
    ...
    SubscriptionItemDeleteParams params =
      SubscriptionItemDeleteParams.builder().build();
  ...
  public void testTestClockList2() throws StripeException {
    com.stripe.param.testhelpers.TestClockListParams params =
      com.stripe.param.testhelpers.TestClockListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testApplicationFeeRetrieve() throws StripeException {
    ApplicationFee applicationFee =
      ApplicationFee.retrieve("fee_xxxxxxxxxxxxx");
  ...
  public void testFeeRefundCreate() throws StripeException {
    ...
    FeeRefundCollectionCreateParams params =
      FeeRefundCollectionCreateParams.builder().build();
  ...
  public void testFeeRefundRetrieve() throws StripeException {
    ...
    FeeRefund feeRefund =
      applicationFee.getRefunds().retrieve("fr_xxxxxxxxxxxxx");
    assertNotNull(feeRefund);
    verifyRequest(
      ApiResource.RequestMethod.GET,
  ...
  public void testCapabilityUpdate() throws StripeException {
    ...
    CapabilityUpdateParams params =
      CapabilityUpdateParams.builder().setRequested(true).build();
  ...
  public void testCountrySpecList() throws StripeException {
    CountrySpecListParams params =
      CountrySpecListParams.builder().setLimit(3L).build();
  ...
  public void testPersonList() throws StripeException {
    ...
    PersonCollectionListParams params =
      PersonCollectionListParams.builder().setLimit(3L).build();
  ...
  public void testTransferList() throws StripeException {
    TransferListParams params =
      TransferListParams.builder().setLimit(3L).build();
  ...
  public void testTransferReversalRetrieve() throws StripeException {
    ...
    TransferReversal transferReversal =
      transfer.getReversals().retrieve("trr_xxxxxxxxxxxxx");
    assertNotNull(transferReversal);
    verifyRequest(
      ApiResource.RequestMethod.GET,
  ...
  public void testEarlyFraudWarningList() throws StripeException {
    com.stripe.param.radar.EarlyFraudWarningListParams params =
      com.stripe.param.radar.EarlyFraudWarningListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testValueListCreate() throws StripeException {
    com.stripe.param.radar.ValueListCreateParams params =
      com.stripe.param.radar.ValueListCreateParams
        ...
        .setItemType(
          com.stripe.param.radar.ValueListCreateParams.ItemType.IP_ADDRESS
        )
        .build();

    com.stripe.model.radar.ValueList valueList =
      com.stripe.model.radar.ValueList.create(params);
  ...
  public void testValueListUpdate() throws StripeException {
    ...
    com.stripe.param.radar.ValueListUpdateParams params =
      com.stripe.param.radar.ValueListUpdateParams
        .builder()
  ...
  public void testValueListItemCreate() throws StripeException {
    com.stripe.param.radar.ValueListItemCreateParams params =
      com.stripe.param.radar.ValueListItemCreateParams
        .builder()
  ...
  public void testAuthorizationUpdate() throws StripeException {
    ...
    com.stripe.param.issuing.AuthorizationUpdateParams params =
      com.stripe.param.issuing.AuthorizationUpdateParams
        .builder()
        .putMetadata("order_id", "6735")
        .build();
  ...
  public void testAuthorizationList() throws StripeException {
    com.stripe.param.issuing.AuthorizationListParams params =
      com.stripe.param.issuing.AuthorizationListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testCardholderCreate() throws StripeException {
    com.stripe.param.issuing.CardholderCreateParams params =
      com.stripe.param.issuing.CardholderCreateParams
        .builder()
        .setType(
          com.stripe.param.issuing.CardholderCreateParams.Type.INDIVIDUAL
        )
        .setName("Jenny Rosen")
        .setEmail("jenny.rosen@example.com")
        .setPhoneNumber("+18888675309")
        .setBilling(
          com.stripe.param.issuing.CardholderCreateParams.Billing
            .builder()
            .setAddress(
              com.stripe.param.issuing.CardholderCreateParams.Billing.Address
                .builder()
  ...
  public void testCardholderUpdate() throws StripeException {
    ...
    com.stripe.param.issuing.CardholderUpdateParams params =
      com.stripe.param.issuing.CardholderUpdateParams
        .builder()
        .putMetadata("order_id", "6735")
        .build();
  ...
  public void testCardholderList() throws StripeException {
    com.stripe.param.issuing.CardholderListParams params =
      com.stripe.param.issuing.CardholderListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testCardCreate() throws StripeException {
    ...
    com.stripe.model.issuing.Card card =
      com.stripe.model.issuing.Card.create(params);
    assertNotNull(card);
    verifyRequest(
      ApiResource.RequestMethod.POST,
      "/v1/issuing/cards",
  ...
  public void testCardList() throws StripeException {
    ...
    com.stripe.model.issuing.CardCollection cards =
      com.stripe.model.issuing.Card.list(params);
    assertNotNull(cards);
    verifyRequest(
      ApiResource.RequestMethod.GET,
      "/v1/issuing/cards",
  ...
  public void testDisputeCreate() throws StripeException {
    com.stripe.param.issuing.DisputeCreateParams params =
      com.stripe.param.issuing.DisputeCreateParams
        .builder()
        ...
        .setEvidence(
          com.stripe.param.issuing.DisputeCreateParams.Evidence
            ...
            .setFraudulent(
              com.stripe.param.issuing.DisputeCreateParams.Evidence.Fraudulent
                .builder()
    ...
    com.stripe.model.issuing.Dispute dispute =
      com.stripe.model.issuing.Dispute.create(params);
    assertNotNull(dispute);
    verifyRequest(
      ApiResource.RequestMethod.POST,
      "/v1/issuing/disputes",
  ...
  public void testDisputeUpdate2() throws StripeException {
    ...
    com.stripe.param.issuing.DisputeUpdateParams params =
      com.stripe.param.issuing.DisputeUpdateParams
        .builder()
        .setEvidence(
          com.stripe.param.issuing.DisputeUpdateParams.Evidence
            .builder()
            .setReason(
            ...
            .setNotReceived(
              com.stripe.param.issuing.DisputeUpdateParams.Evidence.NotReceived
                ...
                .setProductType(
                  com.stripe.param.issuing.DisputeUpdateParams.Evidence.NotReceived.ProductType.MERCHANDISE
                )
                .build()
            )
            .build()
  ...
  public void testTransactionUpdate() throws StripeException {
    ...
    com.stripe.param.issuing.TransactionUpdateParams params =
      com.stripe.param.issuing.TransactionUpdateParams
        .builder()
        .putMetadata("order_id", "6735")
        .build();
  ...
  public void testTransactionList() throws StripeException {
    com.stripe.param.issuing.TransactionListParams params =
      com.stripe.param.issuing.TransactionListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testLocationCreate() throws StripeException {
    com.stripe.param.terminal.LocationCreateParams params =
      com.stripe.param.terminal.LocationCreateParams
        .builder()
        .setDisplayName("My First Store")
        .setAddress(
          com.stripe.param.terminal.LocationCreateParams.Address
            .builder()
            .setLine1("1234 Main Street")
            .setCity("San Francisco")
            .setCountry("US")
    ...
    com.stripe.model.terminal.Location location =
      com.stripe.model.terminal.Location.create(params);
  ...
  public void testLocationUpdate() throws StripeException {
    ...
    com.stripe.param.terminal.LocationUpdateParams params =
      com.stripe.param.terminal.LocationUpdateParams
        .builder()
        .setDisplayName("My First Store")
        .build();
  ...
  public void testLocationList() throws StripeException {
    com.stripe.param.terminal.LocationListParams params =
      com.stripe.param.terminal.LocationListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testReaderCreate() throws StripeException {
    com.stripe.param.terminal.ReaderCreateParams params =
      com.stripe.param.terminal.ReaderCreateParams
        .builder()
    ...
    com.stripe.model.terminal.Reader reader =
      com.stripe.model.terminal.Reader.create(params);
  ...
  public void testReaderUpdate() throws StripeException {
    ...
    com.stripe.param.terminal.ReaderUpdateParams params =
      com.stripe.param.terminal.ReaderUpdateParams
        .builder()
        .setLabel("Blue Rabbit")
        .build();
  ...
  public void testReaderProcessPaymentIntent() throws StripeException {
    ...
    com.stripe.param.terminal.ReaderProcessPaymentIntentParams params =
      com.stripe.param.terminal.ReaderProcessPaymentIntentParams
        .builder()
        .setPaymentIntent("pi_xxxxxxxxxxxxx")
        .build();

    com.stripe.model.terminal.Reader reader =
      resource.processPaymentIntent(params);
    assertNotNull(reader);
    verifyRequest(
      ApiResource.RequestMethod.POST,
  ...
  public void testReaderProcessSetupIntent() throws StripeException {
    ...
    com.stripe.model.terminal.Reader reader =
      resource.processSetupIntent(params);
    assertNotNull(reader);
    verifyRequest(
      ApiResource.RequestMethod.POST,
  ...
  public void testConfigurationCreate3() throws StripeException {
    com.stripe.param.terminal.ConfigurationCreateParams params =
      com.stripe.param.terminal.ConfigurationCreateParams
        .builder()
        .setBbposWiseposE(
          com.stripe.param.terminal.ConfigurationCreateParams.BbposWiseposE
            .builder()
  ...
  public void testConfigurationUpdate3() throws StripeException {
    ...
    com.stripe.param.terminal.ConfigurationUpdateParams params =
      com.stripe.param.terminal.ConfigurationUpdateParams
        .builder()
        .setBbposWiseposE(
          com.stripe.param.terminal.ConfigurationUpdateParams.BbposWiseposE
            .builder()
            .setSplashscreen("file_xxxxxxxxxxxxx")
            .build()
        )
  ...
  public void testConfigurationList3() throws StripeException {
    com.stripe.param.terminal.ConfigurationListParams params =
      com.stripe.param.terminal.ConfigurationListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testFinancialAccountUpdate() throws StripeException {
    ...
    com.stripe.param.treasury.FinancialAccountUpdateParams params =
      com.stripe.param.treasury.FinancialAccountUpdateParams
        .builder()
        .putMetadata("order_id", "6735")
        .build();
  ...
  public void testFinancialAccountList() throws StripeException {
    com.stripe.param.treasury.FinancialAccountListParams params =
      com.stripe.param.treasury.FinancialAccountListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testFinancialAccountRetrieveFeatures() throws StripeException {
    ...
    com.stripe.param.treasury.FinancialAccountRetrieveFeaturesParams params =
      com.stripe.param.treasury.FinancialAccountRetrieveFeaturesParams
        .builder()
        .build();
  ...
  public void testTransactionEntryRetrieve() throws StripeException {
    com.stripe.model.treasury.TransactionEntry transactionEntry =
      com.stripe.model.treasury.TransactionEntry.retrieve(
        "trxne_xxxxxxxxxxxxx"
      );
  ...
  public void testTransactionEntryList() throws StripeException {
    com.stripe.param.treasury.TransactionEntryListParams params =
      com.stripe.param.treasury.TransactionEntryListParams
        .builder()
        .setFinancialAccount("fa_xxxxxxxxxxxxx")
        .setLimit(3L)
        .build();
  ...
  public void testOutboundTransferList() throws StripeException {
    com.stripe.param.treasury.OutboundTransferListParams params =
      com.stripe.param.treasury.OutboundTransferListParams
        .builder()
        .setFinancialAccount("fa_xxxxxxxxxxxxx")
        .setLimit(3L)
        .build();
  ...
  public void testOutboundPaymentList() throws StripeException {
    com.stripe.param.treasury.OutboundPaymentListParams params =
      com.stripe.param.treasury.OutboundPaymentListParams
        .builder()
        .setFinancialAccount("fa_xxxxxxxxxxxxx")
        .setLimit(3L)
        .build();
  ...
  public void testInboundTransferCreate() throws StripeException {
    com.stripe.param.treasury.InboundTransferCreateParams params =
      com.stripe.param.treasury.InboundTransferCreateParams
        .builder()
        .setFinancialAccount("fa_xxxxxxxxxxxxx")
        .setAmount(10000L)
        .setCurrency("usd")
  ...
  public void testInboundTransferList() throws StripeException {
    com.stripe.param.treasury.InboundTransferListParams params =
      com.stripe.param.treasury.InboundTransferListParams
        .builder()
        .setFinancialAccount("fa_xxxxxxxxxxxxx")
        .setLimit(3L)
        .build();
  ...
  public void testReceivedCreditList() throws StripeException {
    com.stripe.param.treasury.ReceivedCreditListParams params =
      com.stripe.param.treasury.ReceivedCreditListParams
        .builder()
        .setFinancialAccount("fa_xxxxxxxxxxxxx")
        .setLimit(3L)
        .build();
  ...
  public void testReceivedDebitList() throws StripeException {
    com.stripe.param.treasury.ReceivedDebitListParams params =
      com.stripe.param.treasury.ReceivedDebitListParams
        .builder()
        .setFinancialAccount("fa_xxxxxxxxxxxxx")
        .setLimit(3L)
        .build();
  ...
  public void testCreditReversalCreate() throws StripeException {
    com.stripe.param.treasury.CreditReversalCreateParams params =
      com.stripe.param.treasury.CreditReversalCreateParams
        .builder()
  ...
  public void testCreditReversalRetrieve() throws StripeException {
    com.stripe.model.treasury.CreditReversal creditReversal =
      com.stripe.model.treasury.CreditReversal.retrieve(
  ...
  public void testCreditReversalList() throws StripeException {
    com.stripe.param.treasury.CreditReversalListParams params =
      com.stripe.param.treasury.CreditReversalListParams
        .builder()
        .setFinancialAccount("fa_xxxxxxxxxxxxx")
        .setLimit(3L)
        .build();
  ...
  public void testDebitReversalCreate() throws StripeException {
    com.stripe.param.treasury.DebitReversalCreateParams params =
      com.stripe.param.treasury.DebitReversalCreateParams
        .builder()
  ...
  public void testDebitReversalList() throws StripeException {
    com.stripe.param.treasury.DebitReversalListParams params =
      com.stripe.param.treasury.DebitReversalListParams
        .builder()
        .setFinancialAccount("fa_xxxxxxxxxxxxx")
        .setLimit(3L)
        .build();
  ...
  public void testSkuUpdate() throws StripeException {
    ...
    SkuUpdateParams params =
      SkuUpdateParams.builder().putMetadata("order_id", "6735").build();

    Sku sku = resource.update(params);
    assertNotNull(sku);
    verifyRequest(
      ApiResource.RequestMethod.POST,
      "/v1/skus/sku_xxxxxxxxxxxxx",
      params.toMap()
    );
  }
  @Test
  ...
  public void testScheduledQueryRunList() throws StripeException {
    com.stripe.param.sigma.ScheduledQueryRunListParams params =
      com.stripe.param.sigma.ScheduledQueryRunListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testReportRunCreate() throws StripeException {
    com.stripe.param.reporting.ReportRunCreateParams params =
      com.stripe.param.reporting.ReportRunCreateParams
        .builder()
        .setReportType("balance.summary.1")
        .setParameters(
          com.stripe.param.reporting.ReportRunCreateParams.Parameters
            .builder()
  ...
  public void testReportRunList() throws StripeException {
    com.stripe.param.reporting.ReportRunListParams params =
      com.stripe.param.reporting.ReportRunListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testAccountRetrieve3() throws StripeException {
    com.stripe.model.financialconnections.Account account =
      com.stripe.model.financialconnections.Account.retrieve(
        "fca_xxxxxxxxxxxxx"
      );
    assertNotNull(account);
    verifyRequest(
  ...
  public void testAccountList3() throws StripeException {
    com.stripe.param.financialconnections.AccountListParams params =
      com.stripe.param.financialconnections.AccountListParams
        .builder()
        .setAccountHolder(
          com.stripe.param.financialconnections.AccountListParams.AccountHolder
            .builder()
            .setCustomer("cus_xxxxxxxxxxxxx")
            .build()
        )
  ...
  public void testSessionCreate5() throws StripeException {
    com.stripe.param.financialconnections.SessionCreateParams params =
      com.stripe.param.financialconnections.SessionCreateParams
        ...
        .setFilters(
          com.stripe.param.financialconnections.SessionCreateParams.Filters
            .builder()
            .addCountry("US")
            .build()
        )
  ...
  public void testSessionRetrieve3() throws StripeException {
    com.stripe.model.financialconnections.Session session =
      com.stripe.model.financialconnections.Session.retrieve(
  ...
  public void testVerificationSessionCreate() throws StripeException {
    com.stripe.param.identity.VerificationSessionCreateParams params =
      com.stripe.param.identity.VerificationSessionCreateParams
        .builder()
        .setType(
          com.stripe.param.identity.VerificationSessionCreateParams.Type.DOCUMENT
        )
        .build();
  ...
  public void testVerificationSessionList() throws StripeException {
    com.stripe.param.identity.VerificationSessionListParams params =
      com.stripe.param.identity.VerificationSessionListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testVerificationSessionRetrieve() throws StripeException {
    com.stripe.model.identity.VerificationSession verificationSession =
      com.stripe.model.identity.VerificationSession.retrieve(
        "vs_xxxxxxxxxxxxx"
      );
    assertNotNull(verificationSession);
    verifyRequest(
  ...
  public void testVerificationSessionUpdate() throws StripeException {
    ...
    com.stripe.param.identity.VerificationSessionUpdateParams params =
      com.stripe.param.identity.VerificationSessionUpdateParams
        .builder()
        .setType(
          com.stripe.param.identity.VerificationSessionUpdateParams.Type.ID_NUMBER
        )
        .build();
  ...
  public void testVerificationSessionCancel() throws StripeException {
    ...
    com.stripe.param.identity.VerificationSessionCancelParams params =
      com.stripe.param.identity.VerificationSessionCancelParams
        .builder()
        .build();
  ...
  public void testVerificationSessionRedact() throws StripeException {
    ...
    com.stripe.param.identity.VerificationSessionRedactParams params =
      com.stripe.param.identity.VerificationSessionRedactParams
        .builder()
        .build();

    com.stripe.model.identity.VerificationSession verificationSession =
      resource.redact(params);
    assertNotNull(verificationSession);
    verifyRequest(
      ApiResource.RequestMethod.POST,
  ...
  public void testVerificationReportList() throws StripeException {
    com.stripe.param.identity.VerificationReportListParams params =
      com.stripe.param.identity.VerificationReportListParams
        .builder()
        .setLimit(3L)
        .build();
  ...
  public void testWebhookEndpointRetrieve() throws StripeException {
    WebhookEndpoint webhookEndpoint =
      WebhookEndpoint.retrieve("we_xxxxxxxxxxxxx");
    assertNotNull(webhookEndpoint);
    verifyRequest(
      ApiResource.RequestMethod.GET,
