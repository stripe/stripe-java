...
class GeneratedExamples extends BaseStripeTest {
  ...
  public void testBalanceTransactionRetrieve() throws StripeException {
    BalanceTransaction balanceTransaction =
      BalanceTransaction.retrieve("txn_xxxxxxxxxxxxx");
  ...
  public void testOrderPay() throws StripeException {
    ...
    OrderPayParams params =
      OrderPayParams.builder().setSource("tok_xxxx").build();

    Order order = resource.pay(params);
    assertNotNull(order);
    verifyRequest(
      ApiResource.RequestMethod.POST,
      "/v1/orders/or_xxxxxxxxxxxxx/pay",
      params.toMap()
    );
  }
  @Test
  ...
  public void testOrderReturnList() throws StripeException {
    OrderReturnListParams params =
      OrderReturnListParams.builder().setLimit(3L).build();
