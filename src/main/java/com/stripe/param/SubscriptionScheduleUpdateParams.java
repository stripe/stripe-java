...
public class SubscriptionScheduleUpdateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * call, and subsequent calls adds additional elements to the original list. See {@link
     * SubscriptionScheduleUpdateParams#pauseSchedules} for the field documentation.
     */
    @SuppressWarnings("unchecked")
    public Builder addPauseSchedule(SubscriptionScheduleUpdateParams.PauseSchedule element) {
      if (this.pauseSchedules == null || this.pauseSchedules instanceof EmptyParam) {
        this.pauseSchedules = new ArrayList<SubscriptionScheduleUpdateParams.PauseSchedule>();
      }
      ((List<SubscriptionScheduleUpdateParams.PauseSchedule>) this.pauseSchedules).add(element);
      return this;
    }
    ...
    public Builder addAllPauseSchedule(
        List<SubscriptionScheduleUpdateParams.PauseSchedule> elements) {
      if (this.pauseSchedules == null || this.pauseSchedules instanceof EmptyParam) {
        this.pauseSchedules = new ArrayList<SubscriptionScheduleUpdateParams.PauseSchedule>();
      }
      ((List<SubscriptionScheduleUpdateParams.PauseSchedule>) this.pauseSchedules).addAll(elements);
      return this;
    }
  ...
  public static class DefaultSettings {
    ...
    public static class InvoiceSettings {
      ...
      public static class Builder {
         ...
         * call, and subsequent calls adds additional elements to the original list. See {@link
         * SubscriptionScheduleUpdateParams.DefaultSettings.InvoiceSettings#customFields} for the
         * field documentation.
         */
        @SuppressWarnings("unchecked")
        public Builder addCustomField(
            SubscriptionScheduleUpdateParams.DefaultSettings.InvoiceSettings.CustomField element) {
          if (this.customFields == null || this.customFields instanceof EmptyParam) {
            this.customFields =
                new ArrayList<
                    SubscriptionScheduleUpdateParams.DefaultSettings.InvoiceSettings.CustomField>();
          }
          ((List<SubscriptionScheduleUpdateParams.DefaultSettings.InvoiceSettings.CustomField>)
                  this.customFields)
              .add(element);
          return this;
        }
      ...
      public static class CustomField {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SubscriptionScheduleUpdateParams.DefaultSettings.InvoiceSettings.CustomField
              build() {
            return new SubscriptionScheduleUpdateParams.DefaultSettings.InvoiceSettings.CustomField(
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SubscriptionScheduleUpdateParams.DefaultSettings.InvoiceSettings.CustomField#extraParams}
           * for the field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
  ...
  public static class PauseSchedule {
    ...
    public static class Builder {
      ...
      public SubscriptionScheduleUpdateParams.PauseSchedule build() {
        return new SubscriptionScheduleUpdateParams.PauseSchedule(
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * SubscriptionScheduleUpdateParams.PauseSchedule#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link SubscriptionScheduleUpdateParams.PauseSchedule#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
      ...
      /** Configuration for when and how the subscription pauses. */
      public Builder setPause(SubscriptionScheduleUpdateParams.PauseSchedule.Pause pause) {
        this.pause = pause;
        return this;
      }
    ...
    public static class Pause {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public SubscriptionScheduleUpdateParams.PauseSchedule.Pause build() {
          return new SubscriptionScheduleUpdateParams.PauseSchedule.Pause(
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SubscriptionScheduleUpdateParams.PauseSchedule.Pause#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
        ...
        public Builder setPauseAt(
            SubscriptionScheduleUpdateParams.PauseSchedule.Pause.PauseAt pauseAt) {
          this.pauseAt = pauseAt;
          return this;
        }
        ...
        public Builder setSettings(
            SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings settings) {
          this.settings = settings;
          return this;
        }
      }
      ...
      public static class PauseAt {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SubscriptionScheduleUpdateParams.PauseSchedule.Pause.PauseAt build() {
            return new SubscriptionScheduleUpdateParams.PauseSchedule.Pause.PauseAt(
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SubscriptionScheduleUpdateParams.PauseSchedule.Pause.PauseAt#extraParams} for the field
           * documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
           ...
           */
          public Builder setType(
              SubscriptionScheduleUpdateParams.PauseSchedule.Pause.PauseAt.Type type) {
            this.type = type;
            return this;
          }
        }
      ...
      public static class Settings {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings build() {
            return new SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings(
                this.billFor, this.extraParams, this.invoicingBehavior, this.type);
          }

          /** Controls what to bill for when pausing the subscription. */
          public Builder setBillFor(
              SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings.BillFor billFor) {
            this.billFor = billFor;
            return this;
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings#extraParams} for the
           * field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
          ...
          /** The pause type. Currently only {@code subscription} is supported. */
          public Builder setType(
              SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings.Type type) {
            this.type = type;
            return this;
          }
        }
        ...
        public static class BillFor {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings.BillFor build() {
              return new SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings.BillFor(
             ...
             * SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings.BillFor#extraParams}
             * for the field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
            ...
            public Builder setUnusedTimeFrom(
                SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings.BillFor.UnusedTimeFrom
                    unusedTimeFrom) {
              this.unusedTimeFrom = unusedTimeFrom;
              return this;
            }
          ...
          public static class OutstandingUsageThrough {
            ...
            public static class Builder {
              ...
              /** Finalize and obtain parameter instance from this builder. */
              public SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings.BillFor
                      .OutstandingUsageThrough
                  build() {
                return new SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings.BillFor
               ...
               * `put/putAll` call, and subsequent calls add additional key/value pairs to the
               * original map. See {@link
               * SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings.BillFor.OutstandingUsageThrough#extraParams}
               * for the field documentation.
               */
              public Builder putExtraParam(String key, Object value) {
                if (this.extraParams == null) {
          ...
          public static class UnusedTimeFrom {
            ...
            public static class Builder {
               ...
               * `put/putAll` call, and subsequent calls add additional key/value pairs to the
               * original map. See {@link
               * SubscriptionScheduleUpdateParams.PauseSchedule.Pause.Settings.BillFor.UnusedTimeFrom#extraParams}
               * for the field documentation.
               */
              public Builder putExtraParam(String key, Object value) {
                if (this.extraParams == null) {
    ...
    public static class Resume {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public SubscriptionScheduleUpdateParams.PauseSchedule.Resume build() {
          return new SubscriptionScheduleUpdateParams.PauseSchedule.Resume(
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SubscriptionScheduleUpdateParams.PauseSchedule.Resume#extraParams} for
         * the field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
        ...
        public Builder setResumeAt(
            SubscriptionScheduleUpdateParams.PauseSchedule.Resume.ResumeAt resumeAt) {
          this.resumeAt = resumeAt;
          return this;
        }
        ...
        /** Settings controlling how the subscription resumes. */
        public Builder setSettings(
            SubscriptionScheduleUpdateParams.PauseSchedule.Resume.Settings settings) {
          this.settings = settings;
          return this;
        }
      }
      ...
      public static class ResumeAt {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SubscriptionScheduleUpdateParams.PauseSchedule.Resume.ResumeAt build() {
            return new SubscriptionScheduleUpdateParams.PauseSchedule.Resume.ResumeAt(
                this.duration, this.extraParams, this.timestamp, this.type);
          }
           ...
           */
          public Builder setDuration(
              SubscriptionScheduleUpdateParams.PauseSchedule.Resume.ResumeAt.Duration duration) {
            this.duration = duration;
            return this;
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SubscriptionScheduleUpdateParams.PauseSchedule.Resume.ResumeAt#extraParams} for the
           * field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
           ...
           */
          public Builder setType(
              SubscriptionScheduleUpdateParams.PauseSchedule.Resume.ResumeAt.Type type) {
            this.type = type;
            return this;
          }
        }
        ...
        public static class Duration {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public SubscriptionScheduleUpdateParams.PauseSchedule.Resume.ResumeAt.Duration build() {
              return new SubscriptionScheduleUpdateParams.PauseSchedule.Resume.ResumeAt.Duration(
                  this.extraParams, this.interval, this.intervalCount);
            }
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * SubscriptionScheduleUpdateParams.PauseSchedule.Resume.ResumeAt.Duration#extraParams}
             * for the field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
             ...
             */
            public Builder setInterval(
                SubscriptionScheduleUpdateParams.PauseSchedule.Resume.ResumeAt.Duration.Interval
                    interval) {
              this.interval = interval;
              return this;
            }
      ...
      public static class Settings {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SubscriptionScheduleUpdateParams.PauseSchedule.Resume.Settings build() {
            return new SubscriptionScheduleUpdateParams.PauseSchedule.Resume.Settings(
                this.billingCycleAnchor,
                this.extraParams,
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SubscriptionScheduleUpdateParams.PauseSchedule.Resume.Settings#extraParams} for the
           * field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
  ...
  public static class Phase {
     ...
     * on the first phase. Prefer to specify {@code now} over an explicit timestamp when appropriate
     * to avoid unexpected behavior due to request delays or clock skew resulting in the phase being
     * slightly backdated or postdated.
     */
     ...
     * combined with {@code trial=true}, it must match the phase end date.
     */
    ...
    public static class Discount {
      ...
      public static class Builder {
        ...
        /** Settings for discount application including service period anchoring. */
        public Builder setSettings(
            SubscriptionScheduleUpdateParams.Phase.Discount.Settings settings) {
          this.settings = settings;
          return this;
        }
      }
      ...
      public static class Settings {
         ...
         * with a service period duration. Defaults to {@code phase_start} if omitted.
         */
        @SerializedName("start_date")
        StartDate startDate;
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SubscriptionScheduleUpdateParams.Phase.Discount.Settings build() {
            return new SubscriptionScheduleUpdateParams.Phase.Discount.Settings(
           ...
           * Add a key/value pair to `extraParams` map. A map is initialized for the first
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link SubscriptionScheduleUpdateParams.Phase.Discount.Settings#extraParams}
           * for the field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
          ...
          public Builder setServicePeriodAnchorConfig(
              SubscriptionScheduleUpdateParams.Phase.Discount.Settings.ServicePeriodAnchorConfig
          ...
          public Builder setStartDate(
              SubscriptionScheduleUpdateParams.Phase.Discount.Settings.StartDate startDate) {
            this.startDate = startDate;
            return this;
          }
        }
        ...
        public static class ServicePeriodAnchorConfig {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public SubscriptionScheduleUpdateParams.Phase.Discount.Settings
                    .ServicePeriodAnchorConfig
                build() {
              return new SubscriptionScheduleUpdateParams.Phase.Discount.Settings
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * SubscriptionScheduleUpdateParams.Phase.Discount.Settings.ServicePeriodAnchorConfig#extraParams}
             * for the field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
          ...
          public static class Custom {
            ...
            public static class Builder {
               ...
               * `put/putAll` call, and subsequent calls add additional key/value pairs to the
               * original map. See {@link
               * SubscriptionScheduleUpdateParams.Phase.Discount.Settings.ServicePeriodAnchorConfig.Custom#extraParams}
               * for the field documentation.
               */
              public Builder putExtraParam(String key, Object value) {
                if (this.extraParams == null) {
    ...
    public static class InvoiceSettings {
      ...
      public static class Builder {
         ...
         * Add an element to `customFields` list. A list is initialized for the first `add/addAll`
         * call, and subsequent calls adds additional elements to the original list. See {@link
         * SubscriptionScheduleUpdateParams.Phase.InvoiceSettings#customFields} for the field
         * documentation.
         */
        @SuppressWarnings("unchecked")
        public Builder addCustomField(
            SubscriptionScheduleUpdateParams.Phase.InvoiceSettings.CustomField element) {
          if (this.customFields == null || this.customFields instanceof EmptyParam) {
            this.customFields =
                new ArrayList<SubscriptionScheduleUpdateParams.Phase.InvoiceSettings.CustomField>();
          }
          ((List<SubscriptionScheduleUpdateParams.Phase.InvoiceSettings.CustomField>)
                  this.customFields)
              .add(element);
          return this;
        }
        ...
        @SuppressWarnings("unchecked")
        public Builder addAllCustomField(
            List<SubscriptionScheduleUpdateParams.Phase.InvoiceSettings.CustomField> elements) {
          if (this.customFields == null || this.customFields instanceof EmptyParam) {
            this.customFields =
                new ArrayList<SubscriptionScheduleUpdateParams.Phase.InvoiceSettings.CustomField>();
          }
        ...
        /** A list of up to 4 custom fields to be displayed on the invoice. */
        public Builder setCustomFields(
            List<SubscriptionScheduleUpdateParams.Phase.InvoiceSettings.CustomField> customFields) {
          this.customFields = customFields;
          return this;
        }
      ...
      public static class CustomField {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SubscriptionScheduleUpdateParams.Phase.InvoiceSettings.CustomField build() {
            return new SubscriptionScheduleUpdateParams.Phase.InvoiceSettings.CustomField(
                this.extraParams, this.name, this.value);
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SubscriptionScheduleUpdateParams.Phase.InvoiceSettings.CustomField#extraParams} for the
           * field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
    ...
    public static class Item {
      ...
      public static class Discount {
        ...
        public static class Builder {
          ...
          /** Settings for discount application including service period anchoring. */
          public Builder setSettings(
              SubscriptionScheduleUpdateParams.Phase.Item.Discount.Settings settings) {
            this.settings = settings;
            return this;
          }
        }
        ...
        public static class Settings {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public SubscriptionScheduleUpdateParams.Phase.Item.Discount.Settings build() {
              return new SubscriptionScheduleUpdateParams.Phase.Item.Discount.Settings(
                  this.extraParams, this.servicePeriodAnchorConfig, this.startDate);
            }
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * SubscriptionScheduleUpdateParams.Phase.Item.Discount.Settings#extraParams} for the
             * field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
             ...
             */
            public Builder setStartDate(
                SubscriptionScheduleUpdateParams.Phase.Item.Discount.Settings.StartDate startDate) {
              this.startDate = startDate;
              return this;
            }
          }
          ...
          public static class ServicePeriodAnchorConfig {
            ...
            public static class Builder {
              ...
              /** Finalize and obtain parameter instance from this builder. */
              public SubscriptionScheduleUpdateParams.Phase.Item.Discount.Settings
                      .ServicePeriodAnchorConfig
                  build() {
                return new SubscriptionScheduleUpdateParams.Phase.Item.Discount.Settings
                    .ServicePeriodAnchorConfig(this.custom, this.extraParams, this.type);
               ...
               * `put/putAll` call, and subsequent calls add additional key/value pairs to the
               * original map. See {@link
               * SubscriptionScheduleUpdateParams.Phase.Item.Discount.Settings.ServicePeriodAnchorConfig#extraParams}
               * for the field documentation.
               */
              public Builder putExtraParam(String key, Object value) {
                if (this.extraParams == null) {
            ...
            public static class Custom {
              ...
              public static class Builder {
                 ...
                 * `put/putAll` call, and subsequent calls add additional key/value pairs to the
                 * original map. See {@link
                 * SubscriptionScheduleUpdateParams.Phase.Item.Discount.Settings.ServicePeriodAnchorConfig.Custom#extraParams}
                 * for the field documentation.
                 */
                public Builder putExtraParam(String key, Object value) {
                  if (this.extraParams == null) {
