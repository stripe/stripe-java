...
public class SessionCreateParams extends ApiRequestParams {
  ...
  public static class LineItem {
     ...
     *
     * <p>If using {@code price} or {@code price_data}, will default to the name of the associated product.
     */
    ...
    public static class PriceData {
      ...
      /**
       * A non-negative integer in %s representing how much to charge. One of {@code unit_amount} or {@code unit_amount_decimal} is required.
       */
  ...
  public static class PaymentIntentData {
     ...
     *
     * <p>For both values, Checkout will attach the payment method to either the provided Customer for the session, or a new Customer created by Checkout if one has not been provided.
     *
