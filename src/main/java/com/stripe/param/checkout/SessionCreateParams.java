...
public class SessionCreateParams extends ApiRequestParams {
  ...
  List<SessionCreateParams.ExcludedPaymentMethodType> excludedPaymentMethodTypes;
  ...
  public static class Builder {
    ...
    private List<SessionCreateParams.ExcludedPaymentMethodType> excludedPaymentMethodTypes;
     ...
     * `add/addAll` call, and subsequent calls adds additional elements to the original list. See
     * {@link SessionCreateParams#excludedPaymentMethodTypes} for the field documentation.
     */
    public Builder addExcludedPaymentMethodType(
        SessionCreateParams.ExcludedPaymentMethodType element) {
    ...
    public Builder addAllExcludedPaymentMethodType(
        List<SessionCreateParams.ExcludedPaymentMethodType> elements) {
      if (this.excludedPaymentMethodTypes == null) {
        this.excludedPaymentMethodTypes = new ArrayList<>();
      }
  ...
  public static class AutomaticTax {
     ...
     * is enabled.
     *
     * <p>Defaults to {@code full}, which collects the address fields needed for the most accurate
     * tax calculation. Set to {@code minimal} to collect only the fields required for tax in the
     * buyer's country, accepting potentially less precise tax calculation in exchange for a
     * streamlined form.
     *
     * <p>Only honored when {@code automatic_tax.enabled} is {@code true}, {@code
     * billing_address_collection} is {@code auto}, the resolved tax address source is the session
     * billing address, and {@code ui_mode} is {@code form}.
     */
    @SerializedName("address_collection_precision")
    AddressCollectionPrecision addressCollectionPrecision;
    ...
    private AutomaticTax(
        ...
        Map<String, Object> extraParams,
        Liability liability) {
      this.addressCollectionPrecision = addressCollectionPrecision;
      this.enabled = enabled;
      this.extraParams = extraParams;
    ...
    public static class Builder {
      private AddressCollectionPrecision addressCollectionPrecision;
      ...
      public SessionCreateParams.AutomaticTax build() {
        return new SessionCreateParams.AutomaticTax(
            this.addressCollectionPrecision, this.enabled, this.extraParams, this.liability);
      }
       ...
       * billing address, and {@code ui_mode} is {@code form}.
       */
      public Builder setAddressCollectionPrecision(
          SessionCreateParams.AutomaticTax.AddressCollectionPrecision addressCollectionPrecision) {
        this.addressCollectionPrecision = addressCollectionPrecision;
        return this;
      }
    ...
    public enum AddressCollectionPrecision implements ApiRequestParams.EnumParam {
      @SerializedName("full")
      FULL("full"),
      ...
      AddressCollectionPrecision(String value) {
        this.value = value;
      }
    }
  }
  ...
  public static class CheckoutItem {
    ...
    private CheckoutItem(
        ...
        Type type) {
      this.extraParams = extraParams;
      this.pricingPlanSubscriptionItem = pricingPlanSubscriptionItem;
    ...
    public static class Builder {
      ...
      private PricingPlanSubscriptionItem pricingPlanSubscriptionItem;
      ...
      public SessionCreateParams.CheckoutItem build() {
        return new SessionCreateParams.CheckoutItem(
            this.extraParams,
            this.pricingPlanSubscriptionItem,
            this.rateCardSubscriptionItem,
            this.type);
      }
      ...
      public Builder setPricingPlanSubscriptionItem(
          SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem
              pricingPlanSubscriptionItem) {
        this.pricingPlanSubscriptionItem = pricingPlanSubscriptionItem;
        return this;
      }
    ...
    @Getter
    @EqualsAndHashCode(callSuper = false)
    public static class PricingPlanSubscriptionItem {
      @SerializedName("component_configurations")
      Map<
              String,
              SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem.ComponentConfiguration>
      ...
      private PricingPlanSubscriptionItem(
          Map<
                  String,
                  SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem build() {
          return new SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem(
        ...
        /**
         * Add a key/value pair to `componentConfigurations` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link
         * SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem#componentConfigurations} for
         * the field documentation.
         */
        public Builder putComponentConfiguration(
            String key,
            SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem.ComponentConfiguration
                value) {
          ...
          this.componentConfigurations.put(key, value);
          return this;
        }

        /**
         * Add all map key/value pairs to `componentConfigurations` map. A map is initialized for
         * the first `put/putAll` call, and subsequent calls add additional key/value pairs to the
         * original map. See {@link
         * SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem#componentConfigurations} for
         * the field documentation.
         */
        public Builder putAllComponentConfiguration(
            Map<
                    String,
                    SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem
                        .ComponentConfiguration>
          ...
          this.componentConfigurations.putAll(map);
          return this;
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem#extraParams}
         ...
         * call, and subsequent calls add additional key/value pairs to the original map. See {@link
         * SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem#metadata} for the field
         * documentation.
         */
        public Builder putMetadata(String key, String value) {
          if (this.metadata == null) {
         ...
         * Add all map key/value pairs to `metadata` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem#metadata}
         * for the field documentation.
         */
        public Builder putAllMetadata(Map<String, String> map) {
          if (this.metadata == null) {
      ...
      public static class ComponentConfiguration {
        ...
        private ComponentConfiguration(
            Map<String, Object> extraParams, LicenseFeeComponent licenseFeeComponent, Type type) {
          this.extraParams = extraParams;
          this.licenseFeeComponent = licenseFeeComponent;
          this.type = type;
        }
        ...
        public static class Builder {
          ...
          private LicenseFeeComponent licenseFeeComponent;

          private Type type;

          /** Finalize and obtain parameter instance from this builder. */
          public SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem.ComponentConfiguration
              build() {
            return new SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem
                .ComponentConfiguration(this.extraParams, this.licenseFeeComponent, this.type);
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem.ComponentConfiguration#extraParams}
           * for the field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
          ...
          public Builder setLicenseFeeComponent(
              SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem.ComponentConfiguration
                      .LicenseFeeComponent
                  licenseFeeComponent) {
            this.licenseFeeComponent = licenseFeeComponent;
        ...
        @Getter
        @EqualsAndHashCode(callSuper = false)
        public static class LicenseFeeComponent {
          /**
           * Map of extra parameters for custom features not available in this client library. The
           * content in this map is not serialized under this field's {@code @SerializedName} value.
           * Instead, each key/value pair is serialized as if the key is a root-level field
          ...
          private LicenseFeeComponent(Map<String, Object> extraParams, Integer quantity) {
            this.extraParams = extraParams;
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem
                    .ComponentConfiguration.LicenseFeeComponent
                build() {
              return new SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem
                  .ComponentConfiguration.LicenseFeeComponent(this.extraParams, this.quantity);
            }
             ...
             * original map. See {@link
             * SessionCreateParams.CheckoutItem.PricingPlanSubscriptionItem.ComponentConfiguration.LicenseFeeComponent#extraParams}
             * for the field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
  ...
  public static class Item {
    ...
    private Item(Map<String, Object> extraParams, Subscription subscription, Type type) {
      this.extraParams = extraParams;
    ...
    public static class Builder {
      ...
      public SessionCreateParams.Item build() {
        return new SessionCreateParams.Item(this.extraParams, this.subscription, this.type);
      }
      ...
      /** Configuration for the subscription item. */
      public Builder setSubscription(SessionCreateParams.Item.Subscription subscription) {
        this.subscription = subscription;
        return this;
      }
    ...
    public static class Subscription {
      ...
      /** <strong>Required.</strong> The list of items for the subscription. */
      @SerializedName("items")
      List<SessionCreateParams.Item.Subscription.InnerItem> items;
      ...
      public static class Builder {
        ...
        private List<SessionCreateParams.Item.Subscription.InnerItem> items;

        private Map<String, String> metadata;

        private PendingInvoiceItemInterval pendingInvoiceItemInterval;
        ...
        public Builder setBillingCycleAnchorConfig(
            SessionCreateParams.Item.Subscription.BillingCycleAnchorConfig
        ...
        public Builder setBillingMode(
            SessionCreateParams.Item.Subscription.BillingMode billingMode) {
          this.billingMode = billingMode;
          return this;
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SessionCreateParams.Item.Subscription#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
         ...
         * and subsequent calls adds additional elements to the original list. See {@link
         * SessionCreateParams.Item.Subscription#items} for the field documentation.
         */
        public Builder addItem(SessionCreateParams.Item.Subscription.InnerItem element) {
          if (this.items == null) {
            this.items = new ArrayList<>();
          }
          this.items.add(element);
         ...
         * SessionCreateParams.Item.Subscription#items} for the field documentation.
         */
        public Builder addAllItem(List<SessionCreateParams.Item.Subscription.InnerItem> elements) {
          if (this.items == null) {
            this.items = new ArrayList<>();
          }
          this.items.addAll(elements);
         ...
         * Add a key/value pair to `metadata` map. A map is initialized for the first `put/putAll`
         * call, and subsequent calls add additional key/value pairs to the original map. See {@link
         * SessionCreateParams.Item.Subscription#metadata} for the field documentation.
         */
        public Builder putMetadata(String key, String value) {
          if (this.metadata == null) {
            this.metadata = new HashMap<>();
         ...
         * Add all map key/value pairs to `metadata` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SessionCreateParams.Item.Subscription#metadata} for the field
         * documentation.
         */
        public Builder putAllMetadata(Map<String, String> map) {
          if (this.metadata == null) {
        ...
        public Builder setPendingInvoiceItemInterval(
            SessionCreateParams.Item.Subscription.PendingInvoiceItemInterval
        ...
        /**
         * Determines how to handle prorations resulting from the {@code billing_cycle_anchor}. If
         * no value is passed, the default is {@code create_prorations}.
         */
        public Builder setProrationBehavior(
            SessionCreateParams.Item.Subscription.ProrationBehavior prorationBehavior) {
          this.prorationBehavior = prorationBehavior;
          return this;
        }
        ...
        public Builder setTrialSettings(
            SessionCreateParams.Item.Subscription.TrialSettings trialSettings) {
          this.trialSettings = trialSettings;
          return this;
        }
      }
      ...
      public static class BillingCycleAnchorConfig {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SessionCreateParams.Item.Subscription.BillingCycleAnchorConfig build() {
            return new SessionCreateParams.Item.Subscription.BillingCycleAnchorConfig(
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SessionCreateParams.Item.Subscription.BillingCycleAnchorConfig#extraParams} for the
           * field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
      ...
      public static class BillingMode {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SessionCreateParams.Item.Subscription.BillingMode build() {
            return new SessionCreateParams.Item.Subscription.BillingMode(
           ...
           * Add a key/value pair to `extraParams` map. A map is initialized for the first
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link SessionCreateParams.Item.Subscription.BillingMode#extraParams} for the
           * field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
          ...
          public Builder setFlexible(
              SessionCreateParams.Item.Subscription.BillingMode.Flexible flexible) {
            this.flexible = flexible;
            return this;
          }
           ...
           * invoices for subscriptions. If no value is passed, the default is {@code flexible}.
           */
          public Builder setType(SessionCreateParams.Item.Subscription.BillingMode.Type type) {
            this.type = type;
            return this;
          }
        }
        ...
        public static class Flexible {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public SessionCreateParams.Item.Subscription.BillingMode.Flexible build() {
              return new SessionCreateParams.Item.Subscription.BillingMode.Flexible(
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * SessionCreateParams.Item.Subscription.BillingMode.Flexible#extraParams} for the field
             * documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
            ...
            public Builder setProrationDiscounts(
                SessionCreateParams.Item.Subscription.BillingMode.Flexible.ProrationDiscounts
                    prorationDiscounts) {
              this.prorationDiscounts = prorationDiscounts;
              return this;
            }
      ...
      public static class InnerItem {
        ...
        public static class Builder {
           ...
           * Add a key/value pair to `extraParams` map. A map is initialized for the first
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link SessionCreateParams.Item.Subscription.InnerItem#extraParams} for the
           * field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
        ...
        public static class PriceData {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public SessionCreateParams.Item.Subscription.InnerItem.PriceData build() {
              return new SessionCreateParams.Item.Subscription.InnerItem.PriceData(
                  this.currency,
                  this.extraParams,
                  this.product,
                  this.productData,
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * SessionCreateParams.Item.Subscription.InnerItem.PriceData#extraParams} for the field
             * documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
            ...
            /**
             * Data used to generate a new <a
             * href="https://docs.stripe.com/api/products">Product</a> object inline. One of {@code
             * product} or {@code product_data} is required.
             */
            public Builder setProductData(
                SessionCreateParams.Item.Subscription.InnerItem.PriceData.ProductData productData) {
              this.productData = productData;
              return this;
            }
            ...
            public Builder setRecurring(
                SessionCreateParams.Item.Subscription.InnerItem.PriceData.Recurring recurring) {
              this.recurring = recurring;
              return this;
            }
             ...
             */
            public Builder setTaxBehavior(
                SessionCreateParams.Item.Subscription.InnerItem.PriceData.TaxBehavior taxBehavior) {
              this.taxBehavior = taxBehavior;
              return this;
            }
             ...
             * charge. One of {@code unit_amount} or {@code unit_amount_decimal} is required.
             */
          ...
          public static class ProductData {
            ...
            /**
             * Set of <a href="https://docs.stripe.com/api/metadata">key-value pairs</a> that you
             * can attach to an object. This can be useful for storing additional information about
             * the object in a structured format. Individual keys can be unset by posting an empty
             * value to them. All keys can be unset by posting an empty value to {@code metadata}.
             */
            @SerializedName("metadata")
            Map<String, String> metadata;

            /**
             * <strong>Required.</strong> The product's name, meant to be displayable to the
             * customer.
             */
            @SerializedName("name")
            String name;
            ...
            public static class Builder {
              ...
              /** Finalize and obtain parameter instance from this builder. */
              public SessionCreateParams.Item.Subscription.InnerItem.PriceData.ProductData build() {
                return new SessionCreateParams.Item.Subscription.InnerItem.PriceData.ProductData(
                    this.description,
                    this.extraParams,
                    this.images,
                    this.metadata,
              ...
              /**
               * The product's description, meant to be displayable to the customer. Use this field
               * to optionally store a long form explanation of the product being sold for your own
               * rendering purposes.
               */
              public Builder setDescription(String description) {
                this.description = description;
               ...
               * `put/putAll` call, and subsequent calls add additional key/value pairs to the
               * original map. See {@link
               * SessionCreateParams.Item.Subscription.InnerItem.PriceData.ProductData#extraParams}
               * for the field documentation.
               */
              public Builder putExtraParam(String key, Object value) {
                if (this.extraParams == null) {
              ...
              /**
               * Add an element to `images` list. A list is initialized for the first `add/addAll`
               * call, and subsequent calls adds additional elements to the original list. See
               * {@link
               * SessionCreateParams.Item.Subscription.InnerItem.PriceData.ProductData#images} for
               * the field documentation.
               */
               ...
               * `put/putAll` call, and subsequent calls add additional key/value pairs to the
               * original map. See {@link
               * SessionCreateParams.Item.Subscription.InnerItem.PriceData.ProductData#metadata} for
               * the field documentation.
               */
              public Builder putMetadata(String key, String value) {
                if (this.metadata == null) {
              ...
              public Builder setTaxDetails(
                  SessionCreateParams.Item.Subscription.InnerItem.PriceData.ProductData.TaxDetails
                      taxDetails) {
                this.taxDetails = taxDetails;
                return this;
              }
            ...
            public static class TaxDetails {
              ...
              public static class Builder {
                ...
                /** Finalize and obtain parameter instance from this builder. */
                public SessionCreateParams.Item.Subscription.InnerItem.PriceData.ProductData
                        .TaxDetails
                    build() {
                  return new SessionCreateParams.Item.Subscription.InnerItem.PriceData.ProductData
                      .TaxDetails(this.extraParams, this.performanceLocation, this.taxCode);
                }
                 ...
                 * `put/putAll` call, and subsequent calls add additional key/value pairs to the
                 * original map. See {@link
                 * SessionCreateParams.Item.Subscription.InnerItem.PriceData.ProductData.TaxDetails#extraParams}
                 * for the field documentation.
                 */
                public Builder putExtraParam(String key, Object value) {
                  if (this.extraParams == null) {
          ...
          public static class Recurring {
            ...
            public static class Builder {
              ...
              /** Finalize and obtain parameter instance from this builder. */
              public SessionCreateParams.Item.Subscription.InnerItem.PriceData.Recurring build() {
                return new SessionCreateParams.Item.Subscription.InnerItem.PriceData.Recurring(
               ...
               * `put/putAll` call, and subsequent calls add additional key/value pairs to the
               * original map. See {@link
               * SessionCreateParams.Item.Subscription.InnerItem.PriceData.Recurring#extraParams}
               * for the field documentation.
               */
              public Builder putExtraParam(String key, Object value) {
                if (this.extraParams == null) {
              ...
              public Builder setInterval(
                  SessionCreateParams.Item.Subscription.InnerItem.PriceData.Recurring.Interval
                      interval) {
                this.interval = interval;
                return this;
              }
      ...
      public static class PendingInvoiceItemInterval {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SessionCreateParams.Item.Subscription.PendingInvoiceItemInterval build() {
            return new SessionCreateParams.Item.Subscription.PendingInvoiceItemInterval(
                this.extraParams, this.interval, this.intervalCount);
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SessionCreateParams.Item.Subscription.PendingInvoiceItemInterval#extraParams} for the
           * field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
           ...
           */
          public Builder setInterval(
              SessionCreateParams.Item.Subscription.PendingInvoiceItemInterval.Interval interval) {
            this.interval = interval;
            return this;
          }

          /**
           * The number of intervals between invoices. For example, {@code interval=month} and
           * {@code interval_count=3} bills every 3 months. Maximum of one year interval allowed (1
      ...
      public static class TrialSettings {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SessionCreateParams.Item.Subscription.TrialSettings build() {
            return new SessionCreateParams.Item.Subscription.TrialSettings(
          ...
          public Builder setEndBehavior(
              SessionCreateParams.Item.Subscription.TrialSettings.EndBehavior endBehavior) {
            this.endBehavior = endBehavior;
            return this;
          }
           ...
           * Add a key/value pair to `extraParams` map. A map is initialized for the first
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link SessionCreateParams.Item.Subscription.TrialSettings#extraParams} for
           * the field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
        ...
        public static class EndBehavior {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public SessionCreateParams.Item.Subscription.TrialSettings.EndBehavior build() {
              return new SessionCreateParams.Item.Subscription.TrialSettings.EndBehavior(
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * SessionCreateParams.Item.Subscription.TrialSettings.EndBehavior#extraParams} for the
             * field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
            ...
            /**
             * <strong>Required.</strong> Indicates how the subscription should change when the
             * trial ends if the user did not provide a payment method.
             */
            public Builder setMissingPaymentMethod(
                SessionCreateParams.Item.Subscription.TrialSettings.EndBehavior.MissingPaymentMethod
    ...
    public static class PriceData {
      ...
      public static class ProductData {
        ...
        public static class Builder {
           ...
           */
          public Builder setTaxDetails(
              SessionCreateParams.LineItem.PriceData.ProductData.TaxDetails taxDetails) {
            this.taxDetails = taxDetails;
            return this;
          }
        ...
        public static class TaxDetails {
          ...
          public static class Builder {
            ...
            public SessionCreateParams.LineItem.PriceData.ProductData.TaxDetails build() {
              return new SessionCreateParams.LineItem.PriceData.ProductData.TaxDetails(
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * SessionCreateParams.LineItem.PriceData.ProductData.TaxDetails#extraParams} for the
             * field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
  ...
  public static class PaymentMethodOptions {
    ...
    public static class Builder {
      ...
      /** contains details about the Alma payment method options. */
      public Builder setAlma(SessionCreateParams.PaymentMethodOptions.Alma alma) {
        this.alma = alma;
        return this;
      }
      ...
      /** contains details about the DemoPay payment method options. */
      public Builder setDemoPay(SessionCreateParams.PaymentMethodOptions.DemoPay demoPay) {
        this.demoPay = demoPay;
        return this;
      }
      ...
      /** contains details about the PayTo payment method options. */
      public Builder setPayto(SessionCreateParams.PaymentMethodOptions.Payto payto) {
        this.payto = payto;
        return this;
      }
    ...
    public static class Affirm {
      ...
      public static class Builder {
        ...
        /** Controls when the funds will be captured from the customer's account. */
        public Builder setCaptureMethod(
            SessionCreateParams.PaymentMethodOptions.Affirm.CaptureMethod captureMethod) {
          this.captureMethod = captureMethod;
          return this;
        }
    ...
    public static class AfterpayClearpay {
      ...
      public static class Builder {
        ...
        /** Controls when the funds will be captured from the customer's account. */
        public Builder setCaptureMethod(
            SessionCreateParams.PaymentMethodOptions.AfterpayClearpay.CaptureMethod captureMethod) {
          this.captureMethod = captureMethod;
          return this;
        }
    ...
    public static class Alma {
      ...
      private Alma(CaptureMethod captureMethod, Map<String, Object> extraParams) {
        this.captureMethod = captureMethod;
        this.extraParams = extraParams;
      }
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public SessionCreateParams.PaymentMethodOptions.Alma build() {
          return new SessionCreateParams.PaymentMethodOptions.Alma(
              this.captureMethod, this.extraParams);
        }

        /** Controls when the funds will be captured from the customer's account. */
        public Builder setCaptureMethod(
            SessionCreateParams.PaymentMethodOptions.Alma.CaptureMethod captureMethod) {
          this.captureMethod = captureMethod;
          return this;
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SessionCreateParams.PaymentMethodOptions.Alma#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
    ...
    public static class AmazonPay {
      ...
      public static class Builder {
        ...
        /** Controls when the funds will be captured from the customer's account. */
        public Builder setCaptureMethod(
            SessionCreateParams.PaymentMethodOptions.AmazonPay.CaptureMethod captureMethod) {
          this.captureMethod = captureMethod;
          return this;
        }
    ...
    public static class Billie {
      ...
      private Billie(CaptureMethod captureMethod, Map<String, Object> extraParams) {
        this.captureMethod = captureMethod;
        this.extraParams = extraParams;
      }
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public SessionCreateParams.PaymentMethodOptions.Billie build() {
          return new SessionCreateParams.PaymentMethodOptions.Billie(
              this.captureMethod, this.extraParams);
        }

        /** Controls when the funds will be captured from the customer's account. */
        public Builder setCaptureMethod(
            SessionCreateParams.PaymentMethodOptions.Billie.CaptureMethod captureMethod) {
          this.captureMethod = captureMethod;
          return this;
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SessionCreateParams.PaymentMethodOptions.Billie#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
    ...
    public static class Card {
      ...
      public static class Builder {
        ...
        /** Controls when the funds will be captured from the customer's account. */
        public Builder setCaptureMethod(
            SessionCreateParams.PaymentMethodOptions.Card.CaptureMethod captureMethod) {
          this.captureMethod = captureMethod;
          return this;
        }
    ...
    public static class Cashapp {
      ...
      public static class Builder {
        ...
        /** Controls when the funds will be captured from the customer's account. */
        public Builder setCaptureMethod(
            SessionCreateParams.PaymentMethodOptions.Cashapp.CaptureMethod captureMethod) {
          this.captureMethod = captureMethod;
          return this;
        }
    ...
    public static class Crypto {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public SessionCreateParams.PaymentMethodOptions.Crypto build() {
          return new SessionCreateParams.PaymentMethodOptions.Crypto(
              this.extraParams, this.setupFutureUsage);
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SessionCreateParams.PaymentMethodOptions.Crypto#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
         ...
         */
        public Builder setSetupFutureUsage(
            SessionCreateParams.PaymentMethodOptions.Crypto.SetupFutureUsage setupFutureUsage) {
          this.setupFutureUsage = setupFutureUsage;
          return this;
        }
      }
    ...
    public static class DemoPay {
      ...
      private DemoPay(Map<String, Object> extraParams, SetupFutureUsage setupFutureUsage) {
        this.extraParams = extraParams;
        this.setupFutureUsage = setupFutureUsage;
      }
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public SessionCreateParams.PaymentMethodOptions.DemoPay build() {
          return new SessionCreateParams.PaymentMethodOptions.DemoPay(
              this.extraParams, this.setupFutureUsage);
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SessionCreateParams.PaymentMethodOptions.DemoPay#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
         ...
         */
        public Builder setSetupFutureUsage(
            SessionCreateParams.PaymentMethodOptions.DemoPay.SetupFutureUsage setupFutureUsage) {
          this.setupFutureUsage = setupFutureUsage;
          return this;
        }
      }
      ...
      public static class Builder {
        ...
        public SessionCreateParams.PaymentMethodOptions.Klarna build() {
          return new SessionCreateParams.PaymentMethodOptions.Klarna(
              this.captureMethod, this.extraParams, this.setupFutureUsage, this.subscriptions);
        }

        /** Controls when the funds will be captured from the customer's account. */
        public Builder setCaptureMethod(
            SessionCreateParams.PaymentMethodOptions.Klarna.CaptureMethod captureMethod) {
          this.captureMethod = captureMethod;
          return this;
        }
    ...
    public static class Link {
      ...
      public static class Builder {
        ...
        /** Controls when the funds will be captured from the customer's account. */
        public Builder setCaptureMethod(
            SessionCreateParams.PaymentMethodOptions.Link.CaptureMethod captureMethod) {
          this.captureMethod = captureMethod;
          return this;
        }
    ...
    public static class Mobilepay {
      ...
      public static class Builder {
        ...
        /** Controls when the funds will be captured from the customer's account. */
        public Builder setCaptureMethod(
            SessionCreateParams.PaymentMethodOptions.Mobilepay.CaptureMethod captureMethod) {
          this.captureMethod = captureMethod;
          return this;
        }
    ...
    public static class Payco {
      ...
      public static class Builder {
         ...
         */
        public Builder setSetupFutureUsage(
            SessionCreateParams.PaymentMethodOptions.Payco.SetupFutureUsage setupFutureUsage) {
          this.setupFutureUsage = setupFutureUsage;
          return this;
        }
      }
    ...
    public static class Paypal {
      ...
      public static class Builder {
         ...
         * call, and subsequent calls adds additional elements to the original list. See {@link
         * SessionCreateParams.PaymentMethodOptions.Paypal#subsellers} for the field documentation.
         */
    ...
    public static class Payto {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public SessionCreateParams.PaymentMethodOptions.Payto build() {
          return new SessionCreateParams.PaymentMethodOptions.Payto(
              this.extraParams, this.mandateOptions, this.setupFutureUsage);
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SessionCreateParams.PaymentMethodOptions.Payto#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
        ...
        /** Additional fields for Mandate creation. */
        public Builder setMandateOptions(
            SessionCreateParams.PaymentMethodOptions.Payto.MandateOptions mandateOptions) {
          this.mandateOptions = mandateOptions;
          return this;
        }
         ...
         */
        public Builder setSetupFutureUsage(
            SessionCreateParams.PaymentMethodOptions.Payto.SetupFutureUsage setupFutureUsage) {
          this.setupFutureUsage = setupFutureUsage;
          return this;
        }
      }
      ...
      public static class MandateOptions {
        ...
        public static class Builder {
          ...
          public SessionCreateParams.PaymentMethodOptions.Payto.MandateOptions build() {
            return new SessionCreateParams.PaymentMethodOptions.Payto.MandateOptions(
                this.amount,
                this.amountType,
                this.endDate,
                this.extraParams,
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SessionCreateParams.PaymentMethodOptions.Payto.MandateOptions#extraParams} for the
           * field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
    ...
    public static class Pix {
      ...
      public static class Builder {
        ...
        /** Additional fields for mandate creation. */
        public Builder setMandateOptions(
            SessionCreateParams.PaymentMethodOptions.Pix.MandateOptions mandateOptions) {
          this.mandateOptions = mandateOptions;
          return this;
        }
      ...
      public static class MandateOptions {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SessionCreateParams.PaymentMethodOptions.Pix.MandateOptions build() {
            return new SessionCreateParams.PaymentMethodOptions.Pix.MandateOptions(
                this.amount,
                this.amountIncludesIof,
                this.amountType,
                this.currency,
          ...
          /** Determines if the amount includes the IOF tax. Defaults to {@code never}. */
          public Builder setAmountIncludesIof(
              SessionCreateParams.PaymentMethodOptions.Pix.MandateOptions.AmountIncludesIof
                  amountIncludesIof) {
            this.amountIncludesIof = amountIncludesIof;
            return this;
          }
          ...
          /** Type of amount. Defaults to {@code maximum}. */
          public Builder setAmountType(
              SessionCreateParams.PaymentMethodOptions.Pix.MandateOptions.AmountType amountType) {
            this.amountType = amountType;
            return this;
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SessionCreateParams.PaymentMethodOptions.Pix.MandateOptions#extraParams} for the field
           * documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
          ...
          /** Schedule at which the future payments will be charged. Defaults to {@code monthly}. */
          public Builder setPaymentSchedule(
              SessionCreateParams.PaymentMethodOptions.Pix.MandateOptions.PaymentSchedule
                  paymentSchedule) {
            this.paymentSchedule = paymentSchedule;
            return this;
          }
    ...
    public static class RevolutPay {
      ...
      public static class Builder {
        ...
        /** Controls when the funds will be captured from the customer's account. */
        public Builder setCaptureMethod(
            SessionCreateParams.PaymentMethodOptions.RevolutPay.CaptureMethod captureMethod) {
          this.captureMethod = captureMethod;
          return this;
        }
    ...
    public static class SamsungPay {
      ...
      public static class Builder {
         ...
         */
        public Builder setSetupFutureUsage(
            SessionCreateParams.PaymentMethodOptions.SamsungPay.SetupFutureUsage setupFutureUsage) {
          this.setupFutureUsage = setupFutureUsage;
          return this;
        }
      }
    ...
    public static class Satispay {
      ...
      private Satispay(CaptureMethod captureMethod, Map<String, Object> extraParams) {
        this.captureMethod = captureMethod;
        this.extraParams = extraParams;
      }
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public SessionCreateParams.PaymentMethodOptions.Satispay build() {
          return new SessionCreateParams.PaymentMethodOptions.Satispay(
              this.captureMethod, this.extraParams);
        }

        /** Controls when the funds will be captured from the customer's account. */
        public Builder setCaptureMethod(
            SessionCreateParams.PaymentMethodOptions.Satispay.CaptureMethod captureMethod) {
          this.captureMethod = captureMethod;
          return this;
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SessionCreateParams.PaymentMethodOptions.Satispay#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
    ...
    public static class Upi {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public SessionCreateParams.PaymentMethodOptions.Upi build() {
          return new SessionCreateParams.PaymentMethodOptions.Upi(
              this.extraParams, this.mandateOptions, this.setupFutureUsage);
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SessionCreateParams.PaymentMethodOptions.Upi#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
        ...
        /** Additional fields for Mandate creation. */
        public Builder setMandateOptions(
            SessionCreateParams.PaymentMethodOptions.Upi.MandateOptions mandateOptions) {
          this.mandateOptions = mandateOptions;
          return this;
        }

        public Builder setSetupFutureUsage(
            SessionCreateParams.PaymentMethodOptions.Upi.SetupFutureUsage setupFutureUsage) {
          this.setupFutureUsage = setupFutureUsage;
          return this;
        }
      ...
      public static class MandateOptions {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SessionCreateParams.PaymentMethodOptions.Upi.MandateOptions build() {
            return new SessionCreateParams.PaymentMethodOptions.Upi.MandateOptions(
           ...
           */
          public Builder setAmountType(
              SessionCreateParams.PaymentMethodOptions.Upi.MandateOptions.AmountType amountType) {
            this.amountType = amountType;
            return this;
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SessionCreateParams.PaymentMethodOptions.Upi.MandateOptions#extraParams} for the field
           * documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
  ...
  public static class Permissions {
    ...
    /**
     * Determines which entity is allowed to update the discounts (coupons or promotion codes) that
     * apply to this session.
     *
     * <p>Default is {@code client_only}. Stripe Checkout client will automatically handle discount
     * updates. If set to {@code server_only}, only your server is allowed to update discounts.
     */
    @SerializedName("update_discounts")
    ...
    public static class Builder {
      ...
      private UpdateDiscounts updateDiscounts;

      private UpdateLineItems updateLineItems;
       ...
       *
       * <p>Default is {@code client_only}. Stripe Checkout client will automatically handle
       * discount updates. If set to {@code server_only}, only your server is allowed to update
       * discounts.
       */
      public Builder setUpdateDiscounts(
          SessionCreateParams.Permissions.UpdateDiscounts updateDiscounts) {
        this.updateDiscounts = updateDiscounts;
        return this;
      }
       ...
       * using the Stripe API.
       */
      public Builder setUpdateLineItems(
          SessionCreateParams.Permissions.UpdateLineItems updateLineItems) {
        this.updateLineItems = updateLineItems;
        return this;
      }
    ...
    public enum UpdateDiscounts implements ApiRequestParams.EnumParam {
      @SerializedName("client_only")
      CLIENT_ONLY("client_only"),
      ...
      UpdateDiscounts(String value) {
        this.value = value;
      }
    }

    public enum UpdateLineItems implements ApiRequestParams.EnumParam {
      @SerializedName("client_only")
      CLIENT_ONLY("client_only"),
  ...
  public static class SubscriptionData {
    ...
    public static class Builder {
       ...
       */
      public Builder setPendingInvoiceItemInterval(
          SessionCreateParams.SubscriptionData.PendingInvoiceItemInterval
              pendingInvoiceItemInterval) {
        this.pendingInvoiceItemInterval = pendingInvoiceItemInterval;
        return this;
      }
    ...
    public static class BillingMode {
      ...
      public static class Builder {
        ...
        public SessionCreateParams.SubscriptionData.BillingMode build() {
          return new SessionCreateParams.SubscriptionData.BillingMode(
              this.extraParams, this.flexible, this.type);
        }
        ...
        /** Configure behavior for flexible billing mode. */
        public Builder setFlexible(
            SessionCreateParams.SubscriptionData.BillingMode.Flexible flexible) {
          this.flexible = flexible;
          return this;
        }
      ...
      public static class Flexible {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SessionCreateParams.SubscriptionData.BillingMode.Flexible build() {
            return new SessionCreateParams.SubscriptionData.BillingMode.Flexible(
                this.extraParams, this.prorationDiscounts);
          }
           ...
           * Add a key/value pair to `extraParams` map. A map is initialized for the first
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link SessionCreateParams.SubscriptionData.BillingMode.Flexible#extraParams}
           * for the field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
           ...
           */
          public Builder setProrationDiscounts(
              SessionCreateParams.SubscriptionData.BillingMode.Flexible.ProrationDiscounts
                  prorationDiscounts) {
            this.prorationDiscounts = prorationDiscounts;
            return this;
          }
    ...
    public static class PendingInvoiceItemInterval {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public SessionCreateParams.SubscriptionData.PendingInvoiceItemInterval build() {
          return new SessionCreateParams.SubscriptionData.PendingInvoiceItemInterval(
              this.extraParams, this.interval, this.intervalCount);
        }
         ...
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link
         * SessionCreateParams.SubscriptionData.PendingInvoiceItemInterval#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
         ...
         */
        public Builder setInterval(
            SessionCreateParams.SubscriptionData.PendingInvoiceItemInterval.Interval interval) {
          this.interval = interval;
          return this;
        }
