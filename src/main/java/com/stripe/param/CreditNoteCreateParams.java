  ...
  public static class Refund {
    ...
    public static class Builder {
      ...
      public Builder setPaymentRecordRefund(
          CreditNoteCreateParams.Refund.PaymentRecordRefund paymentRecordRefund) {
        this.paymentRecordRefund = paymentRecordRefund;
        return this;
      }
       ...
       * {@code refund}.
       */
      public Builder setType(CreditNoteCreateParams.Refund.Type type) {
        this.type = type;
        return this;
      }
    }
    ...
    public static class PaymentRecordRefund {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public CreditNoteCreateParams.Refund.PaymentRecordRefund build() {
          return new CreditNoteCreateParams.Refund.PaymentRecordRefund(
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link CreditNoteCreateParams.Refund.PaymentRecordRefund#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
