...
public class CreditNoteCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * will be automatically applied to their next invoice.
     */
    public CreditNoteCreateParams.Builder setCreditAmount(Long creditAmount) {
     ...
     */
    public CreditNoteCreateParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public CreditNoteCreateParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     */
    public CreditNoteCreateParams.Builder putMetadata(String key, String value) {
     ...
     */
    public CreditNoteCreateParams.Builder putAllMetadata(Map<String, String> map) {
     ...
     * created for the charge associated with the invoice.
     */
    public CreditNoteCreateParams.Builder setRefundAmount(Long refundAmount) {
