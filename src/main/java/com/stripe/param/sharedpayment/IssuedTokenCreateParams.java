...
public class IssuedTokenCreateParams extends ApiRequestParams {
  ...
  public static class UsageLimits {
    ...
    public static class Builder {
      ...
      /** The recurring schedule for the shared payment token's amount usage restrictions. */
      public Builder setRecurring(IssuedTokenCreateParams.UsageLimits.Recurring recurring) {
        this.recurring = recurring;
        return this;
      }
      ...
      public Builder setRecurringInterval(
          IssuedTokenCreateParams.UsageLimits.RecurringInterval recurringInterval) {
        this.recurringInterval = recurringInterval;
        return this;
      }
    }
    ...
    public static class Recurring {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public IssuedTokenCreateParams.UsageLimits.Recurring build() {
          return new IssuedTokenCreateParams.UsageLimits.Recurring(
         ...
         * map. See {@link IssuedTokenCreateParams.UsageLimits.Recurring#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
        ...
        public Builder setInterval(
            IssuedTokenCreateParams.UsageLimits.Recurring.Interval interval) {
          this.interval = interval;
          return this;
        }
