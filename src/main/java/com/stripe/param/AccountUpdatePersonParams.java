...
@Getter
public class AccountUpdatePersonParams extends ApiRequestParams {
  ...
  private AccountUpdatePersonParams(
      AdditionalTosAcceptances additionalTosAcceptances,
      Address address,
      AddressKana addressKana,
      AddressKanji addressKanji,
  ...
  public static class Builder {
    ...
    public AccountUpdatePersonParams build() {
      return new AccountUpdatePersonParams(
    ...
    public Builder setAdditionalTosAcceptances(
        AccountUpdatePersonParams.AdditionalTosAcceptances additionalTosAcceptances) {
      this.additionalTosAcceptances = additionalTosAcceptances;
      return this;
    }

    /** The person's address. */
    public Builder setAddress(AccountUpdatePersonParams.Address address) {
      this.address = address;
      return this;
    }

    /** The Kana variation of the person's address (Japan only). */
    public Builder setAddressKana(AccountUpdatePersonParams.AddressKana addressKana) {
      this.addressKana = addressKana;
      return this;
    }

    /** The Kanji variation of the person's address (Japan only). */
    public Builder setAddressKanji(AccountUpdatePersonParams.AddressKanji addressKanji) {
      this.addressKanji = addressKanji;
      return this;
    }

    /** The person's date of birth. */
    public Builder setDob(AccountUpdatePersonParams.Dob dob) {
      this.dob = dob;
      return this;
    }
    ...
    /** Documents that may be submitted to satisfy various informational requests. */
    public Builder setDocuments(AccountUpdatePersonParams.Documents documents) {
      this.documents = documents;
      return this;
    }
     ...
     * AccountUpdatePersonParams#expand} for the field documentation.
     */
     ...
     * AccountUpdatePersonParams#extraParams} for the field documentation.
     */
     ...
     * See {@link AccountUpdatePersonParams#extraParams} for the field documentation.
     */
     ...
     * AccountUpdatePersonParams#fullNameAliases} for the field documentation.
     */
     ...
     * AccountUpdatePersonParams#metadata} for the field documentation.
     */
    @SuppressWarnings("unchecked")
     ...
     * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
     * See {@link AccountUpdatePersonParams#metadata} for the field documentation.
     */
    @SuppressWarnings("unchecked")
    ...
    public Builder setRegisteredAddress(
        AccountUpdatePersonParams.RegisteredAddress registeredAddress) {
      this.registeredAddress = registeredAddress;
      return this;
    }

    /** The relationship that this person has with the account's legal entity. */
    public Builder setRelationship(AccountUpdatePersonParams.Relationship relationship) {
      this.relationship = relationship;
      return this;
    }
    ...
    /** The person's verification status. */
    public Builder setVerification(AccountUpdatePersonParams.Verification verification) {
      this.verification = verification;
      return this;
    }
  }
  ...
  public static class AdditionalTosAcceptances {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountUpdatePersonParams.AdditionalTosAcceptances build() {
        return new AccountUpdatePersonParams.AdditionalTosAcceptances(
            this.account, this.extraParams);
      }

      /** Details on the legal guardian's acceptance of the main Stripe service agreement. */
      public Builder setAccount(
          AccountUpdatePersonParams.AdditionalTosAcceptances.Account account) {
        this.account = account;
        return this;
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountUpdatePersonParams.AdditionalTosAcceptances#extraParams} for the field
       * documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountUpdatePersonParams.AdditionalTosAcceptances#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
    ...
    public static class Account {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public AccountUpdatePersonParams.AdditionalTosAcceptances.Account build() {
          return new AccountUpdatePersonParams.AdditionalTosAcceptances.Account(
         ...
         * map. See {@link AccountUpdatePersonParams.AdditionalTosAcceptances.Account#extraParams}
  ...
  public static class Address {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountUpdatePersonParams.Address build() {
        return new AccountUpdatePersonParams.Address(
            this.city,
            this.country,
            this.extraParams,
            this.line1,
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountUpdatePersonParams.Address#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountUpdatePersonParams.Address#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
  ...
  public static class AddressKana {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountUpdatePersonParams.AddressKana build() {
        return new AccountUpdatePersonParams.AddressKana(
            this.city,
            this.country,
            this.extraParams,
            this.line1,
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountUpdatePersonParams.AddressKana#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountUpdatePersonParams.AddressKana#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
  ...
  public static class AddressKanji {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountUpdatePersonParams.AddressKanji build() {
        return new AccountUpdatePersonParams.AddressKanji(
            this.city,
            this.country,
            this.extraParams,
            this.line1,
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountUpdatePersonParams.AddressKanji#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountUpdatePersonParams.AddressKanji#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
  ...
  public static class Dob {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountUpdatePersonParams.Dob build() {
        return new AccountUpdatePersonParams.Dob(this.day, this.extraParams, this.month, this.year);
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountUpdatePersonParams.Dob#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountUpdatePersonParams.Dob#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
  ...
  public static class Documents {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountUpdatePersonParams.Documents build() {
        return new AccountUpdatePersonParams.Documents(
      ...
      public Builder setCompanyAuthorization(
          AccountUpdatePersonParams.Documents.CompanyAuthorization companyAuthorization) {
        this.companyAuthorization = companyAuthorization;
        return this;
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountUpdatePersonParams.Documents#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountUpdatePersonParams.Documents#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
      ...
      /** One or more documents showing the person's passport page with photo and personal data. */
      public Builder setPassport(AccountUpdatePersonParams.Documents.Passport passport) {
        this.passport = passport;
        return this;
      }
       ...
       * they are residing.
       */
      public Builder setVisa(AccountUpdatePersonParams.Documents.Visa visa) {
        this.visa = visa;
        return this;
      }
    }
    ...
    public static class CompanyAuthorization {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public AccountUpdatePersonParams.Documents.CompanyAuthorization build() {
          return new AccountUpdatePersonParams.Documents.CompanyAuthorization(
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link AccountUpdatePersonParams.Documents.CompanyAuthorization#extraParams} for
         ...
         * AccountUpdatePersonParams.Documents.CompanyAuthorization#files} for the field
         * documentation.
         */
    ...
    public static class Passport {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public AccountUpdatePersonParams.Documents.Passport build() {
          return new AccountUpdatePersonParams.Documents.Passport(this.extraParams, this.files);
        }

        /**
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link AccountUpdatePersonParams.Documents.Passport#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
         ...
         * Add an element to `files` list. A list is initialized for the first `add/addAll` call,
         * and subsequent calls adds additional elements to the original list. See {@link
         * AccountUpdatePersonParams.Documents.Passport#files} for the field documentation.
         */
        public Builder addFile(String element) {
          if (this.files == null) {
            this.files = new ArrayList<>();
    ...
    public static class Visa {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public AccountUpdatePersonParams.Documents.Visa build() {
          return new AccountUpdatePersonParams.Documents.Visa(this.extraParams, this.files);
        }

        /**
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link AccountUpdatePersonParams.Documents.Visa#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
         ...
         * Add an element to `files` list. A list is initialized for the first `add/addAll` call,
         * and subsequent calls adds additional elements to the original list. See {@link
         * AccountUpdatePersonParams.Documents.Visa#files} for the field documentation.
         */
        public Builder addFile(String element) {
          if (this.files == null) {
            this.files = new ArrayList<>();
  ...
  public static class RegisteredAddress {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountUpdatePersonParams.RegisteredAddress build() {
        return new AccountUpdatePersonParams.RegisteredAddress(
            this.city,
            this.country,
            this.extraParams,
            this.line1,
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountUpdatePersonParams.RegisteredAddress#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountUpdatePersonParams.RegisteredAddress#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
  ...
  public static class Relationship {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountUpdatePersonParams.Relationship build() {
        return new AccountUpdatePersonParams.Relationship(
            this.director,
            this.executive,
            this.extraParams,
            this.legalGuardian,
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountUpdatePersonParams.Relationship#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountUpdatePersonParams.Relationship#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
  ...
  public static class Verification {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountUpdatePersonParams.Verification build() {
        return new AccountUpdatePersonParams.Verification(
      ...
      public Builder setAdditionalDocument(
          AccountUpdatePersonParams.Verification.AdditionalDocument additionalDocument) {
        this.additionalDocument = additionalDocument;
        return this;
      }

      /** An identifying document, either a passport or local ID card. */
      public Builder setDocument(AccountUpdatePersonParams.Verification.Document document) {
        this.document = document;
        return this;
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountUpdatePersonParams.Verification#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountUpdatePersonParams.Verification#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
    ...
    public static class AdditionalDocument {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public AccountUpdatePersonParams.Verification.AdditionalDocument build() {
          return new AccountUpdatePersonParams.Verification.AdditionalDocument(
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link AccountUpdatePersonParams.Verification.AdditionalDocument#extraParams}
         * for the field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
    ...
    public static class Document {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public AccountUpdatePersonParams.Verification.Document build() {
          return new AccountUpdatePersonParams.Verification.Document(
              this.back, this.extraParams, this.front);
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link AccountUpdatePersonParams.Verification.Document#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
