...
public class ExternalAccountCollectionCreateParams extends ApiRequestParams {
  ...
  public static ExternalAccountCollectionCreateParams.Builder builder() {
    return new ExternalAccountCollectionCreateParams.Builder();
  }
  ...
  public static class Builder {
     ...
     */
    public ExternalAccountCollectionCreateParams.Builder setDefaultForCurrency(
        Boolean defaultForCurrency) {
     ...
     */
    public ExternalAccountCollectionCreateParams.Builder addExpand(String element) {
     ...
     * ExternalAccountCollectionCreateParams#expand} for the field documentation.
     */
    public ExternalAccountCollectionCreateParams.Builder addAllExpand(List<String> list) {
    ...
    /** Please refer to full [documentation](https://stripe.com/docs/api) instead. */
    public ExternalAccountCollectionCreateParams.Builder setExternalAccount(
        String externalAccount) {
     ...
     */
    public ExternalAccountCollectionCreateParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public ExternalAccountCollectionCreateParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     */
    public ExternalAccountCollectionCreateParams.Builder putMetadata(String key, String value) {
     ...
     */
    public ExternalAccountCollectionCreateParams.Builder putAllMetadata(Map<String, String> map) {
