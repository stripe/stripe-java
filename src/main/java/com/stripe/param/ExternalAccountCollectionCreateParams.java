...
public class ExternalAccountCollectionCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * href="https://stripe.com/docs/api">documentation</a> instead.
     */
    public Builder setExternalAccount(ExternalAccountCollectionCreateParams.Card externalAccount) {
      this.externalAccount = externalAccount;
      return this;
    }
    ...
    public Builder setExternalAccount(
        ExternalAccountCollectionCreateParams.BankAccount externalAccount) {
      this.externalAccount = externalAccount;
      return this;
    }
     ...
     */
    public Builder setExternalAccount(
        ExternalAccountCollectionCreateParams.CardToken externalAccount) {
      this.externalAccount = externalAccount;
      return this;
    }
  ...
  public static class BankAccount {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public ExternalAccountCollectionCreateParams.BankAccount build() {
        return new ExternalAccountCollectionCreateParams.BankAccount(
      ...
      public Builder setAccountHolderType(
          ExternalAccountCollectionCreateParams.BankAccount.AccountHolderType accountHolderType) {
        this.accountHolderType = accountHolderType;
        return this;
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * ExternalAccountCollectionCreateParams.BankAccount#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link ExternalAccountCollectionCreateParams.BankAccount#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
  ...
  public static class Card {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public ExternalAccountCollectionCreateParams.Card build() {
        return new ExternalAccountCollectionCreateParams.Card(
            this.addressCity,
            this.addressCountry,
            this.addressLine1,
            this.addressLine2,
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * ExternalAccountCollectionCreateParams.Card#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link ExternalAccountCollectionCreateParams.Card#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
       ...
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * ExternalAccountCollectionCreateParams.Card#metadata} for the field documentation.
       */
      public Builder putMetadata(String key, String value) {
        if (this.metadata == null) {
          this.metadata = new HashMap<>();
       ...
       * Add all map key/value pairs to `metadata` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link ExternalAccountCollectionCreateParams.Card#metadata} for the field
       * documentation.
       */
      public Builder putAllMetadata(Map<String, String> map) {
        if (this.metadata == null) {
  ...
  public static class CardToken {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public ExternalAccountCollectionCreateParams.CardToken build() {
        return new ExternalAccountCollectionCreateParams.CardToken(
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * ExternalAccountCollectionCreateParams.CardToken#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link ExternalAccountCollectionCreateParams.CardToken#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
