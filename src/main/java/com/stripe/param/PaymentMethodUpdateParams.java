...
public class PaymentMethodUpdateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * method.
     */
    public Builder setKrMarket(PaymentMethodUpdateParams.KrMarket krMarket) {
      this.krMarket = krMarket;
      return this;
    }
  ...
  public static class KrMarket {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PaymentMethodUpdateParams.KrMarket build() {
        return new PaymentMethodUpdateParams.KrMarket(
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentMethodUpdateParams.KrMarket#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PaymentMethodUpdateParams.KrMarket#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
      ...
      public Builder setUnderlyingPaymentMethod(
          PaymentMethodUpdateParams.KrMarket.UnderlyingPaymentMethod underlyingPaymentMethod) {
        this.underlyingPaymentMethod = underlyingPaymentMethod;
        return this;
      }
    }
  ...
  public static class Rechnung {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PaymentMethodUpdateParams.Rechnung build() {
        return new PaymentMethodUpdateParams.Rechnung(this.dob, this.extraParams);
      }

      /** <strong>Required.</strong> Customer's date of birth */
      public Builder setDob(PaymentMethodUpdateParams.Rechnung.Dob dob) {
        this.dob = dob;
        return this;
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentMethodUpdateParams.Rechnung#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PaymentMethodUpdateParams.Rechnung#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
    ...
    public static class Dob {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public PaymentMethodUpdateParams.Rechnung.Dob build() {
          return new PaymentMethodUpdateParams.Rechnung.Dob(
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link PaymentMethodUpdateParams.Rechnung.Dob#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
