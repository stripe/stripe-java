...
public class SubscriptionItemUpdateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * SubscriptionItemUpdateParams#expand} for the field documentation.
     */
    public SubscriptionItemUpdateParams.Builder addAllExpand(List<String> list) {
     ...
     * billing cycle.
     */
    public SubscriptionItemUpdateParams.Builder setProrate(Boolean prorate) {
  ...
  public static class BillingThresholds {
    ...
    public static class Builder {
      ...
      /** Usage threshold that triggers the subscription to advance to a new billing period. */
      public SubscriptionItemUpdateParams.BillingThresholds.Builder setUsageGte(Long usageGte) {
