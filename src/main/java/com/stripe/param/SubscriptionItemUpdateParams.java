...
public class SubscriptionItemUpdateParams extends ApiRequestParams {
  ...
  public static class Discount {
    ...
    public static class Builder {
      ...
      /** Settings for discount application including service period anchoring. */
      public Builder setSettings(SubscriptionItemUpdateParams.Discount.Settings settings) {
        this.settings = settings;
        return this;
      }
    }
    ...
    public static class Settings {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public SubscriptionItemUpdateParams.Discount.Settings build() {
          return new SubscriptionItemUpdateParams.Discount.Settings(
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SubscriptionItemUpdateParams.Discount.Settings#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
        ...
        public Builder setServicePeriodAnchorConfig(
            SubscriptionItemUpdateParams.Discount.Settings.ServicePeriodAnchorConfig
        ...
        public Builder setStartDate(
            SubscriptionItemUpdateParams.Discount.Settings.StartDate startDate) {
          this.startDate = startDate;
          return this;
        }
      }
      ...
      public static class ServicePeriodAnchorConfig {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SubscriptionItemUpdateParams.Discount.Settings.ServicePeriodAnchorConfig build() {
            return new SubscriptionItemUpdateParams.Discount.Settings.ServicePeriodAnchorConfig(
                this.custom, this.extraParams, this.type);
          }

          /** Anchor the service period to a custom date. Type must be {@code custom} to specify. */
          public Builder setCustom(
              SubscriptionItemUpdateParams.Discount.Settings.ServicePeriodAnchorConfig.Custom
                  custom) {
            this.custom = custom;
            return this;
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SubscriptionItemUpdateParams.Discount.Settings.ServicePeriodAnchorConfig#extraParams}
           * for the field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
          ...
          public Builder setType(
              SubscriptionItemUpdateParams.Discount.Settings.ServicePeriodAnchorConfig.Type type) {
            this.type = type;
            return this;
          }
        }
        ...
        public static class Custom {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public SubscriptionItemUpdateParams.Discount.Settings.ServicePeriodAnchorConfig.Custom
                build() {
              return new SubscriptionItemUpdateParams.Discount.Settings.ServicePeriodAnchorConfig
                  .Custom(
                  this.dayOfMonth,
             ...
             * SubscriptionItemUpdateParams.Discount.Settings.ServicePeriodAnchorConfig.Custom#extraParams}
             * for the field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
