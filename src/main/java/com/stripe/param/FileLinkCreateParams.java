...
public class FileLinkCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public FileLinkCreateParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public FileLinkCreateParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     */
    public FileLinkCreateParams.Builder putMetadata(String key, String value) {
     ...
     */
    public FileLinkCreateParams.Builder putAllMetadata(Map<String, String> map) {
