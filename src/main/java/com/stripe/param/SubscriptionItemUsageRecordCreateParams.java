...
public class SubscriptionItemUsageRecordCreateParams extends ApiRequestParams {
  /**
  ...
  private SubscriptionItemUsageRecordCreateParams(
      Action action,
      List<String> expand,
      Map<String, Object> extraParams,
      Long quantity,
  ...
  public static class Builder {
    ...
    public SubscriptionItemUsageRecordCreateParams build() {
      return new SubscriptionItemUsageRecordCreateParams(
     ...
     * thresholds</a>, {@code increment} is the only allowed value.
     */
    public Builder setAction(SubscriptionItemUsageRecordCreateParams.Action action) {
      this.action = action;
      return this;
    }
     ...
     * SubscriptionItemUsageRecordCreateParams#expand} for the field documentation.
     */
     ...
     * SubscriptionItemUsageRecordCreateParams#extraParams} for the field documentation.
     */
     ...
     * See {@link SubscriptionItemUsageRecordCreateParams#extraParams} for the field documentation.
     */
     ...
     */
    public Builder setTimestamp(SubscriptionItemUsageRecordCreateParams.Timestamp timestamp) {
      this.timestamp = timestamp;
      return this;
    }
