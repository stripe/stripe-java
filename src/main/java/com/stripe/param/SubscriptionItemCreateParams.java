...
public class SubscriptionItemCreateParams extends ApiRequestParams {
  ...
  public static class Discount {
    ...
    public static class Builder {
      ...
      /** Settings for discount application including service period anchoring. */
      public Builder setSettings(SubscriptionItemCreateParams.Discount.Settings settings) {
        this.settings = settings;
        return this;
      }
    }
    ...
    public static class Settings {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public SubscriptionItemCreateParams.Discount.Settings build() {
          return new SubscriptionItemCreateParams.Discount.Settings(
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link SubscriptionItemCreateParams.Discount.Settings#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
        ...
        public Builder setServicePeriodAnchorConfig(
            SubscriptionItemCreateParams.Discount.Settings.ServicePeriodAnchorConfig
        ...
        public Builder setStartDate(
            SubscriptionItemCreateParams.Discount.Settings.StartDate startDate) {
          this.startDate = startDate;
          return this;
        }
      }
      ...
      public static class ServicePeriodAnchorConfig {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public SubscriptionItemCreateParams.Discount.Settings.ServicePeriodAnchorConfig build() {
            return new SubscriptionItemCreateParams.Discount.Settings.ServicePeriodAnchorConfig(
                this.custom, this.extraParams, this.type);
          }

          /** Anchor the service period to a custom date. Type must be {@code custom} to specify. */
          public Builder setCustom(
              SubscriptionItemCreateParams.Discount.Settings.ServicePeriodAnchorConfig.Custom
                  custom) {
            this.custom = custom;
            return this;
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * SubscriptionItemCreateParams.Discount.Settings.ServicePeriodAnchorConfig#extraParams}
           * for the field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
          ...
          public Builder setType(
              SubscriptionItemCreateParams.Discount.Settings.ServicePeriodAnchorConfig.Type type) {
            this.type = type;
            return this;
          }
        }
        ...
        public static class Custom {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public SubscriptionItemCreateParams.Discount.Settings.ServicePeriodAnchorConfig.Custom
                build() {
              return new SubscriptionItemCreateParams.Discount.Settings.ServicePeriodAnchorConfig
                  .Custom(
                  this.dayOfMonth,
             ...
             * SubscriptionItemCreateParams.Discount.Settings.ServicePeriodAnchorConfig.Custom#extraParams}
             * for the field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
