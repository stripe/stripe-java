...
public class AccountSessionCreateParams extends ApiRequestParams {
  ...
  public static class Components {
    ...
    private Components(
      ...
      this.capitalFinancingManualPayment = capitalFinancingManualPayment;
    ...
    public static class Builder {
      ...
      private CapitalFinancingManualPayment capitalFinancingManualPayment;
      ...
      public AccountSessionCreateParams.Components build() {
        return new AccountSessionCreateParams.Components(
            ...
            this.capitalFinancingManualPayment,
       ...
       * financing manual payment</a> embedded component.
       */
      public Builder setCapitalFinancingManualPayment(
          AccountSessionCreateParams.Components.CapitalFinancingManualPayment
    ...
    @Getter
    @EqualsAndHashCode(callSuper = false)
    public static class CapitalFinancingManualPayment {
      /** <strong>Required.</strong> Whether the embedded component is enabled. */
      @SerializedName("enabled")
      Boolean enabled;
      ...
      private CapitalFinancingManualPayment(
          Boolean enabled, Map<String, Object> extraParams, Features features) {
        this.enabled = enabled;
        this.extraParams = extraParams;
        this.features = features;
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public AccountSessionCreateParams.Components.CapitalFinancingManualPayment build() {
          return new AccountSessionCreateParams.Components.CapitalFinancingManualPayment(
              this.enabled, this.extraParams, this.features);
        }
         ...
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link
         * AccountSessionCreateParams.Components.CapitalFinancingManualPayment#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
        ...
        /** An empty list, because this embedded component has no features. */
        public Builder setFeatures(
            AccountSessionCreateParams.Components.CapitalFinancingManualPayment.Features features) {
          this.features = features;
          return this;
        }
      }
      ...
      public static class Features {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public AccountSessionCreateParams.Components.CapitalFinancingManualPayment.Features
              build() {
            return new AccountSessionCreateParams.Components.CapitalFinancingManualPayment.Features(
                this.extraParams);
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * AccountSessionCreateParams.Components.CapitalFinancingManualPayment.Features#extraParams}
           * for the field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
