...
public class ProductListParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public ProductListParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public ProductListParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     */
    public ProductListParams.Builder setStartingAfter(String startingAfter) {
  ...
  public static class Created {
    ...
    public static class Builder {
       ...
       */
      public ProductListParams.Created.Builder putExtraParam(String key, Object value) {
       ...
       */
      public ProductListParams.Created.Builder putAllExtraParam(Map<String, Object> map) {
