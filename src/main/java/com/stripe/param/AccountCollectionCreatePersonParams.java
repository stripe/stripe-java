...
@Getter
public class AccountCollectionCreatePersonParams extends ApiRequestParams {
  ...
  private AccountCollectionCreatePersonParams(
      AdditionalTosAcceptances additionalTosAcceptances,
      Address address,
      AddressKana addressKana,
      AddressKanji addressKanji,
  ...
  public static class Builder {
    ...
    public AccountCollectionCreatePersonParams build() {
      return new AccountCollectionCreatePersonParams(
    ...
    public Builder setAdditionalTosAcceptances(
        AccountCollectionCreatePersonParams.AdditionalTosAcceptances additionalTosAcceptances) {
      this.additionalTosAcceptances = additionalTosAcceptances;
      return this;
    }

    /** The person's address. */
    public Builder setAddress(AccountCollectionCreatePersonParams.Address address) {
      this.address = address;
      return this;
    }

    /** The Kana variation of the person's address (Japan only). */
    public Builder setAddressKana(AccountCollectionCreatePersonParams.AddressKana addressKana) {
      this.addressKana = addressKana;
      return this;
    }

    /** The Kanji variation of the person's address (Japan only). */
    public Builder setAddressKanji(AccountCollectionCreatePersonParams.AddressKanji addressKanji) {
      this.addressKanji = addressKanji;
      return this;
    }

    /** The person's date of birth. */
    public Builder setDob(AccountCollectionCreatePersonParams.Dob dob) {
      this.dob = dob;
      return this;
    }
    ...
    /** Documents that may be submitted to satisfy various informational requests. */
    public Builder setDocuments(AccountCollectionCreatePersonParams.Documents documents) {
      this.documents = documents;
      return this;
    }
     ...
     * AccountCollectionCreatePersonParams#expand} for the field documentation.
     */
     ...
     * AccountCollectionCreatePersonParams#extraParams} for the field documentation.
     */
     ...
     * See {@link AccountCollectionCreatePersonParams#extraParams} for the field documentation.
     */
     ...
     * AccountCollectionCreatePersonParams#fullNameAliases} for the field documentation.
     */
     ...
     * AccountCollectionCreatePersonParams#metadata} for the field documentation.
     */
    @SuppressWarnings("unchecked")
     ...
     * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
     * See {@link AccountCollectionCreatePersonParams#metadata} for the field documentation.
     */
    @SuppressWarnings("unchecked")
    ...
    public Builder setRegisteredAddress(
        AccountCollectionCreatePersonParams.RegisteredAddress registeredAddress) {
      this.registeredAddress = registeredAddress;
      return this;
    }

    /** The relationship that this person has with the account's legal entity. */
    public Builder setRelationship(AccountCollectionCreatePersonParams.Relationship relationship) {
      this.relationship = relationship;
      return this;
    }
    ...
    /** The person's verification status. */
    public Builder setVerification(AccountCollectionCreatePersonParams.Verification verification) {
      this.verification = verification;
      return this;
    }
  }
  ...
  public static class AdditionalTosAcceptances {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountCollectionCreatePersonParams.AdditionalTosAcceptances build() {
        return new AccountCollectionCreatePersonParams.AdditionalTosAcceptances(
            this.account, this.extraParams);
      }

      /** Details on the legal guardian's acceptance of the main Stripe service agreement. */
      public Builder setAccount(
          AccountCollectionCreatePersonParams.AdditionalTosAcceptances.Account account) {
        this.account = account;
        return this;
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountCollectionCreatePersonParams.AdditionalTosAcceptances#extraParams} for the field
       * documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountCollectionCreatePersonParams.AdditionalTosAcceptances#extraParams} for
    ...
    public static class Account {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public AccountCollectionCreatePersonParams.AdditionalTosAcceptances.Account build() {
          return new AccountCollectionCreatePersonParams.AdditionalTosAcceptances.Account(
         ...
         * map. See {@link
         * AccountCollectionCreatePersonParams.AdditionalTosAcceptances.Account#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
  ...
  public static class Address {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountCollectionCreatePersonParams.Address build() {
        return new AccountCollectionCreatePersonParams.Address(
            this.city,
            this.country,
            this.extraParams,
            this.line1,
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountCollectionCreatePersonParams.Address#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountCollectionCreatePersonParams.Address#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
  ...
  public static class AddressKana {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountCollectionCreatePersonParams.AddressKana build() {
        return new AccountCollectionCreatePersonParams.AddressKana(
            this.city,
            this.country,
            this.extraParams,
            this.line1,
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountCollectionCreatePersonParams.AddressKana#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountCollectionCreatePersonParams.AddressKana#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
  ...
  public static class AddressKanji {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountCollectionCreatePersonParams.AddressKanji build() {
        return new AccountCollectionCreatePersonParams.AddressKanji(
            this.city,
            this.country,
            this.extraParams,
            this.line1,
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountCollectionCreatePersonParams.AddressKanji#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountCollectionCreatePersonParams.AddressKanji#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
  ...
  public static class Dob {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountCollectionCreatePersonParams.Dob build() {
        return new AccountCollectionCreatePersonParams.Dob(
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountCollectionCreatePersonParams.Dob#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountCollectionCreatePersonParams.Dob#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
  ...
  public static class Documents {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountCollectionCreatePersonParams.Documents build() {
        return new AccountCollectionCreatePersonParams.Documents(
      ...
      public Builder setCompanyAuthorization(
          AccountCollectionCreatePersonParams.Documents.CompanyAuthorization companyAuthorization) {
        this.companyAuthorization = companyAuthorization;
        return this;
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountCollectionCreatePersonParams.Documents#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountCollectionCreatePersonParams.Documents#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
      ...
      /** One or more documents showing the person's passport page with photo and personal data. */
      public Builder setPassport(AccountCollectionCreatePersonParams.Documents.Passport passport) {
        this.passport = passport;
        return this;
      }
       ...
       * they are residing.
       */
      public Builder setVisa(AccountCollectionCreatePersonParams.Documents.Visa visa) {
        this.visa = visa;
        return this;
      }
    }
    ...
    public static class CompanyAuthorization {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public AccountCollectionCreatePersonParams.Documents.CompanyAuthorization build() {
          return new AccountCollectionCreatePersonParams.Documents.CompanyAuthorization(
         ...
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link
         * AccountCollectionCreatePersonParams.Documents.CompanyAuthorization#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
         ...
         * AccountCollectionCreatePersonParams.Documents.CompanyAuthorization#files} for the field
         * documentation.
         */
    ...
    public static class Passport {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public AccountCollectionCreatePersonParams.Documents.Passport build() {
          return new AccountCollectionCreatePersonParams.Documents.Passport(
              this.extraParams, this.files);
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link AccountCollectionCreatePersonParams.Documents.Passport#extraParams} for
         * the field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
         ...
         * Add an element to `files` list. A list is initialized for the first `add/addAll` call,
         * and subsequent calls adds additional elements to the original list. See {@link
         * AccountCollectionCreatePersonParams.Documents.Passport#files} for the field
         * documentation.
         */
        public Builder addFile(String element) {
          if (this.files == null) {
    ...
    public static class Visa {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public AccountCollectionCreatePersonParams.Documents.Visa build() {
          return new AccountCollectionCreatePersonParams.Documents.Visa(
              this.extraParams, this.files);
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link AccountCollectionCreatePersonParams.Documents.Visa#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
         ...
         * Add an element to `files` list. A list is initialized for the first `add/addAll` call,
         * and subsequent calls adds additional elements to the original list. See {@link
         * AccountCollectionCreatePersonParams.Documents.Visa#files} for the field documentation.
         */
        public Builder addFile(String element) {
          if (this.files == null) {
            this.files = new ArrayList<>();
  ...
  public static class RegisteredAddress {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountCollectionCreatePersonParams.RegisteredAddress build() {
        return new AccountCollectionCreatePersonParams.RegisteredAddress(
            this.city,
            this.country,
            this.extraParams,
            this.line1,
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountCollectionCreatePersonParams.RegisteredAddress#extraParams} for the field
       * documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountCollectionCreatePersonParams.RegisteredAddress#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
  ...
  public static class Relationship {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountCollectionCreatePersonParams.Relationship build() {
        return new AccountCollectionCreatePersonParams.Relationship(
            this.director,
            this.executive,
            this.extraParams,
            this.legalGuardian,
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountCollectionCreatePersonParams.Relationship#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountCollectionCreatePersonParams.Relationship#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
  ...
  public static class Verification {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public AccountCollectionCreatePersonParams.Verification build() {
        return new AccountCollectionCreatePersonParams.Verification(
      ...
      public Builder setAdditionalDocument(
          AccountCollectionCreatePersonParams.Verification.AdditionalDocument additionalDocument) {
        this.additionalDocument = additionalDocument;
        return this;
      }
      ...
      public Builder setDocument(
          AccountCollectionCreatePersonParams.Verification.Document document) {
        this.document = document;
        return this;
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * AccountCollectionCreatePersonParams.Verification#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link AccountCollectionCreatePersonParams.Verification#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
    ...
    public static class AdditionalDocument {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public AccountCollectionCreatePersonParams.Verification.AdditionalDocument build() {
          return new AccountCollectionCreatePersonParams.Verification.AdditionalDocument(
         ...
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link
         * AccountCollectionCreatePersonParams.Verification.AdditionalDocument#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
    ...
    public static class Document {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public AccountCollectionCreatePersonParams.Verification.Document build() {
          return new AccountCollectionCreatePersonParams.Verification.Document(
              this.back, this.extraParams, this.front);
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link AccountCollectionCreatePersonParams.Verification.Document#extraParams}
