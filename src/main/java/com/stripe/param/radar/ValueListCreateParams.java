...
public class ValueListCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public ValueListCreateParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public ValueListCreateParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     */
    public ValueListCreateParams.Builder putMetadata(String key, String value) {
     ...
     */
    public ValueListCreateParams.Builder putAllMetadata(Map<String, String> map) {
