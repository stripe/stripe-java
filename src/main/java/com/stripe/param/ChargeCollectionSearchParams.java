...
@Getter
public class ChargeCollectionSearchParams extends ApiRequestParams {
  ...
  private ChargeCollectionSearchParams(
      List<String> expand,
      Map<String, Object> extraParams,
      Boolean includeCount,
      Long limit,
  ...
  public static class Builder {
    ...
    public ChargeCollectionSearchParams build() {
      return new ChargeCollectionSearchParams(
          this.expand,
          this.extraParams,
          this.includeCount,
          this.limit,
     ...
     * ChargeCollectionSearchParams#expand} for the field documentation.
     */
     ...
     * ChargeCollectionSearchParams#extraParams} for the field documentation.
     */
     ...
     * See {@link ChargeCollectionSearchParams#extraParams} for the field documentation.
     */
