...
@Getter
public class CustomerCollectionSearchParams extends ApiRequestParams {
  ...
  private CustomerCollectionSearchParams(
      List<String> expand,
      Map<String, Object> extraParams,
      Boolean includeCount,
      Long limit,
  ...
  public static class Builder {
    ...
    public CustomerCollectionSearchParams build() {
      return new CustomerCollectionSearchParams(
          this.expand,
          this.extraParams,
          this.includeCount,
          this.limit,
     ...
     * CustomerCollectionSearchParams#expand} for the field documentation.
     */
     ...
     * CustomerCollectionSearchParams#extraParams} for the field documentation.
     */
     ...
     * See {@link CustomerCollectionSearchParams#extraParams} for the field documentation.
     */
