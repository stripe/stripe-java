...
public class ChargeCaptureParams extends ApiRequestParams {
  ...
  public static class TransferData {
    ...
    public static class Builder {
       ...
       * charge amount is transferred to the destination account.
       */
      public ChargeCaptureParams.TransferData.Builder setAmount(Long amount) {
       ...
       */
      public ChargeCaptureParams.TransferData.Builder putExtraParam(String key, Object value) {
       ...
       */
      public ChargeCaptureParams.TransferData.Builder putAllExtraParam(Map<String, Object> map) {
