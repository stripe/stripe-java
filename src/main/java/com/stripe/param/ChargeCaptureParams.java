      ...
      public static class Delivery {
        ...
        public static class Builder {
          ...
          public Builder setReceipient(
              ChargeCaptureParams.PaymentDetails.CarRental.Delivery.Receipient receipient) {
            this.receipient = receipient;
            return this;
          }
        }
        ...
        public static class Receipient {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public ChargeCaptureParams.PaymentDetails.CarRental.Delivery.Receipient build() {
              return new ChargeCaptureParams.PaymentDetails.CarRental.Delivery.Receipient(
             ...
             * ChargeCaptureParams.PaymentDetails.CarRental.Delivery.Receipient#extraParams} for the
             * field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
    ...
    public static class EventDetails {
      ...
      public static class Delivery {
        ...
        public static class Builder {
          ...
          /** Details of the recipient. */
          public Builder setReceipient(
              ChargeCaptureParams.PaymentDetails.EventDetails.Delivery.Receipient receipient) {
            this.receipient = receipient;
            return this;
          }
        }
        ...
        public static class Receipient {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public ChargeCaptureParams.PaymentDetails.EventDetails.Delivery.Receipient build() {
              return new ChargeCaptureParams.PaymentDetails.EventDetails.Delivery.Receipient(
                  this.email, this.extraParams, this.name, this.phone);
            }
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * ChargeCaptureParams.PaymentDetails.EventDetails.Delivery.Receipient#extraParams} for
             * the field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
    ...
    public static class Flight {
      ...
      public static class Delivery {
        ...
        public static class Builder {
          ...
          /** Details of the recipient. */
          public Builder setReceipient(
              ChargeCaptureParams.PaymentDetails.Flight.Delivery.Receipient receipient) {
            this.receipient = receipient;
            return this;
          }
        }
        ...
        public static class Receipient {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public ChargeCaptureParams.PaymentDetails.Flight.Delivery.Receipient build() {
              return new ChargeCaptureParams.PaymentDetails.Flight.Delivery.Receipient(
                  this.email, this.extraParams, this.name, this.phone);
            }
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * ChargeCaptureParams.PaymentDetails.Flight.Delivery.Receipient#extraParams} for the
             * field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
    ...
    public static class Lodging {
      ...
      public static class Delivery {
        ...
        public static class Builder {
          ...
          /** Details of the recipient. */
          public Builder setReceipient(
              ChargeCaptureParams.PaymentDetails.Lodging.Delivery.Receipient receipient) {
            this.receipient = receipient;
            return this;
          }
        }
        ...
        public static class Receipient {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public ChargeCaptureParams.PaymentDetails.Lodging.Delivery.Receipient build() {
              return new ChargeCaptureParams.PaymentDetails.Lodging.Delivery.Receipient(
                  this.email, this.extraParams, this.name, this.phone);
            }
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * ChargeCaptureParams.PaymentDetails.Lodging.Delivery.Receipient#extraParams} for the
             * field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
