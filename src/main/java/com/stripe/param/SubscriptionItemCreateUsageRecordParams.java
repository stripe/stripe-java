...
@Getter
public class SubscriptionItemCreateUsageRecordParams extends ApiRequestParams {
  /**
  ...
  private SubscriptionItemCreateUsageRecordParams(
      Action action,
      List<String> expand,
      Map<String, Object> extraParams,
      Long quantity,
  ...
  public static class Builder {
    ...
    public SubscriptionItemCreateUsageRecordParams build() {
      return new SubscriptionItemCreateUsageRecordParams(
     ...
     * thresholds</a>, {@code increment} is the only allowed value.
     */
    public Builder setAction(SubscriptionItemCreateUsageRecordParams.Action action) {
      this.action = action;
      return this;
    }
     ...
     * SubscriptionItemCreateUsageRecordParams#expand} for the field documentation.
     */
     ...
     * SubscriptionItemCreateUsageRecordParams#extraParams} for the field documentation.
     */
     ...
     * See {@link SubscriptionItemCreateUsageRecordParams#extraParams} for the field documentation.
     */
     ...
     */
    public Builder setTimestamp(SubscriptionItemCreateUsageRecordParams.Timestamp timestamp) {
      this.timestamp = timestamp;
      return this;
    }
