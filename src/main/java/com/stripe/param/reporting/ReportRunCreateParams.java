...
public class ReportRunCreateParams extends ApiRequestParams {
  ...
  public static class Parameters {
    ...
    public static class Builder {
       ...
       */
      public ReportRunCreateParams.Parameters.Builder addColumn(String element) {
       ...
       * ReportRunCreateParams.Parameters#columns} for the field documentation.
       */
      public ReportRunCreateParams.Parameters.Builder addAllColumn(List<String> list) {
      ...
      /** Connected account ID to filter for in the report run. */
      public ReportRunCreateParams.Parameters.Builder setConnectedAccount(String connectedAccount) {
      ...
      /** Currency of objects to be included in the report run. */
      public ReportRunCreateParams.Parameters.Builder setCurrency(String currency) {
       ...
       */
      public ReportRunCreateParams.Parameters.Builder putExtraParam(String key, Object value) {
       ...
       */
      public ReportRunCreateParams.Parameters.Builder putAllExtraParam(Map<String, Object> map) {
      ...
      /** Ending timestamp of data to be included in the report run (exclusive). */
      public ReportRunCreateParams.Parameters.Builder setIntervalEnd(Long intervalEnd) {
      ...
      /** Starting timestamp of data to be included in the report run. */
      public ReportRunCreateParams.Parameters.Builder setIntervalStart(Long intervalStart) {
      ...
      /** Payout ID by which to filter the report run. */
      public ReportRunCreateParams.Parameters.Builder setPayout(String payout) {
