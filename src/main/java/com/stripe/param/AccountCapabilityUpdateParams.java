...
public class AccountCapabilityUpdateParams extends ApiRequestParams {
  ...
  private AccountCapabilityUpdateParams(
  ...
  public static class Builder {
    ...
    public AccountCapabilityUpdateParams build() {
      return new AccountCapabilityUpdateParams(this.expand, this.extraParams, this.requested);
    }

    /**
     * Add an element to `expand` list. A list is initialized for the first `add/addAll` call, and
     * subsequent calls adds additional elements to the original list. See {@link
     * AccountCapabilityUpdateParams#expand} for the field documentation.
     */
     ...
     * AccountCapabilityUpdateParams#extraParams} for the field documentation.
     */
     ...
     * See {@link AccountCapabilityUpdateParams#extraParams} for the field documentation.
     */
