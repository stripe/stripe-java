...
public class CouponCreateParams extends ApiRequestParams {
  ...
  /**
   * Specifies how long the discount will be in effect if used on a subscription. Defaults to {@code
   * once}.
   */
  ...
  public static class Script {
    /**
     * <strong>Required.</strong> The configuration values of the script. The keys and values are
     * specific to the script implementation.
     */
    ...
    /** <strong>Required.</strong> The script implementation ID for this coupon. */
    @SerializedName("id")
    String id;

    private Script(Map<String, Object> configuration, Map<String, Object> extraParams, String id) {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public CouponCreateParams.Script build() {
        return new CouponCreateParams.Script(this.configuration, this.extraParams, this.id);
      }

      /**
       * Add a key/value pair to `configuration` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link CouponCreateParams.Script#configuration} for the field documentation.
       */
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * CouponCreateParams.Script#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link CouponCreateParams.Script#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
