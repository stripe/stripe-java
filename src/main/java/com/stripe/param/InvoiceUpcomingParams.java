...
public class InvoiceUpcomingParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public Builder addInvoiceItems(InvoiceItems element) {
     ...
     */
    public Builder addSubscriptionItems(SubscriptionItems element) {
  ...
  public static class InvoiceItems {
    ...
    public static class Builder {
       ...
       * InvoiceItems#metadata} for the field documentation.
       */
  ...
  public static class SubscriptionItems {
    ...
    public static class Builder {
       ...
       * Add a key/value pair to `metadata` map. A map is initialized for the first call, and
       * subsequent calls adds additional key/value pairs to the original map. See {@link
       * SubscriptionItems#metadata} for the field documentation.
       */
      public Builder putMetadata(String key, String value) {
        if (this.metadata == null) {
          this.metadata = new HashMap<>();
