...
public class InvoiceUpcomingParams extends ApiRequestParams {
  ...
  /**
   * The coupons to redeem into discounts for the invoice preview. If not specified, inherits the discount from the customer or subscription. This only works for coupons directly applied to the invoice. To apply a coupon to a subscription, you must use the {@code coupon} parameter instead. Pass an empty string to avoid inheriting any discounts. To preview the upcoming invoice for a subscription that hasn't been created, use {@code coupon} instead.
   */
  ...
  /**
   * Determines how to handle <a href="https://stripe.com/docs/subscriptions/billing-cycle#prorations">prorations</a> when the billing cycle changes (e.g., when switching plans, resetting {@code billing_cycle_anchor=now}, or starting a trial), or if an item's {@code quantity} changes.
   */
