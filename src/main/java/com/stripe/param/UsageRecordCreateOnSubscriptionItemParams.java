...
public class UsageRecordCreateOnSubscriptionItemParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public UsageRecordCreateOnSubscriptionItemParams.Builder addExpand(String element) {
     ...
     * UsageRecordCreateOnSubscriptionItemParams#expand} for the field documentation.
     */
    public UsageRecordCreateOnSubscriptionItemParams.Builder addAllExpand(List<String> list) {
    ...
    /** The usage quantity for the specified timestamp. */
    public UsageRecordCreateOnSubscriptionItemParams.Builder setQuantity(Long quantity) {
     ...
     */
    public UsageRecordCreateOnSubscriptionItemParams.Builder setTimestamp(Long timestamp) {
