...
public class CustomerBalanceTransactionCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * CustomerBalanceTransactionCreateParams#expand} for the field documentation.
     */
     ...
     * CustomerBalanceTransactionCreateParams#extraParams} for the field documentation.
     */
     ...
     * See {@link CustomerBalanceTransactionCreateParams#extraParams} for the field documentation.
     */
     ...
     * CustomerBalanceTransactionCreateParams#metadata} for the field documentation.
     */
     ...
     * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
     * See {@link CustomerBalanceTransactionCreateParams#metadata} for the field documentation.
     */
    @SuppressWarnings("unchecked")
