...
public class TaxIdCollectionCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * TaxIdCollectionCreateParams#expand} for the field documentation.
     */
    public TaxIdCollectionCreateParams.Builder addAllExpand(List<String> list) {
     ...
     */
    public TaxIdCollectionCreateParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public TaxIdCollectionCreateParams.Builder putAllExtraParam(Map<String, Object> map) {
