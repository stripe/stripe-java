...
public class PersonUpdateParams extends ApiRequestParams {
  ...
  public static class Builder {
    ...
    /** The person's place of birth. */
    public Builder setBirthAddress(PersonUpdateParams.BirthAddress birthAddress) {
      this.birthAddress = birthAddress;
      return this;
    }
    ...
    /** The credit applicant's self-reported yearly income in minor units. */
    public Builder setSelfReportedIncome(PersonUpdateParams.SelfReportedIncome selfReportedIncome) {
      this.selfReportedIncome = selfReportedIncome;
      return this;
    }
    ...
    public Builder setSelfReportedMonthlyHousingPayment(
        PersonUpdateParams.SelfReportedMonthlyHousingPayment selfReportedMonthlyHousingPayment) {
      this.selfReportedMonthlyHousingPayment = selfReportedMonthlyHousingPayment;
      return this;
    }
  ...
  public static class BirthAddress {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PersonUpdateParams.BirthAddress build() {
        return new PersonUpdateParams.BirthAddress(
            this.city,
            this.country,
            this.extraParams,
            this.line1,
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PersonUpdateParams.BirthAddress#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PersonUpdateParams.BirthAddress#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
  ...
  public static class SelfReportedIncome {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PersonUpdateParams.SelfReportedIncome build() {
        return new PersonUpdateParams.SelfReportedIncome(
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PersonUpdateParams.SelfReportedIncome#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PersonUpdateParams.SelfReportedIncome#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
  ...
  public static class SelfReportedMonthlyHousingPayment {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PersonUpdateParams.SelfReportedMonthlyHousingPayment build() {
        return new PersonUpdateParams.SelfReportedMonthlyHousingPayment(
            this.amount, this.currency, this.extraParams);
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PersonUpdateParams.SelfReportedMonthlyHousingPayment#extraParams} for the field
       * documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PersonUpdateParams.SelfReportedMonthlyHousingPayment#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
