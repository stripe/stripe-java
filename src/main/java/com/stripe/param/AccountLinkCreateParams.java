...
public class AccountLinkCreateParams extends ApiRequestParams {
  ...
  /**
   * Which information the platform needs to collect from the user. One of {@code currently_due} or {@code eventually_due}. Default is {@code currently_due}.
   */
  ...
  /**
   * The type of account link the user is requesting. Possible values are {@code account_onboarding} or {@code account_update}.
   */
  @SerializedName("type")
  Type type;
