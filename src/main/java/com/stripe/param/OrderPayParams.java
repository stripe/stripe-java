...
public class OrderPayParams extends ApiRequestParams {
  ...
  /**
   * The ID of an existing customer that will be charged for this order. If no customer was attached to the order at creation, either {@code source} or {@code customer} is required. Otherwise, the specified customer will be charged instead of the one attached to the order.
   */
  ...
  /**
   * A <a href="https://stripe.com/docs/api#tokens">Token</a>'s or a <a href="https://stripe.com/docs/api#sources">Source</a>'s ID, as returned by <a href="https://stripe.com/docs/elements">Elements</a>. If no customer was attached to the order at creation, either {@code source} or {@code customer} is required. Otherwise, the specified source will be charged intead of the customer attached to the order.
   */
