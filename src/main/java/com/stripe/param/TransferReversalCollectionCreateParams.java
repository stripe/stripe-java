...
public class TransferReversalCollectionCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public TransferReversalCollectionCreateParams.Builder setAmount(Long amount) {
     ...
     * reversal in the Dashboard. This will be unset if you POST an empty value.
     */
    public TransferReversalCollectionCreateParams.Builder setDescription(String description) {
     ...
     */
    public TransferReversalCollectionCreateParams.Builder addExpand(String element) {
     ...
     * TransferReversalCollectionCreateParams#expand} for the field documentation.
     */
    public TransferReversalCollectionCreateParams.Builder addAllExpand(List<String> list) {
     ...
     */
    public TransferReversalCollectionCreateParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public TransferReversalCollectionCreateParams.Builder putMetadata(String key, String value) {
     ...
     */
    public TransferReversalCollectionCreateParams.Builder putAllMetadata(Map<String, String> map) {
