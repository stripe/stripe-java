...
public class CustomerSessionCreateParams extends ApiRequestParams {
  /** <strong>Required.</strong> Configuration for each component. */
  ...
  public static class Components {
    ...
    private Components(
        Map<String, Object> extraParams, PaymentElement paymentElement, PricingTable pricingTable) {
      this.extraParams = extraParams;
    ...
    public static class Builder {
      ...
      public CustomerSessionCreateParams.Components build() {
        return new CustomerSessionCreateParams.Components(
            this.extraParams, this.paymentElement, this.pricingTable);
      }
