...
public class PaymentRecordReportPaymentAttemptGuaranteedParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * PaymentRecordReportPaymentAttemptGuaranteedParams#paymentEvaluations} for the field
     * documentation.
     */
     ...
     * {@link PaymentRecordReportPaymentAttemptGuaranteedParams#paymentEvaluations} for the field
     * documentation.
     */
    ...
    public Builder setPaymentMethodDetails(
        PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails
    ...
    public Builder setProcessorDetails(
        PaymentRecordReportPaymentAttemptGuaranteedParams.ProcessorDetails processorDetails) {
      this.processorDetails = processorDetails;
      return this;
    }
  }
  ...
  public static class PaymentMethodDetails {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails build() {
        return new PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails(
            this.card, this.extraParams, this.type);
      }

      /** Information about the card payment method used to make this payment. */
      public Builder setCard(
          PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails.Card card) {
        this.card = card;
        return this;
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails#extraParams} for the
       * field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
      ...
      public Builder setType(
          PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails.Type type) {
        this.type = type;
        return this;
      }
    }
    ...
    public static class Card {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails.Card build() {
          return new PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails.Card(
              this.checks, this.extraParams);
        }

        /** Verification checks performed on the card. */
        public Builder setChecks(
            PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails.Card.Checks
                checks) {
          this.checks = checks;
          return this;
        }
         ...
         * map. See {@link
         * PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails.Card#extraParams}
      ...
      public static class Checks {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails.Card.Checks
              build() {
            return new PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails.Card
                .Checks(
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails.Card.Checks#extraParams}
           * for the field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
  ...
  public static class ProcessorDetails {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PaymentRecordReportPaymentAttemptGuaranteedParams.ProcessorDetails build() {
        return new PaymentRecordReportPaymentAttemptGuaranteedParams.ProcessorDetails(
            this.custom, this.extraParams, this.type);
      }

      /** Information about the custom processor used to make this payment. */
      public Builder setCustom(
          PaymentRecordReportPaymentAttemptGuaranteedParams.ProcessorDetails.Custom custom) {
        this.custom = custom;
        return this;
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentRecordReportPaymentAttemptGuaranteedParams.ProcessorDetails#extraParams} for the
       * field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PaymentRecordReportPaymentAttemptGuaranteedParams.ProcessorDetails#extraParams}
       * for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
       ...
       */
      public Builder setType(
          PaymentRecordReportPaymentAttemptGuaranteedParams.ProcessorDetails.Type type) {
        this.type = type;
        return this;
      }
    }
    ...
    public static class Custom {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public PaymentRecordReportPaymentAttemptGuaranteedParams.ProcessorDetails.Custom build() {
          return new PaymentRecordReportPaymentAttemptGuaranteedParams.ProcessorDetails.Custom(
         ...
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link
         * PaymentRecordReportPaymentAttemptGuaranteedParams.ProcessorDetails.Custom#extraParams}
         * for the field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
