...
public class CustomerCollectionRetrieveParams extends ApiRequestParams {
  ...
  private CustomerCollectionRetrieveParams(List<String> expand) {
    this.expand = expand;
  }

  public static Builder builder() {
    return new com.stripe.param.CustomerCollectionRetrieveParams.Builder();
  }
  ...
  public static class Builder {
    ...
    public CustomerCollectionRetrieveParams build() {
      return new CustomerCollectionRetrieveParams(this.expand);
    }
