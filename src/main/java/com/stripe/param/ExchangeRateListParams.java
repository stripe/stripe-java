...
public class ExchangeRateListParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public ExchangeRateListParams.Builder setEndingBefore(String endingBefore) {
     ...
     */
    public ExchangeRateListParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public ExchangeRateListParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     * fetch the next page of the list.
     */
    public ExchangeRateListParams.Builder setStartingAfter(String startingAfter) {
