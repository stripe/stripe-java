...
public class CustomerBalanceTransactionCollectionCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
    ...
    public Builder setAppliedToInvoice(
        CustomerBalanceTransactionCollectionCreateParams.AppliedToInvoice appliedToInvoice) {
      this.appliedToInvoice = appliedToInvoice;
      return this;
    }
     ...
     * existing credit balance to a specific open invoice.
     */
    public Builder setType(CustomerBalanceTransactionCollectionCreateParams.Type type) {
      this.type = type;
      return this;
    }
  }
  ...
  public static class AppliedToInvoice {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public CustomerBalanceTransactionCollectionCreateParams.AppliedToInvoice build() {
        return new CustomerBalanceTransactionCollectionCreateParams.AppliedToInvoice(
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * CustomerBalanceTransactionCollectionCreateParams.AppliedToInvoice#extraParams} for the
       * field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link CustomerBalanceTransactionCollectionCreateParams.AppliedToInvoice#extraParams}
