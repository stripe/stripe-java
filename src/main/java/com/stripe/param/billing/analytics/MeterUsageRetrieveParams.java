...
public class MeterUsageRetrieveParams extends ApiRequestParams {
  /** <strong>Required.</strong> The customer id to fetch meter usage data for. */
  ...
  /**
   * An array of meter parameters to specify which meters to include in the usage data. If not
   * specified, usage across all meters for the customer is included.
   */
  ...
  /**
   * Specifies what granularity to use when aggregating meter usage events. If not specified, a
   * single event would be returned for the specified time range.
   */
  ...
  public static class Builder {
     ...
     * MeterUsageRetrieveParams#expand} for the field documentation.
     */
     ...
     * MeterUsageRetrieveParams#extraParams} for the field documentation.
     */
     ...
     * See {@link MeterUsageRetrieveParams#extraParams} for the field documentation.
     */
    ...
    /**
     * Add an element to `meters` list. A list is initialized for the first `add/addAll` call, and
     * subsequent calls adds additional elements to the original list. See {@link
     * MeterUsageRetrieveParams#meters} for the field documentation.
     */
    public Builder addMeter(MeterUsageRetrieveParams.Meter element) {
      if (this.meters == null) {
        this.meters = new ArrayList<>();
      }
      this.meters.add(element);
      return this;
    }

    /**
     * Add all elements to `meters` list. A list is initialized for the first `add/addAll` call, and
     * subsequent calls adds additional elements to the original list. See {@link
     * MeterUsageRetrieveParams#meters} for the field documentation.
     */
    public Builder addAllMeter(List<MeterUsageRetrieveParams.Meter> elements) {
      if (this.meters == null) {
        this.meters = new ArrayList<>();
      }
      this.meters.addAll(elements);
      return this;
    }
    ...
    /** The timezone to use for the start and end times. Defaults to UTC if not specified. */
    public Builder setTimezone(MeterUsageRetrieveParams.Timezone timezone) {
      this.timezone = timezone;
      return this;
    }
    ...
    public Builder setValueGroupingWindow(
        MeterUsageRetrieveParams.ValueGroupingWindow valueGroupingWindow) {
      this.valueGroupingWindow = valueGroupingWindow;
      return this;
    }
  }
  ...
  public static class Meter {
     ...
     * given meter dimension key's values.
     */
    ...
    public static class Builder {
       ...
       * {@link MeterUsageRetrieveParams.Meter#dimensionGroupByKeys} for the field documentation.
       */
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * MeterUsageRetrieveParams.Meter#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link MeterUsageRetrieveParams.Meter#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
      ...
      /**
       * Add a key/value pair to `tenantFilters` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
      ...
      public Builder putTenantFilter(String key, String value) {
        ...
        this.tenantFilters.put(key, value);
        return this;
      }

      /**
       * Add all map key/value pairs to `tenantFilters` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link MeterUsageRetrieveParams.Meter#tenantFilters} for the field documentation.
       */
