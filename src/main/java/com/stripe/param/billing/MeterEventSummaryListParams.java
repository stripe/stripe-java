...
public class MeterEventSummaryListParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * MeterEventSummaryListParams#expand} for the field documentation.
     */
     ...
     * MeterEventSummaryListParams#extraParams} for the field documentation.
     */
     ...
     * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
     * See {@link MeterEventSummaryListParams#extraParams} for the field documentation.
     */
     ...
     * MeterEventSummaryListParams#tenantKeys} for the field documentation.
     */
     ...
     * and tenant_values. Cannot be used with tenant_filters.
     */
    public Builder setTenantOperator(MeterEventSummaryListParams.TenantOperator tenantOperator) {
      this.tenantOperator = tenantOperator;
      return this;
    }
     ...
     * and subsequent calls adds additional elements to the original list. See {@link
     * MeterEventSummaryListParams#tenantValues} for the field documentation.
     */
