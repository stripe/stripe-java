...
public class CreditBalanceSummaryRetrieveParams extends ApiRequestParams {
  ...
  public static class Filter {
    ...
    public static class ApplicabilityScope {
      ...
      List<CreditBalanceSummaryRetrieveParams.Filter.ApplicabilityScope.RateCard> rateCards;
      ...
      public static class Builder {
        ...
        private List<CreditBalanceSummaryRetrieveParams.Filter.ApplicabilityScope.RateCard>
            rateCards;
         ...
         * call, and subsequent calls adds additional elements to the original list. See {@link
         * CreditBalanceSummaryRetrieveParams.Filter.ApplicabilityScope#rateCards} for the field
         * documentation.
         */
        public Builder addRateCard(
            CreditBalanceSummaryRetrieveParams.Filter.ApplicabilityScope.RateCard element) {
        ...
        public Builder addAllRateCard(
            List<CreditBalanceSummaryRetrieveParams.Filter.ApplicabilityScope.RateCard> elements) {
          if (this.rateCards == null) {
            this.rateCards = new ArrayList<>();
          }
      ...
      public static class RateCard {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public CreditBalanceSummaryRetrieveParams.Filter.ApplicabilityScope.RateCard build() {
            return new CreditBalanceSummaryRetrieveParams.Filter.ApplicabilityScope.RateCard(
                this.extraParams, this.id);
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * CreditBalanceSummaryRetrieveParams.Filter.ApplicabilityScope.RateCard#extraParams} for
