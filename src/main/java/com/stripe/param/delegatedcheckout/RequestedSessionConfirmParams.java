...
public class RequestedSessionConfirmParams extends ApiRequestParams {
  ...
  private RequestedSessionConfirmParams(
      List<String> expand, Map<String, Object> extraParams, String paymentMethod) {
    this.expand = expand;
  ...
  public static class Builder {
    ...
    public RequestedSessionConfirmParams build() {
      return new RequestedSessionConfirmParams(this.expand, this.extraParams, this.paymentMethod);
    }
