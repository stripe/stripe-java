...
public class CustomerListParams extends ApiRequestParams {
  ...
  public static class Builder {
    ...
    public CustomerListParams.Builder setCreated(CustomerListParams.Created created) {
  ...
  public static class Created {
    ...
    public static class Builder {
       ...
       */
      public CustomerListParams.Created.Builder putExtraParam(String key, Object value) {
       ...
       */
      public CustomerListParams.Created.Builder putAllExtraParam(Map<String, Object> map) {
