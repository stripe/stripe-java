...
public class PaymentMethodAttachParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * PaymentMethodAttachParams#expand} for the field documentation.
     */
    public PaymentMethodAttachParams.Builder addAllExpand(List<String> list) {
     ...
     */
    public PaymentMethodAttachParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public PaymentMethodAttachParams.Builder putAllExtraParam(Map<String, Object> map) {
