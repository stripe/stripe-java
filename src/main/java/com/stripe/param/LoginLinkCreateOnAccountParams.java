...
public class LoginLinkCreateOnAccountParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public LoginLinkCreateOnAccountParams.Builder addExpand(String element) {
     ...
     * LoginLinkCreateOnAccountParams#expand} for the field documentation.
     */
    public LoginLinkCreateOnAccountParams.Builder addAllExpand(List<String> list) {
     ...
     */
    public LoginLinkCreateOnAccountParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public LoginLinkCreateOnAccountParams.Builder putAllExtraParam(Map<String, Object> map) {
    ...
    /** Where to redirect the user after they log out of their dashboard. */
    public LoginLinkCreateOnAccountParams.Builder setRedirectUrl(String redirectUrl) {
