...
public class PaymentIntentRetrieveParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * source.
     */
    public PaymentIntentRetrieveParams.Builder setClientSecret(String clientSecret) {
     ...
     * PaymentIntentRetrieveParams#expand} for the field documentation.
     */
    public PaymentIntentRetrieveParams.Builder addAllExpand(List<String> list) {
     ...
     */
    public PaymentIntentRetrieveParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public PaymentIntentRetrieveParams.Builder putAllExtraParam(Map<String, Object> map) {
