...
@Getter
public class PaymentSourceUpdateParams extends ApiRequestParams {
  ...
  private PaymentSourceUpdateParams(
      Object accountHolderName,
      AccountHolderType accountHolderType,
      Object addressCity,
      Object addressCountry,
  ...
  public static class Builder {
    ...
    public PaymentSourceUpdateParams build() {
      return new PaymentSourceUpdateParams(
    ...
    public Builder setAccountHolderType(
        PaymentSourceUpdateParams.AccountHolderType accountHolderType) {
      this.accountHolderType = accountHolderType;
      return this;
    }
     ...
     * PaymentSourceUpdateParams#expand} for the field documentation.
     */
     ...
     * PaymentSourceUpdateParams#extraParams} for the field documentation.
     */
     ...
     * See {@link PaymentSourceUpdateParams#extraParams} for the field documentation.
     */
     ...
     * PaymentSourceUpdateParams#metadata} for the field documentation.
     */
     ...
     * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
     * See {@link PaymentSourceUpdateParams#metadata} for the field documentation.
     */
    @SuppressWarnings("unchecked")
    ...
    public Builder setOwner(PaymentSourceUpdateParams.Owner owner) {
      this.owner = owner;
      return this;
    }
  }
  ...
  public static class Owner {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PaymentSourceUpdateParams.Owner build() {
        return new PaymentSourceUpdateParams.Owner(
            this.address, this.email, this.extraParams, this.name, this.phone);
      }

      /** Owner's address. */
      public Builder setAddress(PaymentSourceUpdateParams.Owner.Address address) {
        this.address = address;
        return this;
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentSourceUpdateParams.Owner#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PaymentSourceUpdateParams.Owner#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
    ...
    public static class Address {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public PaymentSourceUpdateParams.Owner.Address build() {
          return new PaymentSourceUpdateParams.Owner.Address(
              this.city,
              this.country,
              this.extraParams,
              this.line1,
         ...
         * map. See {@link PaymentSourceUpdateParams.Owner.Address#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
