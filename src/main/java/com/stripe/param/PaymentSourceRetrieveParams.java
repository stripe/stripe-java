...
public class PaymentSourceRetrieveParams extends ApiRequestParams {
  ...
  private PaymentSourceRetrieveParams(List<String> expand) {
    this.expand = expand;
  }

  public static Builder builder() {
    return new com.stripe.param.PaymentSourceRetrieveParams.Builder();
  }
  ...
  public static class Builder {
    ...
    public PaymentSourceRetrieveParams build() {
      return new PaymentSourceRetrieveParams(this.expand);
    }
