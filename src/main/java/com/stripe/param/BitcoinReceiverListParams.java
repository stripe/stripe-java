...
public class BitcoinReceiverListParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * previous page of the list.
     */
    public BitcoinReceiverListParams.Builder setEndingBefore(String endingBefore) {
     ...
     * BitcoinReceiverListParams#expand} for the field documentation.
     */
    public BitcoinReceiverListParams.Builder addAllExpand(List<String> list) {
     ...
     */
    public BitcoinReceiverListParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public BitcoinReceiverListParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     */
    public BitcoinReceiverListParams.Builder setStartingAfter(String startingAfter) {
    ...
    /** Filter for receivers with uncaptured funds. */
    public BitcoinReceiverListParams.Builder setUncapturedFunds(Boolean uncapturedFunds) {
