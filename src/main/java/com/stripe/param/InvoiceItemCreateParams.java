...
public class InvoiceItemCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * InvoiceItemCreateParams#taxRates} for the field documentation.
     */
    public InvoiceItemCreateParams.Builder addAllTaxRate(List<String> list) {
  ...
  public static class Period {
    ...
    public static class Builder {
       ...
       */
      public InvoiceItemCreateParams.Period.Builder putExtraParam(String key, Object value) {
       ...
       */
      public InvoiceItemCreateParams.Period.Builder putAllExtraParam(Map<String, Object> map) {
