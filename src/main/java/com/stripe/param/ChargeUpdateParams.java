...
public class ChargeUpdateParams extends ApiRequestParams {
  ...
  public static class PaymentDetails {
    ...
    public static class Builder {
       ...
       * ChargeUpdateParams.PaymentDetails#fleetData} for the field documentation.
       */
      @SuppressWarnings("unchecked")
      public Builder addFleetData(ChargeUpdateParams.PaymentDetails.FleetData element) {
        if (this.fleetData == null || this.fleetData instanceof EmptyParam) {
          this.fleetData = new ArrayList<ChargeUpdateParams.PaymentDetails.FleetData>();
        }
        ((List<ChargeUpdateParams.PaymentDetails.FleetData>) this.fleetData).add(element);
        return this;
      }
       ...
       */
      @SuppressWarnings("unchecked")
      public Builder addAllFleetData(List<ChargeUpdateParams.PaymentDetails.FleetData> elements) {
        if (this.fleetData == null || this.fleetData instanceof EmptyParam) {
          this.fleetData = new ArrayList<ChargeUpdateParams.PaymentDetails.FleetData>();
        }
        ((List<ChargeUpdateParams.PaymentDetails.FleetData>) this.fleetData).addAll(elements);
        return this;
      }
      ...
      /** Fleet data for this PaymentIntent. */
      public Builder setFleetData(List<ChargeUpdateParams.PaymentDetails.FleetData> fleetData) {
        this.fleetData = fleetData;
        return this;
      }
    ...
    public static class FleetData {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public ChargeUpdateParams.PaymentDetails.FleetData build() {
          return new ChargeUpdateParams.PaymentDetails.FleetData(
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link ChargeUpdateParams.PaymentDetails.FleetData#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
        ...
        public Builder setPrimaryFuelFields(
            ChargeUpdateParams.PaymentDetails.FleetData.PrimaryFuelFields primaryFuelFields) {
          this.primaryFuelFields = primaryFuelFields;
          return this;
        }

        /** Station and acceptor location details. */
        public Builder setStation(ChargeUpdateParams.PaymentDetails.FleetData.Station station) {
          this.station = station;
          return this;
        }

        /** VAT and Invoice on Behalf (IOB) details. */
        public Builder setVat(ChargeUpdateParams.PaymentDetails.FleetData.Vat vat) {
          this.vat = vat;
          return this;
        }
      }
      ...
      public static class PrimaryFuelFields {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public ChargeUpdateParams.PaymentDetails.FleetData.PrimaryFuelFields build() {
            return new ChargeUpdateParams.PaymentDetails.FleetData.PrimaryFuelFields(
                this.brand, this.extraParams);
          }

          /** The fuel brand. */
          public Builder setBrand(
              ChargeUpdateParams.PaymentDetails.FleetData.PrimaryFuelFields.Brand brand) {
            this.brand = brand;
            return this;
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * ChargeUpdateParams.PaymentDetails.FleetData.PrimaryFuelFields#extraParams} for the
           * field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
      ...
      public static class Station {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public ChargeUpdateParams.PaymentDetails.FleetData.Station build() {
            return new ChargeUpdateParams.PaymentDetails.FleetData.Station(
          ...
          /** Additional contact information for the station. */
          public Builder setAdditionalContactInfo(EmptyParam additionalContactInfo) {
            this.additionalContactInfo = additionalContactInfo;
            return this;
          }
           ...
           * Add a key/value pair to `extraParams` map. A map is initialized for the first
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link ChargeUpdateParams.PaymentDetails.FleetData.Station#extraParams} for
           * the field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
          ...
          /** The partner ID code of the station. */
          public Builder setPartnerIdCode(EmptyParam partnerIdCode) {
            this.partnerIdCode = partnerIdCode;
            return this;
          }
          ...
          public Builder setServiceLocation(
              ChargeUpdateParams.PaymentDetails.FleetData.Station.ServiceLocation serviceLocation) {
            this.serviceLocation = serviceLocation;
            return this;
          }
        ...
        public static class ServiceLocation {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public ChargeUpdateParams.PaymentDetails.FleetData.Station.ServiceLocation build() {
              return new ChargeUpdateParams.PaymentDetails.FleetData.Station.ServiceLocation(
                  this.city,
                  this.country,
                  this.extraParams,
                  this.line1,
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * ChargeUpdateParams.PaymentDetails.FleetData.Station.ServiceLocation#extraParams} for
             * the field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
      ...
      public static class Vat {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public ChargeUpdateParams.PaymentDetails.FleetData.Vat build() {
            return new ChargeUpdateParams.PaymentDetails.FleetData.Vat(
           ...
           * Add a key/value pair to `extraParams` map. A map is initialized for the first
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link ChargeUpdateParams.PaymentDetails.FleetData.Vat#extraParams} for the
           * field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
          ...
          public Builder setIobIndicator(
              ChargeUpdateParams.PaymentDetails.FleetData.Vat.IobIndicator iobIndicator) {
            this.iobIndicator = iobIndicator;
            return this;
          }
        }
