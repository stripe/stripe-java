...
public class TransferReversalCreateParams extends ApiRequestParams {
  ...
  private TransferReversalCreateParams(
      Long amount,
      String description,
      List<String> expand,
      Map<String, Object> extraParams,
  ...
  public static class Builder {
    ...
    public TransferReversalCreateParams build() {
      return new TransferReversalCreateParams(
          this.amount,
          this.description,
          this.expand,
          this.extraParams,
     ...
     * TransferReversalCreateParams#expand} for the field documentation.
     */
     ...
     * TransferReversalCreateParams#extraParams} for the field documentation.
     */
     ...
     * See {@link TransferReversalCreateParams#extraParams} for the field documentation.
     */
     ...
     * TransferReversalCreateParams#metadata} for the field documentation.
     */
     ...
     * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
     * See {@link TransferReversalCreateParams#metadata} for the field documentation.
     */
    @SuppressWarnings("unchecked")
