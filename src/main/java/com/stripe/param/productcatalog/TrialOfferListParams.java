...
public class TrialOfferListParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * TrialOfferListParams#expand} for the field documentation.
     */
     ...
     * TrialOfferListParams#extraParams} for the field documentation.
     */
     ...
     * See {@link TrialOfferListParams#extraParams} for the field documentation.
     */
    ...
    /**
     * Add an element to `prices` list. A list is initialized for the first `add/addAll` call, and
     * subsequent calls adds additional elements to the original list. See {@link
     * TrialOfferListParams#prices} for the field documentation.
     */
    ...
    /**
     * Add all elements to `prices` list. A list is initialized for the first `add/addAll` call, and
     * subsequent calls adds additional elements to the original list. See {@link
     * TrialOfferListParams#prices} for the field documentation.
     */
  ...
  public static class Created {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public TrialOfferListParams.Created build() {
        return new TrialOfferListParams.Created(
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * TrialOfferListParams.Created#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link TrialOfferListParams.Created#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
