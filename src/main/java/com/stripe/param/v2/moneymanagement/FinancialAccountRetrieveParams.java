...
public class FinancialAccountRetrieveParams extends ApiRequestParams {
  ...
  List<FinancialAccountRetrieveParams.Include> include;

  private FinancialAccountRetrieveParams(
      Map<String, Object> extraParams, List<FinancialAccountRetrieveParams.Include> include) {
  ...
  public static class Builder {
    ...
    private List<FinancialAccountRetrieveParams.Include> include;

    /** Finalize and obtain parameter instance from this builder. */
    public FinancialAccountRetrieveParams build() {
      return new FinancialAccountRetrieveParams(this.extraParams, this.include);
    }
     ...
     * FinancialAccountRetrieveParams#include} for the field documentation.
     */
    public Builder addInclude(FinancialAccountRetrieveParams.Include element) {
     ...
     * FinancialAccountRetrieveParams#include} for the field documentation.
     */
    public Builder addAllInclude(List<FinancialAccountRetrieveParams.Include> elements) {
      if (this.include == null) {
        this.include = new ArrayList<>();
      }
