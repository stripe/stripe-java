...
public class InboundTransferListParams extends ApiRequestParams {
  ...
  private InboundTransferListParams(Created created, Map<String, Object> extraParams, Long limit) {
  ...
  public static class Builder {
    ...
    public InboundTransferListParams build() {
      return new InboundTransferListParams(this.created, this.extraParams, this.limit);
    }

    /** Hash of options for filtering on creation time. */
    public Builder setCreated(InboundTransferListParams.Created created) {
      this.created = created;
      return this;
    }
  ...
  public static class Created {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public InboundTransferListParams.Created build() {
        return new InboundTransferListParams.Created(
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * InboundTransferListParams.Created#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link InboundTransferListParams.Created#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
