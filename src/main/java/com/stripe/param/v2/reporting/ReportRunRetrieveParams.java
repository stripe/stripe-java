...
public class ReportRunRetrieveParams extends ApiRequestParams {
  ...
  private ReportRunRetrieveParams(
      Map<String, Object> extraParams, List<ReportRunRetrieveParams.Include> include) {
  ...
  public static class Builder {
    ...
    public ReportRunRetrieveParams build() {
      return new ReportRunRetrieveParams(this.extraParams, this.include);
    }
  ...
  public enum Include implements ApiRequestParams.EnumParam {
    @SerializedName("result.file.schema")
    RESULT__FILE__SCHEMA("result.file.schema");
