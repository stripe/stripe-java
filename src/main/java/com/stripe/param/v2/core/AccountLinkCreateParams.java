...
public class AccountLinkCreateParams extends ApiRequestParams {
  ...
  public static class UseCase {
     ...
     * recipient.
     */
    @SerializedName("recipient_onboarding")
     ...
     */
    @SerializedName("recipient_update")
    ...
    private UseCase(
      ...
      this.extraParams = extraParams;
      this.recipientOnboarding = recipientOnboarding;
      this.recipientUpdate = recipientUpdate;
      this.type = type;
    }
    ...
    public static class Builder {
      ...
      private RecipientOnboarding recipientOnboarding;

      private RecipientUpdate recipientUpdate;
       ...
       * recipient.
       */
      public Builder setRecipientOnboarding(
          AccountLinkCreateParams.UseCase.RecipientOnboarding recipientOnboarding) {
        this.recipientOnboarding = recipientOnboarding;
        return this;
      }
       ...
       * recipient.
       */
      public Builder setRecipientUpdate(
          AccountLinkCreateParams.UseCase.RecipientUpdate recipientUpdate) {
        this.recipientUpdate = recipientUpdate;
        return this;
      }
    ...
    @Getter
    @EqualsAndHashCode(callSuper = false)
    public static class RecipientOnboarding {
      /**
       * Specifies the requirements that Stripe collects from v2/core/accounts in the Onboarding
       * flow.
       */
      ...
      public static class Builder {
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link AccountLinkCreateParams.UseCase.RecipientOnboarding#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
      ...
      public static class CollectionOptions {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public AccountLinkCreateParams.UseCase.RecipientOnboarding.CollectionOptions build() {
            return new AccountLinkCreateParams.UseCase.RecipientOnboarding.CollectionOptions(
                this.extraParams, this.fields, this.futureRequirements);
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * AccountLinkCreateParams.UseCase.RecipientOnboarding.CollectionOptions#extraParams} for
           * the field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
           ...
           */
          public Builder setFields(
              AccountLinkCreateParams.UseCase.RecipientOnboarding.CollectionOptions.Fields fields) {
            this.fields = fields;
            return this;
          }
    ...
    public static class RecipientUpdate {
      ...
      public static class Builder {
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link AccountLinkCreateParams.UseCase.RecipientUpdate#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
      ...
      public static class CollectionOptions {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public AccountLinkCreateParams.UseCase.RecipientUpdate.CollectionOptions build() {
            return new AccountLinkCreateParams.UseCase.RecipientUpdate.CollectionOptions(
                this.extraParams, this.fields, this.futureRequirements);
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * AccountLinkCreateParams.UseCase.RecipientUpdate.CollectionOptions#extraParams} for the
           * field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
           ...
           */
          public Builder setFields(
              AccountLinkCreateParams.UseCase.RecipientUpdate.CollectionOptions.Fields fields) {
            this.fields = fields;
            return this;
          }
           ...
           */
          public Builder setFutureRequirements(
              AccountLinkCreateParams.UseCase.RecipientUpdate.CollectionOptions.FutureRequirements
                  futureRequirements) {
            this.futureRequirements = futureRequirements;
            return this;
          }
