...
public class WorkflowRunListParams extends ApiRequestParams {
  ...
  /**
   * <strong>Required.</strong> When retrieving Workflow Runs, include only those with the specified
   * status values. If not specified, all Runs are returned.
   */
  @SerializedName("status")
  List<WorkflowRunListParams.Status> status;

  /**
   * <strong>Required.</strong> When retrieving Workflow Runs, include only those associated with
   * the Workflows specified. If not specified, all Runs are returned.
   */
