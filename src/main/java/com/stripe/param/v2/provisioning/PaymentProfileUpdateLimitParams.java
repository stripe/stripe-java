...
public class PaymentProfileUpdateLimitParams extends ApiRequestParams {
  /**
  ...
  private PaymentProfileUpdateLimitParams(
      Map<String, Object> extraParams, Boolean livemode, String provider, UsageLimits usageLimits) {
  ...
  public static class Builder {
    ...
    public PaymentProfileUpdateLimitParams build() {
      return new PaymentProfileUpdateLimitParams(
     ...
     * PaymentProfileUpdateLimitParams#extraParams} for the field documentation.
     */
     ...
     * See {@link PaymentProfileUpdateLimitParams#extraParams} for the field documentation.
     */
    ...
    /** <strong>Required.</strong> New usage limit to apply. */
    public Builder setUsageLimits(PaymentProfileUpdateLimitParams.UsageLimits usageLimits) {
      this.usageLimits = usageLimits;
      return this;
    }
  }
  ...
  public static class UsageLimits {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PaymentProfileUpdateLimitParams.UsageLimits build() {
        return new PaymentProfileUpdateLimitParams.UsageLimits(
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentProfileUpdateLimitParams.UsageLimits#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PaymentProfileUpdateLimitParams.UsageLimits#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
      ...
      public Builder setRecurringInterval(
          PaymentProfileUpdateLimitParams.UsageLimits.RecurringInterval recurringInterval) {
        this.recurringInterval = recurringInterval;
        return this;
      }
    }
