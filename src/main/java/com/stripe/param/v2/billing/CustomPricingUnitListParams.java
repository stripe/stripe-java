...
public class CustomPricingUnitListParams extends ApiRequestParams {
  ...
  private CustomPricingUnitListParams(
  ...
  public static class Builder {
    ...
    public CustomPricingUnitListParams build() {
      return new CustomPricingUnitListParams(
          this.active, this.extraParams, this.limit, this.lookupKeys);
    }
     ...
     * CustomPricingUnitListParams#extraParams} for the field documentation.
     */
     ...
     * See {@link CustomPricingUnitListParams#extraParams} for the field documentation.
     */
     ...
     * CustomPricingUnitListParams#lookupKeys} for the field documentation.
     */
