...
public class CollectionSettingListParams extends ApiRequestParams {
  ...
  private CollectionSettingListParams(
  ...
  public static class Builder {
    ...
    public CollectionSettingListParams build() {
      return new CollectionSettingListParams(this.extraParams, this.limit, this.lookupKeys);
    }

    /**
     * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
     * call, and subsequent calls add additional key/value pairs to the original map. See {@link
     * CollectionSettingListParams#extraParams} for the field documentation.
     */
     ...
     * See {@link CollectionSettingListParams#extraParams} for the field documentation.
     */
     ...
     * CollectionSettingListParams#lookupKeys} for the field documentation.
     */
