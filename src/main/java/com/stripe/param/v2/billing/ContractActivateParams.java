...
public class ContractActivateParams extends ApiRequestParams {
  ...
  List<ContractActivateParams.Include> include;

  private ContractActivateParams(
      Map<String, Object> extraParams, List<ContractActivateParams.Include> include) {
  ...
  public static class Builder {
    ...
    private List<ContractActivateParams.Include> include;
     ...
     * ContractActivateParams#include} for the field documentation.
     */
    public Builder addAllInclude(List<ContractActivateParams.Include> elements) {
      if (this.include == null) {
        this.include = new ArrayList<>();
      }
