...
public class LicensedItemListParams extends ApiRequestParams {
  /**
  ...
  public static class Builder {
    ...
    public LicensedItemListParams build() {
      return new LicensedItemListParams(this.extraParams, this.limit, this.lookupKeys);
    }

    /**
     * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
     * call, and subsequent calls add additional key/value pairs to the original map. See {@link
     * LicensedItemListParams#extraParams} for the field documentation.
     */
     ...
     * See {@link LicensedItemListParams#extraParams} for the field documentation.
     */
     ...
     * LicensedItemListParams#lookupKeys} for the field documentation.
     */
