...
public class PricingPlanSubscriptionUpdateParams extends ApiRequestParams {
  ...
  private PricingPlanSubscriptionUpdateParams(
      Boolean clearCancelAt, Map<String, Object> extraParams, Map<String, Object> metadata) {
  ...
  public static class Builder {
    ...
    public PricingPlanSubscriptionUpdateParams build() {
      return new PricingPlanSubscriptionUpdateParams(
          this.clearCancelAt, this.extraParams, this.metadata);
    }
     ...
     * PricingPlanSubscriptionUpdateParams#extraParams} for the field documentation.
     */
     ...
     * See {@link PricingPlanSubscriptionUpdateParams#extraParams} for the field documentation.
     */
     ...
     * PricingPlanSubscriptionUpdateParams#metadata} for the field documentation.
     */
