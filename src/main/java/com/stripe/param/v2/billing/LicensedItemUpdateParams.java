...
public class LicensedItemUpdateParams extends ApiRequestParams {
  ...
  private LicensedItemUpdateParams(
      Object displayName,
      Map<String, Object> extraParams,
      Object lookupKey,
      Map<String, Object> metadata,
  ...
  public static class Builder {
    ...
    public LicensedItemUpdateParams build() {
      return new LicensedItemUpdateParams(
          this.displayName,
          this.extraParams,
          this.lookupKey,
          this.metadata,
     ...
     * LicensedItemUpdateParams#extraParams} for the field documentation.
     */
     ...
     * See {@link LicensedItemUpdateParams#extraParams} for the field documentation.
     */
     ...
     * LicensedItemUpdateParams#metadata} for the field documentation.
     */
    ...
    /** Stripe Tax details. */
    public Builder setTaxDetails(LicensedItemUpdateParams.TaxDetails taxDetails) {
      this.taxDetails = taxDetails;
      return this;
    }
  ...
  public static class TaxDetails {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public LicensedItemUpdateParams.TaxDetails build() {
        return new LicensedItemUpdateParams.TaxDetails(this.extraParams, this.taxCode);
      }

      /**
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * LicensedItemUpdateParams.TaxDetails#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link LicensedItemUpdateParams.TaxDetails#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
