...
public class PricingPlanListParams extends ApiRequestParams {
  /** Filter for active/inactive PricingPlans. Mutually exclusive with {@code lookup_keys}. */
  ...
  public static class Builder {
    ...
    public PricingPlanListParams build() {
      return new PricingPlanListParams(this.active, this.extraParams, this.limit, this.lookupKeys);
    }
     ...
     * PricingPlanListParams#extraParams} for the field documentation.
     */
     ...
     * See {@link PricingPlanListParams#extraParams} for the field documentation.
     */
     ...
     * PricingPlanListParams#lookupKeys} for the field documentation.
     */
