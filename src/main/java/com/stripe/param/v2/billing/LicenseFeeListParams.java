...
public class LicenseFeeListParams extends ApiRequestParams {
  /**
  ...
  /** <strong>Required.</strong> Filter by lookup keys. You can specify up to 10 lookup keys. */
  @SerializedName("lookup_keys")
  List<String> lookupKeys;

  private LicenseFeeListParams(
      Map<String, Object> extraParams, String licensedItem, Long limit, List<String> lookupKeys) {
  ...
  public static class Builder {
    ...
    public LicenseFeeListParams build() {
      return new LicenseFeeListParams(
          this.extraParams, this.licensedItem, this.limit, this.lookupKeys);
    }

    /**
     * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
     * call, and subsequent calls add additional key/value pairs to the original map. See {@link
     * LicenseFeeListParams#extraParams} for the field documentation.
     */
     ...
     * See {@link LicenseFeeListParams#extraParams} for the field documentation.
     */
     ...
     * LicenseFeeListParams#lookupKeys} for the field documentation.
     */
