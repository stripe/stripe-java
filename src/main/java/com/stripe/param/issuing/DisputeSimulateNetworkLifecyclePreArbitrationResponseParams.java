...
public class DisputeSimulateNetworkLifecyclePreArbitrationResponseParams extends ApiRequestParams {
   ...
   * for the pre-arbitration response stage.
   */
  @SerializedName("merchant_evidence_files")
  MerchantEvidenceFiles merchantEvidenceFiles;

  private DisputeSimulateNetworkLifecyclePreArbitrationResponseParams(
      List<String> expand,
      Map<String, Object> extraParams,
      MerchantEvidenceFiles merchantEvidenceFiles) {
    this.expand = expand;
  ...
  public static class Builder {
    ...
    public DisputeSimulateNetworkLifecyclePreArbitrationResponseParams build() {
      return new DisputeSimulateNetworkLifecyclePreArbitrationResponseParams(
     ...
     * DisputeSimulateNetworkLifecyclePreArbitrationResponseParams#expand} for the field
     * documentation.
     */
     ...
     * DisputeSimulateNetworkLifecyclePreArbitrationResponseParams#extraParams} for the field
     * documentation.
     */
     ...
     * See {@link DisputeSimulateNetworkLifecyclePreArbitrationResponseParams#extraParams} for the
     * field documentation.
     */
     ...
     * files for the pre-arbitration response stage.
     */
    public Builder setMerchantEvidenceFiles(
        DisputeSimulateNetworkLifecyclePreArbitrationResponseParams.MerchantEvidenceFiles
  ...
  public static class MerchantEvidenceFiles {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public DisputeSimulateNetworkLifecyclePreArbitrationResponseParams.MerchantEvidenceFiles
          build() {
        return new DisputeSimulateNetworkLifecyclePreArbitrationResponseParams
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * DisputeSimulateNetworkLifecyclePreArbitrationResponseParams.MerchantEvidenceFiles#extraParams}
