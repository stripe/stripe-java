...
public class DisputeCloseParams extends ApiRequestParams {
  ...
  /** <strong>Required.</strong> Whether to close the dispute as {@code won} or {@code lost}. */
  @SerializedName("status")
  Status status;

  private DisputeCloseParams(List<String> expand, Map<String, Object> extraParams, Status status) {
    this.expand = expand;
