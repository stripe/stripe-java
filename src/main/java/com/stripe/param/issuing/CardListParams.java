...
public class CardListParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public CardListParams.Builder putAllExtraParam(Map<String, Object> map) {
  ...
  public static class Created {
    ...
    public static class Builder {
       ...
       */
      public CardListParams.Created.Builder putExtraParam(String key, Object value) {
       ...
       */
      public CardListParams.Created.Builder putAllExtraParam(Map<String, Object> map) {
