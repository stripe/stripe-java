...
public class CreditUnderwritingRecordCreateFromProactiveReviewParams extends ApiRequestParams {
  ...
  public static class Builder {
    ...
    public Builder setException(
        CreditUnderwritingRecordCreateFromProactiveReviewParams.Exception exception) {
      this.exception = exception;
      return this;
    }
  ...
  public static class Exception {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public CreditUnderwritingRecordCreateFromProactiveReviewParams.Exception build() {
        return new CreditUnderwritingRecordCreateFromProactiveReviewParams.Exception(
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * CreditUnderwritingRecordCreateFromProactiveReviewParams.Exception#extraParams} for the
       * field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link CreditUnderwritingRecordCreateFromProactiveReviewParams.Exception#extraParams}
       * for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
      ...
      public Builder setOriginalDecisionType(
          CreditUnderwritingRecordCreateFromProactiveReviewParams.Exception.OriginalDecisionType
