...
public class CardholderUpdateParams extends ApiRequestParams {
  ...
  public static class Builder {
    ...
    /** The cardholder's billing address. */
    public Builder setBilling(CardholderUpdateParams.Billing billing) {
      this.billing = billing;
      return this;
    }

    /** Additional information about a {@code company} cardholder. */
    public Builder setCompany(CardholderUpdateParams.Company company) {
      this.company = company;
      return this;
    }
    ...
    /** Additional information about an {@code individual} cardholder. */
    public Builder setIndividual(CardholderUpdateParams.Individual individual) {
      this.individual = individual;
      return this;
    }
    ...
    /** Specifies whether to permit authorizations on this cardholder's cards. */
    public Builder setStatus(CardholderUpdateParams.Status status) {
      this.status = status;
      return this;
    }
  }
  ...
  public static class Company {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public CardholderUpdateParams.Company build() {
        return new CardholderUpdateParams.Company(this.extraParams, this.taxId);
      }
  ...
  public static class Individual {
    ...
    public static class Builder {
      ...
      /** The date of birth of this cardholder. Cardholders must be older than 13 years old. */
      public Builder setDob(CardholderUpdateParams.Individual.Dob dob) {
        this.dob = dob;
        return this;
      }
    ...
    public static class Dob {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public CardholderUpdateParams.Individual.Dob build() {
          return new CardholderUpdateParams.Individual.Dob(
    ...
    public static class Verification {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public CardholderUpdateParams.Individual.Verification build() {
          return new CardholderUpdateParams.Individual.Verification(
              this.document, this.extraParams);
        }

        /** An identifying document, either a passport or local ID card. */
        public Builder setDocument(
            CardholderUpdateParams.Individual.Verification.Document document) {
          this.document = document;
          return this;
        }
      ...
      public static class Document {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public CardholderUpdateParams.Individual.Verification.Document build() {
            return new CardholderUpdateParams.Individual.Verification.Document(
  ...
  public static class SpendingControls {
    ...
    public static class Builder {
      ...
      private List<CardholderUpdateParams.SpendingControls.SpendingLimit> spendingLimits;
      ...
      public Builder addAllowedCategory(
          CardholderUpdateParams.SpendingControls.AllowedCategory element) {
      ...
      public Builder addAllAllowedCategory(
          List<CardholderUpdateParams.SpendingControls.AllowedCategory> elements) {
        if (this.allowedCategories == null) {
          this.allowedCategories = new ArrayList<>();
        }
      ...
      public Builder addBlockedCategory(
          CardholderUpdateParams.SpendingControls.BlockedCategory element) {
      ...
      public Builder addAllBlockedCategory(
          List<CardholderUpdateParams.SpendingControls.BlockedCategory> elements) {
        if (this.blockedCategories == null) {
          this.blockedCategories = new ArrayList<>();
        }
      ...
      public Builder addSpendingLimit(
          CardholderUpdateParams.SpendingControls.SpendingLimit element) {
      ...
      public Builder addAllSpendingLimit(
          List<CardholderUpdateParams.SpendingControls.SpendingLimit> elements) {
        if (this.spendingLimits == null) {
          this.spendingLimits = new ArrayList<>();
        }
    ...
    public static class SpendingLimit {
      ...
      List<CardholderUpdateParams.SpendingControls.SpendingLimit.Category> categories;
      ...
      public static class Builder {
        ...
        private List<CardholderUpdateParams.SpendingControls.SpendingLimit.Category> categories;
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public CardholderUpdateParams.SpendingControls.SpendingLimit build() {
          return new CardholderUpdateParams.SpendingControls.SpendingLimit(
        ...
        public Builder addCategory(
            CardholderUpdateParams.SpendingControls.SpendingLimit.Category element) {
        ...
        public Builder addAllCategory(
            List<CardholderUpdateParams.SpendingControls.SpendingLimit.Category> elements) {
          if (this.categories == null) {
            this.categories = new ArrayList<>();
          }
