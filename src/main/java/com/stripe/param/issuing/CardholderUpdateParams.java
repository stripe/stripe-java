...
public class CardholderUpdateParams extends ApiRequestParams {
  ...
  public static class AuthorizationControls {
    ...
    List<CardholderUpdateParams.AuthorizationControls.AllowedCategory> allowedCategories;
    ...
    List<CardholderUpdateParams.AuthorizationControls.BlockedCategory> blockedCategories;
    ...
    List<CardholderUpdateParams.AuthorizationControls.SpendingLimit> spendingLimits;
    ...
    public static class Builder {
      private List<CardholderUpdateParams.AuthorizationControls.AllowedCategory> allowedCategories;
      private List<CardholderUpdateParams.AuthorizationControls.BlockedCategory> blockedCategories;
      private Map<String, Object> extraParams;
      private List<CardholderUpdateParams.AuthorizationControls.SpendingLimit> spendingLimits;
      ...
      public CardholderUpdateParams.AuthorizationControls.Builder addAllAllowedCategory(
          List<CardholderUpdateParams.AuthorizationControls.AllowedCategory> list) {
      ...
      public CardholderUpdateParams.AuthorizationControls.Builder addAllBlockedCategory(
          List<CardholderUpdateParams.AuthorizationControls.BlockedCategory> list) {
      ...
      public CardholderUpdateParams.AuthorizationControls.Builder addAllSpendingLimit(
          List<CardholderUpdateParams.AuthorizationControls.SpendingLimit> list) {
    ...
    public static class SpendingLimit {
      ...
      List<CardholderUpdateParams.AuthorizationControls.SpendingLimit.Category> categories;
      ...
      public static class Builder {
        private Long amount;
        private List<CardholderUpdateParams.AuthorizationControls.SpendingLimit.Category>
            categories;
        private Map<String, Object> extraParams;
        ...
        public CardholderUpdateParams.AuthorizationControls.SpendingLimit.Builder addAllCategory(
            List<CardholderUpdateParams.AuthorizationControls.SpendingLimit.Category> list) {
  ...
  public static class Billing {
    ...
    public static class Builder {
      ...
      public CardholderUpdateParams.Billing build() {
        return new CardholderUpdateParams.Billing(this.address, this.extraParams, this.name);
      }
       ...
       */
      public CardholderUpdateParams.Billing.Builder putExtraParam(String key, Object value) {
       ...
       */
      public CardholderUpdateParams.Billing.Builder putAllExtraParam(Map<String, Object> map) {
    ...
    public static class Address {
      ...
      public static class Builder {
        ...
        public CardholderUpdateParams.Billing.Address.Builder setCity(String city) {

          this.city = city;
          return this;
        }

        public CardholderUpdateParams.Billing.Address.Builder setCountry(String country) {
        ...
        public CardholderUpdateParams.Billing.Address.Builder setLine1(String line1) {

          this.line1 = line1;
          return this;
        }

        public CardholderUpdateParams.Billing.Address.Builder setLine2(String line2) {

          this.line2 = line2;
          return this;
        }

        public CardholderUpdateParams.Billing.Address.Builder setPostalCode(String postalCode) {

          this.postalCode = postalCode;
          return this;
        }

        public CardholderUpdateParams.Billing.Address.Builder setState(String state) {
