...
public class AuthorizationRetrieveParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * AuthorizationRetrieveParams#expand} for the field documentation.
     */
    public AuthorizationRetrieveParams.Builder addAllExpand(List<String> list) {
     ...
     */
    public AuthorizationRetrieveParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public AuthorizationRetrieveParams.Builder putAllExtraParam(Map<String, Object> map) {
