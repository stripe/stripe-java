...
public class TransactionRetrieveParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * TransactionRetrieveParams#expand} for the field documentation.
     */
    public TransactionRetrieveParams.Builder addAllExpand(List<String> list) {
     ...
     */
    public TransactionRetrieveParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public TransactionRetrieveParams.Builder putAllExtraParam(Map<String, Object> map) {
