...
public class SecretDeleteWhereParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * SecretDeleteWhereParams#expand} for the field documentation.
     */
     ...
     * SecretDeleteWhereParams#extraParams} for the field documentation.
     */
     ...
     * See {@link SecretDeleteWhereParams#extraParams} for the field documentation.
     */
  ...
  public static class Scope {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public SecretDeleteWhereParams.Scope build() {
        return new SecretDeleteWhereParams.Scope(this.extraParams, this.type, this.user);
      }

      /**
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * SecretDeleteWhereParams.Scope#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link SecretDeleteWhereParams.Scope#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
