...
public class AccountPersonsParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * calls adds additional elements to the original list. See {@link AccountPersonsParams#expand}
  ...
  public static class Relationship {
    ...
    public static class Builder {
      ...
      public Relationship build() {
        return new Relationship(this.accountOpener, this.director, this.executive, this.owner);
      }
