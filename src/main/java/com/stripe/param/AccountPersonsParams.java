...
public class AccountPersonsParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * previous page of the list.
     */
    public AccountPersonsParams.Builder setEndingBefore(String endingBefore) {
     ...
     */
    public AccountPersonsParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public AccountPersonsParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     */
    public AccountPersonsParams.Builder setStartingAfter(String startingAfter) {
  ...
  public static class Relationship {
    ...
    public static class Builder {
       ...
       */
      public AccountPersonsParams.Relationship.Builder setAccountOpener(Boolean accountOpener) {
       ...
       */
      public AccountPersonsParams.Relationship.Builder putAllExtraParam(Map<String, Object> map) {
       ...
       * account's company.
       */
      public AccountPersonsParams.Relationship.Builder setOwner(Boolean owner) {
