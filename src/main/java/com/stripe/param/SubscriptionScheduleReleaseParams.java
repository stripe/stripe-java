...
public class SubscriptionScheduleReleaseParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public SubscriptionScheduleReleaseParams.Builder addExpand(String element) {
     ...
     * SubscriptionScheduleReleaseParams#expand} for the field documentation.
     */
    public SubscriptionScheduleReleaseParams.Builder addAllExpand(List<String> list) {
     ...
     */
    public SubscriptionScheduleReleaseParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public SubscriptionScheduleReleaseParams.Builder putAllExtraParam(Map<String, Object> map) {
