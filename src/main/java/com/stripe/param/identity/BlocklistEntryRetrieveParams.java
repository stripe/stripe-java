...
public class BlocklistEntryRetrieveParams extends ApiRequestParams {
  ...
  private BlocklistEntryRetrieveParams(List<String> expand, Map<String, Object> extraParams) {
    this.expand = expand;
