...
public class ReaderDeleteParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public ReaderDeleteParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public ReaderDeleteParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     * ID.
     */
    public ReaderDeleteParams.Builder setOperatorAccount(String operatorAccount) {
