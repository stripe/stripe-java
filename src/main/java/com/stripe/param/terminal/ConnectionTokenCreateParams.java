...
public class ConnectionTokenCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * ConnectionTokenCreateParams#expand} for the field documentation.
     */
    public ConnectionTokenCreateParams.Builder addAllExpand(List<String> list) {
     ...
     */
    public ConnectionTokenCreateParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public ConnectionTokenCreateParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     * token will be usable with all readers.
     */
    public ConnectionTokenCreateParams.Builder setLocation(String location) {
     ...
     * ID.
     */
    public ConnectionTokenCreateParams.Builder setOperatorAccount(String operatorAccount) {
