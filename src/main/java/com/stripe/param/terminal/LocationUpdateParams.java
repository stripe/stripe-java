...
public class LocationUpdateParams extends ApiRequestParams {
  ...
  public static class Builder {
    ...
    /** The full address of the location. */
    public LocationUpdateParams.Builder setAddress(LocationUpdateParams.Address address) {
     ...
     * ID.
     */
    public LocationUpdateParams.Builder setOperatorAccount(String operatorAccount) {
  ...
  public static class Address {
    ...
    public static class Builder {
      ...
      public LocationUpdateParams.Address.Builder setCountry(String country) {
       ...
       */
      public LocationUpdateParams.Address.Builder putExtraParam(String key, Object value) {
       ...
       */
      public LocationUpdateParams.Address.Builder putAllExtraParam(Map<String, Object> map) {
      ...
      public LocationUpdateParams.Address.Builder setPostalCode(String postalCode) {
