...
public class LocationDeleteParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public LocationDeleteParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public LocationDeleteParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     * ID.
     */
    public LocationDeleteParams.Builder setOperatorAccount(String operatorAccount) {
