...
public class ReaderListParams extends ApiRequestParams {
  ...
  ReaderListParams.Status status;
  ...
  public static class Builder {
    ...
    private ReaderListParams.Status status;
     ...
     */
    public ReaderListParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public ReaderListParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     * ID.
     */
    public ReaderListParams.Builder setOperatorAccount(String operatorAccount) {
