...
public class ReaderCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public ReaderCreateParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public ReaderCreateParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     * ID.
     */
    public ReaderCreateParams.Builder setOperatorAccount(String operatorAccount) {
    ...
    /** A code generated by the reader used for registering to an account. */
    public ReaderCreateParams.Builder setRegistrationCode(String registrationCode) {
