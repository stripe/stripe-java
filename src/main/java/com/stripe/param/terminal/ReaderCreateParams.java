...
public class ReaderCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
    ...
    /**
     * Add a key/value pair to `metadata` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link ReaderCreateParams#metadata} for the field documentation.
     */
    ...
    /**
     * Add all map key/value pairs to `metadata` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link ReaderCreateParams#metadata} for the field documentation.
     */
    @SuppressWarnings("unchecked")
