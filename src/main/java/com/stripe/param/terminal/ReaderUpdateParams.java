...
public class ReaderUpdateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public ReaderUpdateParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public ReaderUpdateParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     * ID.
     */
    public ReaderUpdateParams.Builder setOperatorAccount(String operatorAccount) {
