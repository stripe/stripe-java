...
public class PaymentMethodCreateParams extends ApiRequestParams {
  ...
  /**
   * If this is a {@code tamara} PaymentMethod, this hash contains details about the Tamara payment
   * method.
   */
  ...
  public static class Builder {
     ...
     * payment method.
     */
    public Builder setCustom(PaymentMethodCreateParams.Custom custom) {
      this.custom = custom;
      return this;
    }
     ...
     * payment method.
     */
    public Builder setTamara(PaymentMethodCreateParams.Tamara tamara) {
      this.tamara = tamara;
      return this;
    }
     ...
     * method.
     */
    public Builder setVipps(PaymentMethodCreateParams.Vipps vipps) {
      this.vipps = vipps;
      return this;
    }
  ...
  public static class Custom {
    ...
    /**
     * <strong>Required.</strong> ID of the Dashboard-only CustomPaymentMethodType. This field is
     * used by Stripe products' internal code to support CPMs.
     */
    @SerializedName("type")
    String type;

    private Custom(Map<String, Object> extraParams, String type) {
      this.extraParams = extraParams;
      this.type = type;
    }
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PaymentMethodCreateParams.Custom build() {
        return new PaymentMethodCreateParams.Custom(this.extraParams, this.type);
      }

      /**
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentMethodCreateParams.Custom#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PaymentMethodCreateParams.Custom#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
  ...
  public static class StripeBalance {
    ...
    public static class Builder {
      ...
      public PaymentMethodCreateParams.StripeBalance build() {
        return new PaymentMethodCreateParams.StripeBalance(this.account, this.extraParams);
      }
  ...
  public static class Tamara {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PaymentMethodCreateParams.Tamara build() {
        return new PaymentMethodCreateParams.Tamara(this.extraParams);
      }

      /**
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentMethodCreateParams.Tamara#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PaymentMethodCreateParams.Tamara#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
  ...
  public static class Vipps {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PaymentMethodCreateParams.Vipps build() {
        return new PaymentMethodCreateParams.Vipps(this.extraParams);
      }

      /**
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentMethodCreateParams.Vipps#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PaymentMethodCreateParams.Vipps#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
