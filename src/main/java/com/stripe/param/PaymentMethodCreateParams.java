...
public class PaymentMethodCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * method.
     */
    public Builder setKrMarket(PaymentMethodCreateParams.KrMarket krMarket) {
      this.krMarket = krMarket;
      return this;
    }
  ...
  public static class KrMarket {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PaymentMethodCreateParams.KrMarket build() {
        return new PaymentMethodCreateParams.KrMarket(
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentMethodCreateParams.KrMarket#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PaymentMethodCreateParams.KrMarket#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
      ...
      public Builder setUnderlyingPaymentMethod(
          PaymentMethodCreateParams.KrMarket.UnderlyingPaymentMethod underlyingPaymentMethod) {
        this.underlyingPaymentMethod = underlyingPaymentMethod;
        return this;
      }
    }
