...
public class SubscriptionListParams extends ApiRequestParams {
  /**
   * The collection method of the subscriptions to retrieve. Either {@code charge_automatically} or {@code send_invoice}.
   */
  ...
  /**
   * The status of the subscriptions to retrieve. Passing in a value of {@code canceled} will return all canceled subscriptions, including those belonging to deleted customers. Pass {@code ended} to find subscriptions that are canceled and subscriptions that are expired due to <a href="https://stripe.com/docs/billing/subscriptions/overview#subscription-statuses">incomplete payment</a>. Passing in a value of {@code all} will return subscriptions of all statuses. If no value is supplied, all subscriptions that have not been canceled are returned.
   */
