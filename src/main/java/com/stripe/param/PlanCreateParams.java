...
public class PlanCreateParams extends ApiRequestParams {
  ...
  public static class Product {
    ...
    private Product(Boolean active, String id, Map<String, String> metadata, String unitLabel) {
      this.active = active;
      this.id = id;
      this.metadata = metadata;
    ...
    public static class Builder {
      ...
      public Product build() {
        return new Product(this.active, this.id, this.metadata, this.unitLabel);
      }
