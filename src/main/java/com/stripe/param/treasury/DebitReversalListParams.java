...
public class DebitReversalListParams extends ApiRequestParams {
  ...
  public static class Builder {
    ...
    /**
     * Add an element to `expand` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link DebitReversalListParams#expand} for the field documentation.
     */
    ...
    /**
     * Add all elements to `expand` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link DebitReversalListParams#expand} for the field documentation.
     */
    ...
    /**
     * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link DebitReversalListParams#extraParams} for the field documentation.
     */
    ...
    /**
     * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link DebitReversalListParams#extraParams} for the field documentation.
     */
