...
public class PaymentIntentCaptureParams extends ApiRequestParams {
  ...
  public static class AmountDetails {
    ...
    public static class Builder {
      ...
      /** Contains information about the tip portion of the amount. */
      public Builder setTip(PaymentIntentCaptureParams.AmountDetails.Tip tip) {
        this.tip = tip;
        return this;
      }
    ...
    public static class Tip {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public PaymentIntentCaptureParams.AmountDetails.Tip build() {
          return new PaymentIntentCaptureParams.AmountDetails.Tip(this.amount, this.extraParams);
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link PaymentIntentCaptureParams.AmountDetails.Tip#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
