...
public class PaymentSourceCollectionCreateParams extends ApiRequestParams {
  ...
  public static PaymentSourceCollectionCreateParams.Builder builder() {
    return new PaymentSourceCollectionCreateParams.Builder();
  }
  ...
  public static class Builder {
     ...
     */
    public PaymentSourceCollectionCreateParams.Builder addExpand(String element) {
     ...
     * PaymentSourceCollectionCreateParams#expand} for the field documentation.
     */
    public PaymentSourceCollectionCreateParams.Builder addAllExpand(List<String> list) {
     ...
     */
    public PaymentSourceCollectionCreateParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public PaymentSourceCollectionCreateParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     */
    public PaymentSourceCollectionCreateParams.Builder putMetadata(String key, String value) {
     ...
     */
    public PaymentSourceCollectionCreateParams.Builder putAllMetadata(Map<String, String> map) {
    ...
    /** Please refer to full [documentation](https://stripe.com/docs/api) instead. */
    public PaymentSourceCollectionCreateParams.Builder setSource(String source) {
