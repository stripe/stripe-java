...
@Getter
public class CustomerCollectionCreateTaxIdParams extends ApiRequestParams {
  ...
  private CustomerCollectionCreateTaxIdParams(
  ...
  public static class Builder {
    ...
    public CustomerCollectionCreateTaxIdParams build() {
      return new CustomerCollectionCreateTaxIdParams(
          this.expand, this.extraParams, this.type, this.value);
    }

    /**
     * Add an element to `expand` list. A list is initialized for the first `add/addAll` call, and
     * subsequent calls adds additional elements to the original list. See {@link
     * CustomerCollectionCreateTaxIdParams#expand} for the field documentation.
     */
     ...
     * CustomerCollectionCreateTaxIdParams#extraParams} for the field documentation.
     */
     ...
     * See {@link CustomerCollectionCreateTaxIdParams#extraParams} for the field documentation.
     */
     ...
     */
    public Builder setType(CustomerCollectionCreateTaxIdParams.Type type) {
      this.type = type;
      return this;
    }
