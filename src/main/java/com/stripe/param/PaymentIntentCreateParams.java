...
public class PaymentIntentCreateParams extends ApiRequestParams {
  ...
  List<PaymentIntentCreateParams.ExcludedPaymentMethodType> excludedPaymentMethodTypes;
  ...
  public static class Builder {
    ...
    private List<PaymentIntentCreateParams.ExcludedPaymentMethodType> excludedPaymentMethodTypes;
    ...
    public Builder addAllExcludedPaymentMethodType(
        List<PaymentIntentCreateParams.ExcludedPaymentMethodType> elements) {
      if (this.excludedPaymentMethodTypes == null) {
        this.excludedPaymentMethodTypes = new ArrayList<>();
      }
  ...
  public static class AmountDetails {
    ...
    public static class Builder {
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentIntentCreateParams.AmountDetails#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PaymentIntentCreateParams.AmountDetails#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
       ...
       * PaymentIntentCreateParams.AmountDetails#lineItems} for the field documentation.
       */
      @SuppressWarnings("unchecked")
      public Builder addLineItem(PaymentIntentCreateParams.AmountDetails.LineItem element) {
        if (this.lineItems == null || this.lineItems instanceof EmptyParam) {
          this.lineItems = new ArrayList<PaymentIntentCreateParams.AmountDetails.LineItem>();
        }
        ((List<PaymentIntentCreateParams.AmountDetails.LineItem>) this.lineItems).add(element);
        return this;
      }
      ...
      public Builder addAllLineItem(
          List<PaymentIntentCreateParams.AmountDetails.LineItem> elements) {
        if (this.lineItems == null || this.lineItems instanceof EmptyParam) {
          this.lineItems = new ArrayList<PaymentIntentCreateParams.AmountDetails.LineItem>();
        }
        ((List<PaymentIntentCreateParams.AmountDetails.LineItem>) this.lineItems).addAll(elements);
        return this;
      }
      ...
      public Builder setLineItems(
          List<PaymentIntentCreateParams.AmountDetails.LineItem> lineItems) {
        this.lineItems = lineItems;
        return this;
      }

      /** Contains information about the shipping portion of the amount. */
      public Builder setShipping(PaymentIntentCreateParams.AmountDetails.Shipping shipping) {
        this.shipping = shipping;
        return this;
      }
    ...
    public static class LineItem {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public PaymentIntentCreateParams.AmountDetails.LineItem build() {
          return new PaymentIntentCreateParams.AmountDetails.LineItem(
              this.discountAmount,
              this.extraParams,
              this.paymentMethodOptions,
              this.productCode,
         ...
         * map. See {@link PaymentIntentCreateParams.AmountDetails.LineItem#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
        ...
        /** Payment method-specific information for line items. */
        public Builder setPaymentMethodOptions(
            PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions
        ...
        /** Contains information about the tax on the item. */
        public Builder setTax(PaymentIntentCreateParams.AmountDetails.LineItem.Tax tax) {
          this.tax = tax;
          return this;
        }
      ...
      public static class PaymentMethodOptions {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions build() {
            return new PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions(
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions#extraParams} for
        ...
        public static class Card {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions.Card
                build() {
              return new PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions.Card(
             ...
             * PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions.Card#extraParams}
        ...
        public static class CardPresent {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions.CardPresent
                build() {
              return new PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions.CardPresent#extraParams}
             * for the field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
        ...
        public static class Klarna {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions.Klarna
                build() {
              return new PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions
                  .Klarna(
                  this.extraParams,
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions.Klarna#extraParams}
             * for the field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
        ...
        public static class Paypal {
          ...
          public static class Builder {
            ...
            /** Finalize and obtain parameter instance from this builder. */
            public PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions.Paypal
                build() {
              return new PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions
            ...
            public Builder setCategory(
                PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions.Paypal
                        .Category
                    category) {
              this.category = category;
              return this;
             ...
             * `put/putAll` call, and subsequent calls add additional key/value pairs to the
             * original map. See {@link
             * PaymentIntentCreateParams.AmountDetails.LineItem.PaymentMethodOptions.Paypal#extraParams}
             * for the field documentation.
             */
            public Builder putExtraParam(String key, Object value) {
              if (this.extraParams == null) {
      ...
      public static class Tax {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public PaymentIntentCreateParams.AmountDetails.LineItem.Tax build() {
            return new PaymentIntentCreateParams.AmountDetails.LineItem.Tax(
           ...
           * Add a key/value pair to `extraParams` map. A map is initialized for the first
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link PaymentIntentCreateParams.AmountDetails.LineItem.Tax#extraParams} for
           * the field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
    ...
    public static class Shipping {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public PaymentIntentCreateParams.AmountDetails.Shipping build() {
          return new PaymentIntentCreateParams.AmountDetails.Shipping(
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link PaymentIntentCreateParams.AmountDetails.Shipping#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
    ...
    public static class Tax {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public PaymentIntentCreateParams.AmountDetails.Tax build() {
          return new PaymentIntentCreateParams.AmountDetails.Tax(
              this.extraParams, this.totalTaxAmount);
        }
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link PaymentIntentCreateParams.AmountDetails.Tax#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
  ...
  public static class PaymentMethodOptions {
    ...
    public static class Pix {
      ...
      public static class Builder {
         ...
         */
        public Builder setMandateOptions(
            PaymentIntentCreateParams.PaymentMethodOptions.Pix.MandateOptions mandateOptions) {
          this.mandateOptions = mandateOptions;
          return this;
        }
      ...
      public static class MandateOptions {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public PaymentIntentCreateParams.PaymentMethodOptions.Pix.MandateOptions build() {
            return new PaymentIntentCreateParams.PaymentMethodOptions.Pix.MandateOptions(
                this.amount,
                this.amountIncludesIof,
                this.amountType,
                this.currency,
          ...
          /** Determines if the amount includes the IOF tax. Defaults to {@code never}. */
          public Builder setAmountIncludesIof(
              PaymentIntentCreateParams.PaymentMethodOptions.Pix.MandateOptions.AmountIncludesIof
                  amountIncludesIof) {
            this.amountIncludesIof = amountIncludesIof;
            return this;
          }
          ...
          /** Type of amount. Defaults to {@code maximum}. */
          public Builder setAmountType(
              PaymentIntentCreateParams.PaymentMethodOptions.Pix.MandateOptions.AmountType
                  amountType) {
            this.amountType = amountType;
            return this;
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * PaymentIntentCreateParams.PaymentMethodOptions.Pix.MandateOptions#extraParams} for the
           * field documentation.
           */
          public Builder putExtraParam(String key, Object value) {
            if (this.extraParams == null) {
