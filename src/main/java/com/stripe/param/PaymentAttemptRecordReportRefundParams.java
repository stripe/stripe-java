...
public class PaymentAttemptRecordReportRefundParams extends ApiRequestParams {
  ...
  public static class Builder {
    ...
    /** Information about the refund failure. */
    public Builder setFailed(PaymentAttemptRecordReportRefundParams.Failed failed) {
      this.failed = failed;
      return this;
    }
     ...
     * requested_by_customer}.
     */
    public Builder setReason(PaymentAttemptRecordReportRefundParams.Reason reason) {
      this.reason = reason;
      return this;
    }
  ...
  public static class Failed {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PaymentAttemptRecordReportRefundParams.Failed build() {
        return new PaymentAttemptRecordReportRefundParams.Failed(
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentAttemptRecordReportRefundParams.Failed#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PaymentAttemptRecordReportRefundParams.Failed#extraParams} for the field
       * documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
      ...
      public Builder setFailureReason(
          PaymentAttemptRecordReportRefundParams.Failed.FailureReason failureReason) {
        this.failureReason = failureReason;
        return this;
      }
    }
