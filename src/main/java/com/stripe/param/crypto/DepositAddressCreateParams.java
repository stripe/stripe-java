...
public class DepositAddressCreateParams extends ApiRequestParams {
  ...
  private DepositAddressCreateParams(
      String customer,
      List<String> expand,
      Map<String, Object> extraParams,
      Map<String, String> metadata,
  ...
  public static class Builder {
    ...
    public DepositAddressCreateParams build() {
      return new DepositAddressCreateParams(
     ...
     * DepositAddressCreateParams#expand} for the field documentation.
     */
     ...
     * DepositAddressCreateParams#extraParams} for the field documentation.
     */
     ...
     * See {@link DepositAddressCreateParams#extraParams} for the field documentation.
     */
     ...
     * DepositAddressCreateParams#metadata} for the field documentation.
     */
     ...
     * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
     * See {@link DepositAddressCreateParams#metadata} for the field documentation.
     */
