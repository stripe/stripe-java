...
public class SubscriptionCancelParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     */
    public SubscriptionCancelParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public SubscriptionCancelParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     * proration invoice items.
     */
    public SubscriptionCancelParams.Builder setInvoiceNow(Boolean invoiceNow) {
