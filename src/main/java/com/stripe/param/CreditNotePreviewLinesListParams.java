  ...
  public static class Refund {
    ...
    public static class Builder {
      ...
      public Builder setPaymentRecordRefund(
          CreditNotePreviewLinesListParams.Refund.PaymentRecordRefund paymentRecordRefund) {
        this.paymentRecordRefund = paymentRecordRefund;
        return this;
      }
       ...
       * {@code refund}.
       */
      public Builder setType(CreditNotePreviewLinesListParams.Refund.Type type) {
        this.type = type;
        return this;
      }
    }
    ...
    public static class PaymentRecordRefund {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public CreditNotePreviewLinesListParams.Refund.PaymentRecordRefund build() {
          return new CreditNotePreviewLinesListParams.Refund.PaymentRecordRefund(
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link CreditNotePreviewLinesListParams.Refund.PaymentRecordRefund#extraParams}
