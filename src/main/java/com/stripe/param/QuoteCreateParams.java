...
public class QuoteCreateParams extends ApiRequestParams {
  ...
  public static class InvoiceSettings {
    ...
    public static class Builder {
       ...
       * call, and subsequent calls adds additional elements to the original list. See {@link
       * QuoteCreateParams.InvoiceSettings#customFields} for the field documentation.
       */
      @SuppressWarnings("unchecked")
      public Builder addCustomField(QuoteCreateParams.InvoiceSettings.CustomField element) {
        if (this.customFields == null || this.customFields instanceof EmptyParam) {
          this.customFields = new ArrayList<QuoteCreateParams.InvoiceSettings.CustomField>();
        }
        ((List<QuoteCreateParams.InvoiceSettings.CustomField>) this.customFields).add(element);
        return this;
      }
      ...
      public Builder addAllCustomField(
          List<QuoteCreateParams.InvoiceSettings.CustomField> elements) {
        if (this.customFields == null || this.customFields instanceof EmptyParam) {
          this.customFields = new ArrayList<QuoteCreateParams.InvoiceSettings.CustomField>();
        }
        ((List<QuoteCreateParams.InvoiceSettings.CustomField>) this.customFields).addAll(elements);
        return this;
      }
      ...
      public Builder setCustomFields(
          List<QuoteCreateParams.InvoiceSettings.CustomField> customFields) {
        this.customFields = customFields;
        return this;
      }
    ...
    public static class CustomField {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public QuoteCreateParams.InvoiceSettings.CustomField build() {
          return new QuoteCreateParams.InvoiceSettings.CustomField(
         ...
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link QuoteCreateParams.InvoiceSettings.CustomField#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
