...
@Getter
public class UsageRecordCreateParams extends ApiRequestParams {
  /**
  ...
  private UsageRecordCreateParams(
      Action action,
      List<String> expand,
      Map<String, Object> extraParams,
      Long quantity,
  ...
  public static class Builder {
    ...
    public UsageRecordCreateParams build() {
      return new UsageRecordCreateParams(
     ...
     * thresholds</a>, {@code increment} is the only allowed value.
     */
    public Builder setAction(UsageRecordCreateParams.Action action) {
      this.action = action;
      return this;
    }
     ...
     * UsageRecordCreateParams#expand} for the field documentation.
     */
     ...
     * UsageRecordCreateParams#extraParams} for the field documentation.
     */
     ...
     * See {@link UsageRecordCreateParams#extraParams} for the field documentation.
     */
     ...
     */
    public Builder setTimestamp(UsageRecordCreateParams.Timestamp timestamp) {
      this.timestamp = timestamp;
      return this;
    }
