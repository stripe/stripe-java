...
public class PriceCreateParams extends ApiRequestParams {
  ...
  public static class ProductData {
    ...
    public static class Builder {
       ...
       * code</a> and an optional performance location.
       */
      public Builder setTaxDetails(PriceCreateParams.ProductData.TaxDetails taxDetails) {
        this.taxDetails = taxDetails;
        return this;
      }
    ...
    public static class TaxDetails {
      ...
      public static class Builder {
        ...
        public PriceCreateParams.ProductData.TaxDetails build() {
          return new PriceCreateParams.ProductData.TaxDetails(this.extraParams, this.taxCode);
        }

        /**
         * Add a key/value pair to `extraParams` map. A map is initialized for the first
         * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
         * map. See {@link PriceCreateParams.ProductData.TaxDetails#extraParams} for the field
         * documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
