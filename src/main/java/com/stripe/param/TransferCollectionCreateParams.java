...
@Getter
public class TransferCollectionCreateParams extends ApiRequestParams {
  /**
  ...
  private TransferCollectionCreateParams(
      Long amount,
      String description,
      List<String> expand,
      Map<String, Object> extraParams,
  ...
  public static class Builder {
    ...
    public TransferCollectionCreateParams build() {
      return new TransferCollectionCreateParams(
          this.amount,
          this.description,
          this.expand,
          this.extraParams,
     ...
     * TransferCollectionCreateParams#expand} for the field documentation.
     */
     ...
     * TransferCollectionCreateParams#extraParams} for the field documentation.
     */
     ...
     * See {@link TransferCollectionCreateParams#extraParams} for the field documentation.
     */
     ...
     * TransferCollectionCreateParams#metadata} for the field documentation.
     */
     ...
     * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
     * See {@link TransferCollectionCreateParams#metadata} for the field documentation.
     */
    @SuppressWarnings("unchecked")
