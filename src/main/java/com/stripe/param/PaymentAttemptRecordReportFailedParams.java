...
public class PaymentAttemptRecordReportFailedParams extends ApiRequestParams {
  ...
  public static class Builder {
    ...
    public Builder setPaymentMethodDetails(
        PaymentAttemptRecordReportFailedParams.PaymentMethodDetails paymentMethodDetails) {
      this.paymentMethodDetails = paymentMethodDetails;
      return this;
    }
  ...
  public static class PaymentMethodDetails {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PaymentAttemptRecordReportFailedParams.PaymentMethodDetails build() {
        return new PaymentAttemptRecordReportFailedParams.PaymentMethodDetails(
            this.card, this.extraParams, this.type);
      }

      /** Information about the card payment method used to make this payment. */
      public Builder setCard(
          PaymentAttemptRecordReportFailedParams.PaymentMethodDetails.Card card) {
        this.card = card;
        return this;
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentAttemptRecordReportFailedParams.PaymentMethodDetails#extraParams} for the field
       * documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PaymentAttemptRecordReportFailedParams.PaymentMethodDetails#extraParams} for the
       * field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
      ...
      public Builder setType(
          PaymentAttemptRecordReportFailedParams.PaymentMethodDetails.Type type) {
        this.type = type;
        return this;
      }
    }
    ...
    public static class Card {
      ...
      public static class Builder {
        ...
        public Builder setChecks(
            PaymentAttemptRecordReportFailedParams.PaymentMethodDetails.Card.Checks checks) {
          this.checks = checks;
          return this;
        }
         ...
         * map. See {@link
         * PaymentAttemptRecordReportFailedParams.PaymentMethodDetails.Card#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
      ...
      public static class Checks {
        ...
        public static class Builder {
          ...
          /** Finalize and obtain parameter instance from this builder. */
          public PaymentAttemptRecordReportFailedParams.PaymentMethodDetails.Card.Checks build() {
            return new PaymentAttemptRecordReportFailedParams.PaymentMethodDetails.Card.Checks(
          ...
          public Builder setAddressLine1Check(
              PaymentAttemptRecordReportFailedParams.PaymentMethodDetails.Card.Checks
                      .AddressLine1Check
                  addressLine1Check) {
            this.addressLine1Check = addressLine1Check;
            return this;
          ...
          public Builder setCvcCheck(
              PaymentAttemptRecordReportFailedParams.PaymentMethodDetails.Card.Checks.CvcCheck
                  cvcCheck) {
            this.cvcCheck = cvcCheck;
            return this;
          }
           ...
           * `put/putAll` call, and subsequent calls add additional key/value pairs to the original
           * map. See {@link
           * PaymentAttemptRecordReportFailedParams.PaymentMethodDetails.Card.Checks#extraParams}
