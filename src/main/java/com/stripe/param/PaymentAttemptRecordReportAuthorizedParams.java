...
public class PaymentAttemptRecordReportAuthorizedParams extends ApiRequestParams {
  ...
  private PaymentAttemptRecordReportAuthorizedParams(
      Long authorizedAt,
      List<String> expand,
      Map<String, Object> extraParams,
      Object metadata,
  ...
  public static class Builder {
    ...
    /** When the reported payment was authorized. Measured in seconds since the Unix epoch. */
    public Builder setAuthorizedAt(Long authorizedAt) {
      this.authorizedAt = authorizedAt;
      return this;
    }
     ...
     * PaymentAttemptRecordReportAuthorizedParams#expand} for the field documentation.
     */
     ...
     * PaymentAttemptRecordReportAuthorizedParams#extraParams} for the field documentation.
     */
     ...
     * See {@link PaymentAttemptRecordReportAuthorizedParams#extraParams} for the field
     * documentation.
     */
     ...
     * PaymentAttemptRecordReportAuthorizedParams#metadata} for the field documentation.
     */
     ...
     * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
     * See {@link PaymentAttemptRecordReportAuthorizedParams#metadata} for the field documentation.
     */
    @SuppressWarnings("unchecked")
  ...
  public static class ProcessorDetails {
    ...
    public static class Builder {
      ...
      /** Finalize and obtain parameter instance from this builder. */
      public PaymentAttemptRecordReportAuthorizedParams.ProcessorDetails build() {
        return new PaymentAttemptRecordReportAuthorizedParams.ProcessorDetails(
            this.custom, this.extraParams, this.type);
      }

      /** Information about the custom processor used to make this payment. */
      public Builder setCustom(
          PaymentAttemptRecordReportAuthorizedParams.ProcessorDetails.Custom custom) {
        this.custom = custom;
        return this;
      }
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * PaymentAttemptRecordReportAuthorizedParams.ProcessorDetails#extraParams} for the field
       * documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link PaymentAttemptRecordReportAuthorizedParams.ProcessorDetails#extraParams} for the
       * field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
      ...
      public Builder setType(
          PaymentAttemptRecordReportAuthorizedParams.ProcessorDetails.Type type) {
        this.type = type;
        return this;
      }
    }
    ...
    public static class Custom {
      ...
      public static class Builder {
        ...
        /** Finalize and obtain parameter instance from this builder. */
        public PaymentAttemptRecordReportAuthorizedParams.ProcessorDetails.Custom build() {
          return new PaymentAttemptRecordReportAuthorizedParams.ProcessorDetails.Custom(
         ...
         * map. See {@link
         * PaymentAttemptRecordReportAuthorizedParams.ProcessorDetails.Custom#extraParams} for the
         * field documentation.
         */
        public Builder putExtraParam(String key, Object value) {
          if (this.extraParams == null) {
