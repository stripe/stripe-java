...
public class DisputeUpdateParams extends ApiRequestParams {
  ...
  public static class Builder {
     ...
     * 150,000.
     */
    public DisputeUpdateParams.Builder setEvidence(DisputeUpdateParams.Evidence evidence) {
     ...
     */
    public DisputeUpdateParams.Builder putExtraParam(String key, Object value) {
     ...
     */
    public DisputeUpdateParams.Builder putAllExtraParam(Map<String, Object> map) {
     ...
     */
    public DisputeUpdateParams.Builder putMetadata(String key, String value) {
     ...
     */
    public DisputeUpdateParams.Builder putAllMetadata(Map<String, String> map) {
