...
public final class CustomerBalanceTransactionService extends ApiService {
  ...
  public StripeCollection<CustomerBalanceTransaction> list(
      String id, CustomerBalanceTransactionListParams params) throws StripeException {
   ...
   * href="https://stripe.com/docs/billing/customer/balance">balances</a>.
   */
  public StripeCollection<CustomerBalanceTransaction> list(String id, RequestOptions options)
      throws StripeException {
    return list(id, (CustomerBalanceTransactionListParams) null, options);
  }
  /**
   * Returns a list of transactions that updated the customer’s <a
   * href="https://stripe.com/docs/billing/customer/balance">balances</a>.
   */
  public StripeCollection<CustomerBalanceTransaction> list(String id) throws StripeException {
    return list(id, (CustomerBalanceTransactionListParams) null, (RequestOptions) null);
  }
  /**
   * Returns a list of transactions that updated the customer’s <a
   * href="https://stripe.com/docs/billing/customer/balance">balances</a>.
   */
  public StripeCollection<CustomerBalanceTransaction> list(
      String id, CustomerBalanceTransactionListParams params, RequestOptions options)
      throws StripeException {
    String path =
        String.format("/v1/customers/%s/balance_transactions", ApiResource.urlEncodeId(id));
    ApiRequest request =
        new ApiRequest(
            BaseAddress.API,
   ...
   */
  public CustomerBalanceTransaction create(String id, CustomerBalanceTransactionCreateParams params)
      throws StripeException {
  ...
  public CustomerBalanceTransaction create(
      String id, CustomerBalanceTransactionCreateParams params, RequestOptions options)
      throws StripeException {
    String path =
        String.format("/v1/customers/%s/balance_transactions", ApiResource.urlEncodeId(id));
    ApiRequest request =
  ...
  public CustomerBalanceTransaction retrieve(
      String customerId, String id, CustomerBalanceTransactionRetrieveParams params)
      throws StripeException {
   ...
   * href="https://stripe.com/docs/billing/customer/balance">balances</a>.
   */
  public CustomerBalanceTransaction retrieve(String customerId, String id, RequestOptions options)
      throws StripeException {
    return retrieve(customerId, id, (CustomerBalanceTransactionRetrieveParams) null, options);
  }
  /**
   * Retrieves a specific customer balance transaction that updated the customer’s <a
   * href="https://stripe.com/docs/billing/customer/balance">balances</a>.
   */
  public CustomerBalanceTransaction retrieve(String customerId, String id) throws StripeException {
    return retrieve(
        customerId, id, (CustomerBalanceTransactionRetrieveParams) null, (RequestOptions) null);
  }
  /**
   * Retrieves a specific customer balance transaction that updated the customer’s <a
   * href="https://stripe.com/docs/billing/customer/balance">balances</a>.
  ...
  public CustomerBalanceTransaction update(
      String customerId, String id, CustomerBalanceTransactionUpdateParams params)
      throws StripeException {
   ...
   * description} and {@code metadata}.
   */
  public CustomerBalanceTransaction update(String customerId, String id, RequestOptions options)
      throws StripeException {
    return update(customerId, id, (CustomerBalanceTransactionUpdateParams) null, options);
  }
  /**
   * Most credit balance transaction fields are immutable, but you may update its {@code
   * description} and {@code metadata}.
   */
  public CustomerBalanceTransaction update(String customerId, String id) throws StripeException {
    return update(
        customerId, id, (CustomerBalanceTransactionUpdateParams) null, (RequestOptions) null);
  }
  /**
   * Most credit balance transaction fields are immutable, but you may update its {@code
   * description} and {@code metadata}.
  ...
  public String serializeBatchCreate(String id, CustomerBalanceTransactionCreateParams params)
      throws StripeException {
