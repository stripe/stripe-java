...
public class RootServices {
  ...
  private final Lazy<ChargeService> chargeService =
      new Lazy<>(() -> new ChargeService(this.client));

  private final Lazy<CouponService> couponService =
      new Lazy<>(() -> new CouponService(this.client));
