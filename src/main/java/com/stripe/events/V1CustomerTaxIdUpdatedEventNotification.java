...
@Getter
public final class V1CustomerTaxIdUpdatedEventNotification extends EventNotification {
  ...
  @Override
  public V1CustomerTaxIdUpdatedEvent fetchEvent() throws StripeException {
    return (V1CustomerTaxIdUpdatedEvent) super.fetchEvent();
  }
}
