...
@Getter
public final class V1IssuingPersonalizationDesignRejectedEventNotification
  ...
  @Override
  public V1IssuingPersonalizationDesignRejectedEvent fetchEvent() throws StripeException {
    return (V1IssuingPersonalizationDesignRejectedEvent) super.fetchEvent();
  }
}
