...
@Getter
public final class V1InvoiceVoidedEventNotification extends EventNotification {
  ...
  @Override
  public V1InvoiceVoidedEvent fetchEvent() throws StripeException {
    return (V1InvoiceVoidedEvent) super.fetchEvent();
  }
}
