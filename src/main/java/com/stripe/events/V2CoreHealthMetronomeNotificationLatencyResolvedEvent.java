...
@Getter
public final class V2CoreHealthMetronomeNotificationLatencyResolvedEvent extends Event {
  /** Data for the v2.core.health.metronome_notification_latency.resolved event. */
  @SerializedName("data")
  V2CoreHealthMetronomeNotificationLatencyResolvedEvent.EventData data;
