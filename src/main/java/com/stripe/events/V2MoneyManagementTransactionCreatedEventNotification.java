...
@Getter
public final class V2MoneyManagementTransactionCreatedEventNotification extends EventNotification {
  ...
  @Override
  public V2MoneyManagementTransactionCreatedEvent fetchEvent() throws StripeException {
    return (V2MoneyManagementTransactionCreatedEvent) super.fetchEvent();
  }
}
