...
@Getter
public final class V2MoneyManagementOutboundTransferReturnedEventNotification
  ...
  @Override
  public V2MoneyManagementOutboundTransferReturnedEvent fetchEvent() throws StripeException {
    return (V2MoneyManagementOutboundTransferReturnedEvent) super.fetchEvent();
  }
}
