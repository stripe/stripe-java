...
@Getter
public final class V1RefundCreatedEventNotification extends EventNotification {
  ...
  @Override
  public V1RefundCreatedEvent fetchEvent() throws StripeException {
    return (V1RefundCreatedEvent) super.fetchEvent();
  }
}
