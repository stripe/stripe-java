...
@Getter
public final class V1InvoiceOverdueEventNotification extends EventNotification {
  ...
  @Override
  public V1InvoiceOverdueEvent fetchEvent() throws StripeException {
    return (V1InvoiceOverdueEvent) super.fetchEvent();
  }
}
