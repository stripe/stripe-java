...
@Getter
public final class V1IssuingDisputeCreatedEventNotification extends EventNotification {
  ...
  @Override
  public V1IssuingDisputeCreatedEvent fetchEvent() throws StripeException {
    return (V1IssuingDisputeCreatedEvent) super.fetchEvent();
  }
}
