...
@Getter
public final class V1PersonUpdatedEventNotification extends EventNotification {
  ...
  @Override
  public V1PersonUpdatedEvent fetchEvent() throws StripeException {
    return (V1PersonUpdatedEvent) super.fetchEvent();
  }
}
