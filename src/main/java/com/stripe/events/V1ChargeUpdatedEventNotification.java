...
@Getter
public final class V1ChargeUpdatedEventNotification extends EventNotification {
  ...
  @Override
  public V1ChargeUpdatedEvent fetchEvent() throws StripeException {
    return (V1ChargeUpdatedEvent) super.fetchEvent();
  }
}
