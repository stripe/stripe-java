...
@Getter
public final class V1IssuingDisputeFundsRescindedEventNotification extends EventNotification {
  ...
  @Override
  public V1IssuingDisputeFundsRescindedEvent fetchEvent() throws StripeException {
    return (V1IssuingDisputeFundsRescindedEvent) super.fetchEvent();
  }
}
