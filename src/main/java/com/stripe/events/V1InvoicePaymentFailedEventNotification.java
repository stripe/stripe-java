...
@Getter
public final class V1InvoicePaymentFailedEventNotification extends EventNotification {
  ...
  @Override
  public V1InvoicePaymentFailedEvent fetchEvent() throws StripeException {
    return (V1InvoicePaymentFailedEvent) super.fetchEvent();
  }
}
