...
@Getter
public final class V2BillingCadenceCanceledEventNotification extends EventNotification {
  ...
  @Override
  public V2BillingCadenceCanceledEvent fetchEvent() throws StripeException {
    return (V2BillingCadenceCanceledEvent) super.fetchEvent();
  }
}
