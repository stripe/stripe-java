...
@Getter
public final class V1IssuingDisputeSubmittedEventNotification extends EventNotification {
  ...
  @Override
  public V1IssuingDisputeSubmittedEvent fetchEvent() throws StripeException {
    return (V1IssuingDisputeSubmittedEvent) super.fetchEvent();
  }
}
