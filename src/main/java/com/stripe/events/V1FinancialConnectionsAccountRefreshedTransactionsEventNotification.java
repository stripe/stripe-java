...
@Getter
public final class V1FinancialConnectionsAccountRefreshedTransactionsEventNotification
  ...
  public V1FinancialConnectionsAccountRefreshedTransactionsEvent fetchEvent()
    ...
    return (V1FinancialConnectionsAccountRefreshedTransactionsEvent) super.fetchEvent();
  }
}
