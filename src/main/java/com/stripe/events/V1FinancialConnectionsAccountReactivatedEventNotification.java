...
@Getter
public final class V1FinancialConnectionsAccountReactivatedEventNotification
  ...
  @Override
  public V1FinancialConnectionsAccountReactivatedEvent fetchEvent() throws StripeException {
    return (V1FinancialConnectionsAccountReactivatedEvent) super.fetchEvent();
  }
}
