...
@Getter
public final class V1IssuingDisputeClosedEventNotification extends EventNotification {
  ...
  @Override
  public V1IssuingDisputeClosedEvent fetchEvent() throws StripeException {
    return (V1IssuingDisputeClosedEvent) super.fetchEvent();
  }
}
