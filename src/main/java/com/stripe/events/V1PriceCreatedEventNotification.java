...
@Getter
public final class V1PriceCreatedEventNotification extends EventNotification {
  ...
  @Override
  public V1PriceCreatedEvent fetchEvent() throws StripeException {
    return (V1PriceCreatedEvent) super.fetchEvent();
  }
}
