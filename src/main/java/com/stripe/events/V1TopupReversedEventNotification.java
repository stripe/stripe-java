...
@Getter
public final class V1TopupReversedEventNotification extends EventNotification {
  ...
  @Override
  public V1TopupReversedEvent fetchEvent() throws StripeException {
    return (V1TopupReversedEvent) super.fetchEvent();
  }
}
