...
@Getter
public final class V1FinancialConnectionsAccountDisconnectedEventNotification
  ...
  @Override
  public V1FinancialConnectionsAccountDisconnectedEvent fetchEvent() throws StripeException {
    return (V1FinancialConnectionsAccountDisconnectedEvent) super.fetchEvent();
  }
}
