...
@Getter
public final class V1InvoicePaidEventNotification extends EventNotification {
  ...
  @Override
  public V1InvoicePaidEvent fetchEvent() throws StripeException {
    return (V1InvoicePaidEvent) super.fetchEvent();
  }
}
