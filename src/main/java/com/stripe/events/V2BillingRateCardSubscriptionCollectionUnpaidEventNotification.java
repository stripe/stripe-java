...
@Getter
public final class V2BillingRateCardSubscriptionCollectionUnpaidEventNotification
  ...
  @Override
  public V2BillingRateCardSubscriptionCollectionUnpaidEvent fetchEvent() throws StripeException {
    return (V2BillingRateCardSubscriptionCollectionUnpaidEvent) super.fetchEvent();
  }
}
