...
@Getter
public final class V2MoneyManagementOutboundTransferCreatedEventNotification
  ...
  @Override
  public V2MoneyManagementOutboundTransferCreatedEvent fetchEvent() throws StripeException {
    return (V2MoneyManagementOutboundTransferCreatedEvent) super.fetchEvent();
  }
}
