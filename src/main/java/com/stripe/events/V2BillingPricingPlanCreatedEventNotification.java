...
@Getter
public final class V2BillingPricingPlanCreatedEventNotification extends EventNotification {
  ...
  @Override
  public V2BillingPricingPlanCreatedEvent fetchEvent() throws StripeException {
    return (V2BillingPricingPlanCreatedEvent) super.fetchEvent();
  }
}
