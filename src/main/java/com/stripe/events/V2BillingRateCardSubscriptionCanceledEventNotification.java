...
@Getter
public final class V2BillingRateCardSubscriptionCanceledEventNotification
  ...
  @Override
  public V2BillingRateCardSubscriptionCanceledEvent fetchEvent() throws StripeException {
    return (V2BillingRateCardSubscriptionCanceledEvent) super.fetchEvent();
  }
}
