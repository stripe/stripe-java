...
@Getter
public final class V2BillingRateCardSubscriptionCollectionPausedEventNotification
  ...
  @Override
  public V2BillingRateCardSubscriptionCollectionPausedEvent fetchEvent() throws StripeException {
    return (V2BillingRateCardSubscriptionCollectionPausedEvent) super.fetchEvent();
  }
}
