...
@Getter
public final class V2MoneyManagementInboundTransferBankDebitFailedEventNotification
  ...
  @Override
  public V2MoneyManagementInboundTransferBankDebitFailedEvent fetchEvent() throws StripeException {
    return (V2MoneyManagementInboundTransferBankDebitFailedEvent) super.fetchEvent();
  }
}
