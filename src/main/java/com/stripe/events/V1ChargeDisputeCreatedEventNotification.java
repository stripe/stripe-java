...
@Getter
public final class V1ChargeDisputeCreatedEventNotification extends EventNotification {
  ...
  @Override
  public V1ChargeDisputeCreatedEvent fetchEvent() throws StripeException {
    return (V1ChargeDisputeCreatedEvent) super.fetchEvent();
  }
}
