...
@Getter
public final class V2PaymentsOffSessionPaymentFailedEventNotification extends EventNotification {
  ...
  @Override
  public V2PaymentsOffSessionPaymentFailedEvent fetchEvent() throws StripeException {
    return (V2PaymentsOffSessionPaymentFailedEvent) super.fetchEvent();
  }
}
