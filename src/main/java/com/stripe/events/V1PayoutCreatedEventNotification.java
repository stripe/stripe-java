...
@Getter
public final class V1PayoutCreatedEventNotification extends EventNotification {
  ...
  @Override
  public V1PayoutCreatedEvent fetchEvent() throws StripeException {
    return (V1PayoutCreatedEvent) super.fetchEvent();
  }
}
