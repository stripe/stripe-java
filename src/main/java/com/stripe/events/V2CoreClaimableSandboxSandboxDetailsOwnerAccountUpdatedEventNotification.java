...
@Getter
public final class V2CoreClaimableSandboxSandboxDetailsOwnerAccountUpdatedEventNotification
  ...
  public V2CoreClaimableSandboxSandboxDetailsOwnerAccountUpdatedEvent fetchEvent()
    ...
    return (V2CoreClaimableSandboxSandboxDetailsOwnerAccountUpdatedEvent) super.fetchEvent();
  }
}
