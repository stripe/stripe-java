...
@Getter
public final class V1PriceDeletedEventNotification extends EventNotification {
  ...
  @Override
  public V1PriceDeletedEvent fetchEvent() throws StripeException {
    return (V1PriceDeletedEvent) super.fetchEvent();
  }
}
