...
@Getter
public final class V1PaymentLinkCreatedEventNotification extends EventNotification {
  ...
  @Override
  public V1PaymentLinkCreatedEvent fetchEvent() throws StripeException {
    return (V1PaymentLinkCreatedEvent) super.fetchEvent();
  }
}
