...
@Getter
public final class V2PaymentsOffSessionPaymentCreatedEventNotification extends EventNotification {
  ...
  @Override
  public V2PaymentsOffSessionPaymentCreatedEvent fetchEvent() throws StripeException {
    return (V2PaymentsOffSessionPaymentCreatedEvent) super.fetchEvent();
  }
}
