...
@Getter
public final class V2MoneyManagementOutboundPaymentFailedEventNotification
  ...
  @Override
  public V2MoneyManagementOutboundPaymentFailedEvent fetchEvent() throws StripeException {
    return (V2MoneyManagementOutboundPaymentFailedEvent) super.fetchEvent();
  }
}
