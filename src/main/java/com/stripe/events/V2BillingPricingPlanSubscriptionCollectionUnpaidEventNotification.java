...
@Getter
public final class V2BillingPricingPlanSubscriptionCollectionUnpaidEventNotification
  ...
  @Override
  public V2BillingPricingPlanSubscriptionCollectionUnpaidEvent fetchEvent() throws StripeException {
    return (V2BillingPricingPlanSubscriptionCollectionUnpaidEvent) super.fetchEvent();
  }
}
