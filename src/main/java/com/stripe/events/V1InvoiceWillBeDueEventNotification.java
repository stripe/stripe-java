...
@Getter
public final class V1InvoiceWillBeDueEventNotification extends EventNotification {
  ...
  @Override
  public V1InvoiceWillBeDueEvent fetchEvent() throws StripeException {
    return (V1InvoiceWillBeDueEvent) super.fetchEvent();
  }
}
