...
@Getter
public final class V2BillingPricingPlanSubscriptionServicingPausedEventNotification
  ...
  @Override
  public V2BillingPricingPlanSubscriptionServicingPausedEvent fetchEvent() throws StripeException {
    return (V2BillingPricingPlanSubscriptionServicingPausedEvent) super.fetchEvent();
  }
}
