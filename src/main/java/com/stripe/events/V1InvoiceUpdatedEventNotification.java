...
@Getter
public final class V1InvoiceUpdatedEventNotification extends EventNotification {
  ...
  @Override
  public V1InvoiceUpdatedEvent fetchEvent() throws StripeException {
    return (V1InvoiceUpdatedEvent) super.fetchEvent();
  }
}
