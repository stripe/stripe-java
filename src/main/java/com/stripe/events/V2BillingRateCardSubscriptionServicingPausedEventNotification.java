...
@Getter
public final class V2BillingRateCardSubscriptionServicingPausedEventNotification
  ...
  @Override
  public V2BillingRateCardSubscriptionServicingPausedEvent fetchEvent() throws StripeException {
    return (V2BillingRateCardSubscriptionServicingPausedEvent) super.fetchEvent();
  }
}
