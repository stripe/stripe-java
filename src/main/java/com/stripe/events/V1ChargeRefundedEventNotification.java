...
@Getter
public final class V1ChargeRefundedEventNotification extends EventNotification {
  ...
  @Override
  public V1ChargeRefundedEvent fetchEvent() throws StripeException {
    return (V1ChargeRefundedEvent) super.fetchEvent();
  }
}
