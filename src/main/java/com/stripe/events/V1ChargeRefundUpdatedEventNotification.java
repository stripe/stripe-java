...
@Getter
public final class V1ChargeRefundUpdatedEventNotification extends EventNotification {
  ...
  @Override
  public V1ChargeRefundUpdatedEvent fetchEvent() throws StripeException {
    return (V1ChargeRefundUpdatedEvent) super.fetchEvent();
  }
}
