...
@Getter
public final class V2PaymentsOffSessionPaymentSucceededEventNotification extends EventNotification {
  ...
  @Override
  public V2PaymentsOffSessionPaymentSucceededEvent fetchEvent() throws StripeException {
    return (V2PaymentsOffSessionPaymentSucceededEvent) super.fetchEvent();
  }
}
