...
@Getter
public final class V1PlanUpdatedEventNotification extends EventNotification {
  ...
  @Override
  public V1PlanUpdatedEvent fetchEvent() throws StripeException {
    return (V1PlanUpdatedEvent) super.fetchEvent();
  }
}
