...
@Getter
public final class V1ChargeSucceededEventNotification extends EventNotification {
  ...
  @Override
  public V1ChargeSucceededEvent fetchEvent() throws StripeException {
    return (V1ChargeSucceededEvent) super.fetchEvent();
  }
}
