...
@Getter
public final class V2BillingLicenseFeeVersionCreatedEventNotification extends EventNotification {
  ...
  @Override
  public V2BillingLicenseFeeVersionCreatedEvent fetchEvent() throws StripeException {
    return (V2BillingLicenseFeeVersionCreatedEvent) super.fetchEvent();
  }
}
