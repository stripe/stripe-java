...
@Getter
public final class V2BillingRateCardSubscriptionActivatedEventNotification
  ...
  @Override
  public V2BillingRateCardSubscriptionActivatedEvent fetchEvent() throws StripeException {
    return (V2BillingRateCardSubscriptionActivatedEvent) super.fetchEvent();
  }
}
