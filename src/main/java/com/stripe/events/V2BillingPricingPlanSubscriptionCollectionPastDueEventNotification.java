...
@Getter
public final class V2BillingPricingPlanSubscriptionCollectionPastDueEventNotification
  ...
  @Override
  public V2BillingPricingPlanSubscriptionCollectionPastDueEvent fetchEvent()
      throws StripeException {
    return (V2BillingPricingPlanSubscriptionCollectionPastDueEvent) super.fetchEvent();
  }
}
