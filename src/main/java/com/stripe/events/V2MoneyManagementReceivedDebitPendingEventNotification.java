...
@Getter
public final class V2MoneyManagementReceivedDebitPendingEventNotification
  ...
  @Override
  public V2MoneyManagementReceivedDebitPendingEvent fetchEvent() throws StripeException {
    return (V2MoneyManagementReceivedDebitPendingEvent) super.fetchEvent();
  }
}
