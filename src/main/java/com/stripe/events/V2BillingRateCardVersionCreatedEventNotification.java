...
@Getter
public final class V2BillingRateCardVersionCreatedEventNotification extends EventNotification {
  ...
  @Override
  public V2BillingRateCardVersionCreatedEvent fetchEvent() throws StripeException {
    return (V2BillingRateCardVersionCreatedEvent) super.fetchEvent();
  }
}
