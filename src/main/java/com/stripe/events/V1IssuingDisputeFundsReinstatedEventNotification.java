...
@Getter
public final class V1IssuingDisputeFundsReinstatedEventNotification extends EventNotification {
  ...
  @Override
  public V1IssuingDisputeFundsReinstatedEvent fetchEvent() throws StripeException {
    return (V1IssuingDisputeFundsReinstatedEvent) super.fetchEvent();
  }
}
