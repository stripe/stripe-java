...
@Getter
public final class V2CoreHealthIssuingAuthorizationRequestErrorsFiringEvent extends Event {
  /** Data for the v2.core.health.issuing_authorization_request_errors.firing event. */
  @SerializedName("data")
  V2CoreHealthIssuingAuthorizationRequestErrorsFiringEvent.EventData data;
