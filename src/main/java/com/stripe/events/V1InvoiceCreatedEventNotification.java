...
@Getter
public final class V1InvoiceCreatedEventNotification extends EventNotification {
  ...
  @Override
  public V1InvoiceCreatedEvent fetchEvent() throws StripeException {
    return (V1InvoiceCreatedEvent) super.fetchEvent();
  }
}
