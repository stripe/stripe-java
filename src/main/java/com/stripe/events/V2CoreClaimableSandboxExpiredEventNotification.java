...
@Getter
public final class V2CoreClaimableSandboxExpiredEventNotification extends EventNotification {
  ...
  @Override
  public V2CoreClaimableSandboxExpiredEvent fetchEvent() throws StripeException {
    return (V2CoreClaimableSandboxExpiredEvent) super.fetchEvent();
  }
}
