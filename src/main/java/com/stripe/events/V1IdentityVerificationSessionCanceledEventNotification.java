...
@Getter
public final class V1IdentityVerificationSessionCanceledEventNotification
  ...
  @Override
  public V1IdentityVerificationSessionCanceledEvent fetchEvent() throws StripeException {
    return (V1IdentityVerificationSessionCanceledEvent) super.fetchEvent();
  }
}
