...
@Getter
public final class V2PaymentsOffSessionPaymentAuthorizationAttemptStartedEventNotification
  ...
  public V2PaymentsOffSessionPaymentAuthorizationAttemptStartedEvent fetchEvent()
    ...
    return (V2PaymentsOffSessionPaymentAuthorizationAttemptStartedEvent) super.fetchEvent();
  }
}
