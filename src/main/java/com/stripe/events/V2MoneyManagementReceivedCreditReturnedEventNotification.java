...
@Getter
public final class V2MoneyManagementReceivedCreditReturnedEventNotification
  ...
  @Override
  public V2MoneyManagementReceivedCreditReturnedEvent fetchEvent() throws StripeException {
    return (V2MoneyManagementReceivedCreditReturnedEvent) super.fetchEvent();
  }
}
