...
@Getter
public final class V1IssuingDisputeUpdatedEventNotification extends EventNotification {
  ...
  @Override
  public V1IssuingDisputeUpdatedEvent fetchEvent() throws StripeException {
    return (V1IssuingDisputeUpdatedEvent) super.fetchEvent();
  }
}
