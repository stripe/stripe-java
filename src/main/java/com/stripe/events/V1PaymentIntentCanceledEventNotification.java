...
@Getter
public final class V1PaymentIntentCanceledEventNotification extends EventNotification {
  ...
  @Override
  public V1PaymentIntentCanceledEvent fetchEvent() throws StripeException {
    return (V1PaymentIntentCanceledEvent) super.fetchEvent();
  }
}
