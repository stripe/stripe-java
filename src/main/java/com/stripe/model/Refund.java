...
public class Refund extends ApiResource implements MetadataStore<Refund>, BalanceTransactionSource {
  ...
  /**
   * If the refund failed, the reason for refund failure if known. Possible values are {@code lost_or_stolen_card}, {@code expired_or_canceled_card}, or {@code unknown}.
   */
  ...
  /**
   * Reason for the refund, either user-provided ({@code duplicate}, {@code fraudulent}, or {@code requested_by_customer}) or generated by Stripe internally ({@code expired_uncaptured_charge}).
   */
  ...
  /**
   * Status of the refund. For credit card refunds, this can be {@code pending}, {@code succeeded}, or {@code failed}. For other types of refunds, it can be {@code pending}, {@code succeeded}, {@code failed}, or {@code canceled}. Refer to our <a href="https://stripe.com/docs/refunds#failed-refunds">refunds</a> documentation for more details.
   */
