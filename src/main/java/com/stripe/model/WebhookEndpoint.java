...
public class WebhookEndpoint extends ApiResource implements HasId, MetadataStore<WebhookEndpoint> {
  ...
  /**
   * The list of events to enable for this endpoint. {@code ['*']} indicates that all events are enabled, except those that require explicit selection.
   */
  ...
  /**
   * The endpoint's secret, used to generate <a href="https://stripe.com/docs/webhooks/signatures">webhook signatures</a>. Only returned at creation.
   */
