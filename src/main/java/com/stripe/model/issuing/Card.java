...
public class Card extends ApiResource implements HasId, MetadataStore<Card> {
  ...
  /**
   * An Issuing {@code Cardholder} object represents an individual or business entity who is <a href="https://stripe.com/docs/issuing">issued</a> cards.
   *
   * <p>Related guide: <a href="https://stripe.com/docs/issuing/cards#create-cardholder">How to create a Cardholder</a>
   */
  ...
  /**
   * The card's CVC. For security reasons, this is only available for virtual cards, and will be omitted unless you explicitly request it with <a href="https://stripe.com/docs/api/expanding_objects">the {@code expand} parameter</a>. Additionally, it's only available via the <a href="https://stripe.com/docs/api/issuing/cards/retrieve">&quot;Retrieve a card&quot; endpoint</a>, not via &quot;List all cards&quot; or any other endpoint.
   */
  @SerializedName("cvc")
  String cvc;
  ...
  public static class Shipping extends StripeObject {
     ...
     *
     * <p>One of {@code canceled}, {@code delivered}, {@code failure}, {@code pending}, {@code returned}, or {@code shipped}.
     */
    @SerializedName("status")
    String status;
  ...
  public static class SpendingControls extends StripeObject {
    ...
    /**
     * Currency of the amounts within {@code spending_limits}. Always the same as the currency of the card.
     */
    ...
    public static class SpendingLimit extends StripeObject {
      /**
       * Maximum amount allowed to spend per interval. This amount is in the card's currency and in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>.
       */
       ...
       *
       * <p>One of {@code all_time}, {@code daily}, {@code monthly}, {@code per_authorization}, {@code weekly}, or {@code yearly}.
       */
  ...
  public static class Wallets extends StripeObject {
    ...
    public static class ApplePay extends StripeObject {
       ...
       *
       * <p>One of {@code missing_agreement}, {@code missing_cardholder_contact}, or {@code unsupported_region}.
       */
