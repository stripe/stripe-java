...
public class Transaction
  ...
  /**
   * The transaction amount, which will be reflected in your balance. This amount is in your currency and in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>.
   */
  ...
  /**
   * ID of the <a href="https://stripe.com/docs/api/balance_transactions">balance transaction</a> associated with this transaction.
   */
  ...
  /**
   * The amount that the merchant will receive, denominated in {@code merchant_currency} and in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>. It will be different from {@code amount} if the merchant is taking payment in a different currency.
   */
  ...
  /**
   * <a href="https://stripe.com/docs/api/treasury">Treasury</a> details related to this transaction if it was created on a [FinancialAccount](/docs/api/treasury/financial_accounts
   */
  ...
  /**
   * The digital wallet used for this transaction. One of {@code apple_pay}, {@code google_pay}, or {@code samsung_pay}.
   */
  ...
  public static class PurchaseDetails extends StripeObject {
    ...
    public static class Fuel extends StripeObject {
      /**
       * The type of fuel that was purchased. One of {@code diesel}, {@code unleaded_plus}, {@code unleaded_regular}, {@code unleaded_super}, or {@code other}.
       */
      @SerializedName("type")
      String type;
  ...
  public static class Treasury extends StripeObject {
    /**
     * The Treasury <a href="https://stripe.com/docs/api/treasury/received_debits">ReceivedCredit</a> representing this Issuing transaction if it is a refund
     */
    @SerializedName("received_credit")
    String receivedCredit;

    /**
     * The Treasury <a href="https://stripe.com/docs/api/treasury/received_credits">ReceivedDebit</a> representing this Issuing transaction if it is a capture
     */
