...
public class Settlement extends ApiResource implements HasId, MetadataStore<Settlement> {
  ...
  /** The total net fees owed to the network. */
  Long networkFees;
  ...
  /** The total number of transactions involved in this settlement. */
  Long transactionCount;

  /** The total transaction amount involved in this settlement. */
