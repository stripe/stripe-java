...
public class Authorization
  ...
  /**
   * The total amount that was authorized or rejected. This amount is in the card's currency and in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>.
   */
  @SerializedName("amount")
  Long amount;

  /**
   * Detailed breakdown of amount components. These amounts are denominated in {@code currency} and in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>.
   */
   ...
   *
   * <p>One of {@code chip}, {@code contactless}, {@code keyed_in}, {@code online}, or {@code swipe}.
   */
  ...
  /**
   * The total amount that was authorized or rejected. This amount is in the {@code merchant_currency} and in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>.
   */
  @SerializedName("merchant_amount")
  Long merchantAmount;

  /**
   * The currency that was presented to the cardholder for the authorization. Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
   */
  ...
  /**
   * The pending authorization request. This field will only be non-null during an {@code issuing_authorization.request} webhook.
   */
  @SerializedName("pending_request")
  PendingRequest pendingRequest;

  /**
   * History of every time {@code pending_request} was approved/denied, either by you directly or by Stripe (e.g. based on your {@code spending_controls}). If the merchant changes the authorization by performing an <a href="https://stripe.com/docs/issuing/purchases/authorizations">incremental authorization</a>, you can look at this field to see the previous requests for the authorization.
   */
  ...
  /**
   * List of <a href="https://stripe.com/docs/api/issuing/transactions">transactions</a> associated with this authorization.
   */
  @SerializedName("transactions")
  List<Transaction> transactions;

  /**
   * <a href="https://stripe.com/docs/api/treasury">Treasury</a> details related to this authorization if it was created on a <a href="https://stripe.com/docs/api/treasury/financial_accounts">FinancialAccount</a>.
   */
  ...
  /**
   * The digital wallet used for this authorization. One of {@code apple_pay}, {@code google_pay}, or {@code samsung_pay}.
   */
  ...
  /**
   * <p>Approves a pending Issuing <code>Authorization</code> object. This request should be made within the timeout window of the <a href="https://stripe.com/docs/issuing/controls/real-time-authorizations">real-time authorization</a> flow.</p>
   */
  ...
  public Authorization approve(
    ...
    String url =
      String.format(
        ...
        Stripe.getApiBase(),
        String.format(
          "/v1/issuing/authorizations/%s/approve",
  ...
  /**
   * <p>Declines a pending Issuing <code>Authorization</code> object. This request should be made within the timeout window of the <a href="https://stripe.com/docs/issuing/controls/real-time-authorizations">real time authorization</a> flow.</p>
   */
  ...
  public Authorization decline(
    ...
    String url =
      String.format(
        ...
        Stripe.getApiBase(),
        String.format(
          "/v1/issuing/authorizations/%s/decline",
          ApiResource.urlEncodeId(this.getId())
        )
      );
    return ApiResource.request(
  ...
  public static class MerchantData extends StripeObject {
    /**
     * A categorization of the seller's type of business. See our <a href="https://stripe.com/docs/issuing/merchant-categories">merchant categories guide</a> for a list of possible values.
     */
  ...
  public static class PendingRequest extends StripeObject {
    /**
     * The additional amount Stripe will hold if the authorization is approved, in the card's <a href="https://stripe.com/docs/api#issuing_authorization_object-pending-request-currency">currency</a> and in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>.
     */
    @SerializedName("amount")
    Long amount;
    ...
    /**
     * If set {@code true}, you may provide <a href="https://stripe.com/docs/api/issuing/authorizations/approve#approve_issuing_authorization-amount">amount</a> to control how much to hold for the authorization.
     */
    @SerializedName("is_amount_controllable")
    Boolean isAmountControllable;

    /**
     * The amount the merchant is requesting to be authorized in the {@code merchant_currency}. The amount is in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>.
     */
    @SerializedName("merchant_amount")
    Long merchantAmount;
  ...
  public static class RequestHistory extends StripeObject {
    /**
     * The {@code pending_request.amount} at the time of the request, presented in your card's currency and in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>. Stripe held this amount from your account to fund the authorization if the request was approved.
     */
    @SerializedName("amount")
    Long amount;
    ...
    /**
     * The {@code pending_request.merchant_amount} at the time of the request, presented in the {@code merchant_currency} and in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>.
     */
    @SerializedName("merchant_amount")
    Long merchantAmount;

    /**
     * The currency that was collected by the merchant and presented to the cardholder for the authorization. Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
     */
    @SerializedName("merchant_currency")
    String merchantCurrency;
     ...
     *
     * <p>One of {@code account_disabled}, {@code card_active}, {@code card_inactive}, {@code cardholder_inactive}, {@code cardholder_verification_required}, {@code insufficient_funds}, {@code not_allowed}, {@code spending_controls}, {@code suspected_fraud}, {@code verification_failed}, {@code webhook_approved}, {@code webhook_declined}, or {@code webhook_timeout}.
     */
  ...
  public static class Treasury extends StripeObject {
    /**
     * The array of <a href="https://stripe.com/docs/api/treasury/received_credits">ReceivedCredits</a> associated with this authorization
     */
    @SerializedName("received_credits")
    List<String> receivedCredits;

    /**
     * The array of <a href="https://stripe.com/docs/api/treasury/received_debits">ReceivedDebits</a> associated with this authorization
     */
    @SerializedName("received_debits")
    List<String> receivedDebits;

    /**
     * The Treasury <a href="https://stripe.com/docs/api/treasury/transactions">Transaction</a> associated with this authorization
     */
  ...
  public static class VerificationData extends StripeObject {
    /**
     * Whether the cardholder provided an address first line and if it matched the cardholder’s {@code billing.address.line1}.
     *
    ...
    /**
     * Whether the cardholder provided a postal code and if it matched the cardholder’s {@code billing.address.postal_code}.
     *
     * <p>One of {@code match}, {@code mismatch}, or {@code not_provided}.
     */
