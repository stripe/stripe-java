...
public class Reader extends ApiResource implements HasId, MetadataStore<Reader> {
  ...
  /**
   * Type of reader, one of {@code bbpos_wisepad3}, {@code stripe_m2}, {@code bbpos_chipper2x}, {@code bbpos_wisepos_e}, {@code verifone_P400}, or {@code simulated_wisepos_e}.
   */
   ...
   */
  public Reader processPaymentIntent(
      ReaderProcessPaymentIntentParams params) throws StripeException {
    return processPaymentIntent(params, (RequestOptions) null);
  }
  ...
  public Reader cancelAction(
    ...
    String url =
      String.format(
        ...
        Stripe.getApiBase(),
        String.format(
          "/v1/terminal/readers/%s/cancel_action",
          ApiResource.urlEncodeId(this.getId())
        )
      );
    return ApiResource.request(ApiResource.RequestMethod.POST, url, params, Reader.class, options);
   ...
   */
  public Reader cancelAction(
      ReaderCancelActionParams params,
      RequestOptions options) throws StripeException {
    String url =
      String.format(
        "%s%s",
  ...
  public static class ReaderAction extends StripeObject {
     ...
     *
     * <p>One of {@code process_payment_intent}, {@code process_setup_intent}, or {@code set_reader_display}.
     */
    @SerializedName("type")
    String type;
    ...
    public static class SetReaderDisplayAction extends StripeObject {
      ...
      public static class Cart extends StripeObject {
        ...
        /**
         * Tax amount for the entire cart. A positive integer in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>.
         */
        @SerializedName("tax")
        Long tax;

        /**
         * Total amount for the entire cart, including tax. A positive integer in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>.
         */
        ...
        public static class LineItem extends StripeObject {
          /**
           * The amount of the line item. A positive integer in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>.
           */
  ...
  public class TestHelpers {
     ...
     */
    public Reader presentPaymentMethod(
        ReaderPresentPaymentMethodParams params) throws StripeException {
      return presentPaymentMethod(params, (RequestOptions) null);
    }
