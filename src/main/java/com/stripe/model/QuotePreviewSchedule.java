...
public class QuotePreviewSchedule extends ApiResource implements HasId {
   ...
   *
   * <p>Equal to {@code quote_preview_schedule}.
   */
  ...
  List<QuotePreviewSchedule.Phase> phases;
  ...
  public static QuotePreviewScheduleCollection list(String quote, Map<String, Object> params)
      throws StripeException {
    return list(quote, params, (RequestOptions) null);
  }

  /** Preview the schedules that would be generated by accepting the quote. */
  public static QuotePreviewScheduleCollection list(
    ...
    return getGlobalResponseGetter()
        .request(
            ...
            path,
            params,
            QuotePreviewScheduleCollection.class,
            options,
            ApiMode.V1);
  }
  ...
  public static class Phase extends StripeObject {
    ...
    List<QuotePreviewSchedule.Phase.AddInvoiceItem> addInvoiceItems;
    ...
    List<QuotePreviewSchedule.Phase.Discount> discounts;
    ...
    List<QuotePreviewSchedule.Phase.Item> items;
    ...
    public static class AddInvoiceItem extends StripeObject {
      ...
      @SerializedName("discounts")
      List<QuotePreviewSchedule.Phase.AddInvoiceItem.Discount> discounts;
    ...
    public static class Item extends StripeObject {
       ...
       */
      @SerializedName("discounts")
      List<QuotePreviewSchedule.Phase.Item.Discount> discounts;
