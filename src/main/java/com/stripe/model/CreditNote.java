...
import com.stripe.param.CreditNotePreviewLinesParams;
...
public class CreditNote extends ApiResource implements HasId, MetadataStore<CreditNote> {
  ...
  /**
   * Status of this credit note, one of {@code issued} or {@code void}. Learn more about <a href="https://stripe.com/docs/billing/invoices/credit-notes#voiding">voiding credit notes</a>.
   */
  ...
  /**
   * Type of this credit note, one of {@code pre_payment} or {@code post_payment}. A {@code pre_payment} credit note means it was issued when the invoice was open. A {@code post_payment} credit note means it was issued when the invoice was paid.
   */
  @SerializedName("type")
  String type;
   ...
   * <p>Get a preview of a credit note without creating it.</p>
   */
  public static CreditNote preview(
      Map<String, Object> params,
      RequestOptions options) throws StripeException {
  ...
  /**
   * <p>Marks a credit note as void. Learn more about <a href="https://stripe.com/docs/billing/invoices/credit-notes#voiding">voiding credit notes</a>.</p>
   */
