...
public class QuotePreviewInvoice extends ApiResource implements HasId {
  ...
  public InvoiceLineItemCollection listLines() throws StripeException {
    return listLines((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Preview the invoice line items that would be generated by accepting the quote. */
  public InvoiceLineItemCollection listLines(Map<String, Object> params) throws StripeException {
    return listLines(params, (RequestOptions) null);
  }

  /** Preview the invoice line items that would be generated by accepting the quote. */
  public InvoiceLineItemCollection listLines(Map<String, Object> params, RequestOptions options)
      throws StripeException {
    String path =
        String.format(
            "/v1/quotes/%s/preview_invoices/%s/lines",
            ApiResource.urlEncodeId(this.getQuote()), ApiResource.urlEncodeId(this.getId()));
  ...
  /** Preview the invoice line items that would be generated by accepting the quote. */
  public InvoiceLineItemCollection listLines(QuotePreviewInvoiceListLinesParams params)
      throws StripeException {
    return listLines(params, (RequestOptions) null);
  }

  /** Preview the invoice line items that would be generated by accepting the quote. */
  public InvoiceLineItemCollection listLines(
      QuotePreviewInvoiceListLinesParams params, RequestOptions options) throws StripeException {
    String path =
        String.format(
            "/v1/quotes/%s/preview_invoices/%s/lines",
            ApiResource.urlEncodeId(this.getQuote()), ApiResource.urlEncodeId(this.getId()));
