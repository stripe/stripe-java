...
public class QuotePreviewInvoice extends ApiResource implements HasId {
  ...
  public static QuotePreviewInvoiceCollection list(String id, Map<String, Object> params)
  ...
  public static QuotePreviewInvoiceCollection list(
    ...
    String path = String.format("/v1/quotes/%s/preview_invoices", ApiResource.urlEncodeId(id));
    ApiRequest request =
  ...
  /** Preview the invoices that would be generated by accepting the quote. */
  public static QuotePreviewInvoiceCollection list(String id, QuotePreviewInvoiceListParams params)
      throws StripeException {
    return list(id, params, (RequestOptions) null);
  }
  ...
  /** Preview the invoices that would be generated by accepting the quote. */
  public static QuotePreviewInvoiceCollection list(
      String id, QuotePreviewInvoiceListParams params, RequestOptions options)
      throws StripeException {
    String path = String.format("/v1/quotes/%s/preview_invoices", ApiResource.urlEncodeId(id));
