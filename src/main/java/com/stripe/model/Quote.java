...
public class Quote extends ApiResource implements HasId, MetadataStore<Quote> {
  ...
  /** Preview the invoice line items that would be generated by accepting the quote. */
  public InvoiceLineItemCollection previewInvoiceLines(
      String previewInvoice, QuotePreviewInvoiceLinesParams params, RequestOptions options)
      throws StripeException {
    String path =
        String.format(
            "/v1/quotes/%s/preview_invoices/%s/lines",
  ...
  public QuotePreviewInvoiceCollection previewInvoices() throws StripeException {
    return previewInvoices((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Preview the invoices that would be generated by accepting the quote. */
  public QuotePreviewInvoiceCollection previewInvoices(Map<String, Object> params)
      throws StripeException {
    return previewInvoices(params, (RequestOptions) null);
  }

  /** Preview the invoices that would be generated by accepting the quote. */
  public QuotePreviewInvoiceCollection previewInvoices(
      Map<String, Object> params, RequestOptions options) throws StripeException {
    String path =
  ...
  /** Preview the invoices that would be generated by accepting the quote. */
  public QuotePreviewInvoiceCollection previewInvoices(QuotePreviewInvoicesParams params)
      throws StripeException {
    return previewInvoices(params, (RequestOptions) null);
  }
  ...
  public QuotePreviewScheduleCollection previewSubscriptionSchedules() throws StripeException {
    return previewSubscriptionSchedules((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Preview the schedules that would be generated by accepting the quote. */
  public QuotePreviewScheduleCollection previewSubscriptionSchedules(Map<String, Object> params)
      throws StripeException {
    return previewSubscriptionSchedules(params, (RequestOptions) null);
  }

  /** Preview the schedules that would be generated by accepting the quote. */
  public QuotePreviewScheduleCollection previewSubscriptionSchedules(
      Map<String, Object> params, RequestOptions options) throws StripeException {
    String path =
        String.format(
            "/v1/quotes/%s/preview_subscription_schedules", ApiResource.urlEncodeId(this.getId()));
    return getResponseGetter()
        .request(
            BaseAddress.API,
            ApiResource.RequestMethod.GET,
