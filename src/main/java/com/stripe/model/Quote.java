...
public class Quote extends ApiResource implements HasId, MetadataStore<Quote> {
  ...
  public InvoiceLineItemCollection listPreviewInvoiceLines(String quoteId) throws StripeException {
    return listPreviewInvoiceLines(quoteId, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Preview the invoice line items that would be generated by accepting the quote. */
  public InvoiceLineItemCollection listPreviewInvoiceLines(String quoteId, RequestOptions options)
      throws StripeException {
    return listPreviewInvoiceLines(quoteId, (Map<String, Object>) null, options);
  }

  /** Preview the invoice line items that would be generated by accepting the quote. */
  public InvoiceLineItemCollection listPreviewInvoiceLines(
      String quoteId, Map<String, Object> params) throws StripeException {
    return listPreviewInvoiceLines(quoteId, params, (RequestOptions) null);
  }

  /** Preview the invoice line items that would be generated by accepting the quote. */
  public InvoiceLineItemCollection listPreviewInvoiceLines(
      String quoteId, Map<String, Object> params, RequestOptions options) throws StripeException {
    String path =
        String.format(
            "/v1/quotes/%s/preview_invoices/%s/lines",
            ApiResource.urlEncodeId(quoteId), ApiResource.urlEncodeId(this.getId()));
    ApiRequest request =
        new ApiRequest(BaseAddress.API, ApiResource.RequestMethod.GET, path, params, options);
  ...
  /** Preview the invoice line items that would be generated by accepting the quote. */
  public InvoiceLineItemCollection listPreviewInvoiceLines(
      String quoteId, QuoteListPreviewInvoiceLinesParams params) throws StripeException {
    return listPreviewInvoiceLines(quoteId, params, (RequestOptions) null);
  }

  /** Preview the invoice line items that would be generated by accepting the quote. */
  public InvoiceLineItemCollection listPreviewInvoiceLines(
      String quoteId, QuoteListPreviewInvoiceLinesParams params, RequestOptions options)
      throws StripeException {
    String path =
        String.format(
            "/v1/quotes/%s/preview_invoices/%s/lines",
  ...
  public static Quote retrieve(String id) throws StripeException {
    return retrieve(id, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves the quote with the given ID. */
  public static Quote retrieve(String id, RequestOptions options) throws StripeException {
    return retrieve(id, (Map<String, Object>) null, options);
  }

  /** Retrieves the quote with the given ID. */
  public static Quote retrieve(String id, Map<String, Object> params, RequestOptions options)
      throws StripeException {
  ...
  /** Retrieves the quote with the given ID. */
  public static Quote retrieve(String id, QuoteRetrieveParams params, RequestOptions options)
      throws StripeException {
    String path = String.format("/v1/quotes/%s", ApiResource.urlEncodeId(id));
    ApiResource.checkNullTypedParams(path, params);
    ApiRequest request =
