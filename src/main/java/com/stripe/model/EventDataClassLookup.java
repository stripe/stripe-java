...
public class EventDataClassLookup {
  ...
  static {
    ...
    classLookup.put("line_item", LineItem.class);
    classLookup.put("login_link", LoginLink.class);
    classLookup.put("notification_event_data", NotificationEventData.class);
    ...
    classLookup.put("tax_rate_template", TaxRateTemplate.class);
