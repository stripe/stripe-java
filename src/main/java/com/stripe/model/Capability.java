...
public class Capability extends ApiResource implements HasId {
  ...
  /**
   * The status of the capability. Can be {@code active}, {@code inactive}, {@code pending}, or {@code unrequested}.
   */
  ...
  public static class FutureRequirements extends StripeObject {
    ...
    /**
     * Fields that need to be collected to keep the capability enabled. If not collected by {@code future_requirements[current_deadline]}, these fields will transition to the main {@code requirements} hash.
     */
  ...
  public static class Requirements extends StripeObject {
    ...
    /**
     * Date by which the fields in {@code currently_due} must be collected to keep the capability enabled for the account. These fields may disable the capability sooner if the next threshold is reached before they are collected.
     */
    @SerializedName("current_deadline")
    Long currentDeadline;

    /**
     * Fields that need to be collected to keep the capability enabled. If not collected by {@code current_deadline}, these fields appear in {@code past_due} as well, and the capability is disabled.
     */
    @SerializedName("currently_due")
    List<String> currentlyDue;

    /**
     * If the capability is disabled, this string describes why. Can be {@code requirements.past_due}, {@code requirements.pending_verification}, {@code listed}, {@code platform_paused}, {@code rejected.fraud}, {@code rejected.listed}, {@code rejected.terms_of_service}, {@code rejected.other}, {@code under_review}, or {@code other}.
     *
     * <p>{@code rejected.unsupported_business} means that the account's business is not supported by the capability. For example, payment methods may restrict the businesses they support in their terms of service:
     *
     * <p>- <a href="https://stripe.com/afterpay-clearpay/legal#restricted-businesses">Afterpay Clearpay's terms of service</a>
     *
     * <p>If you believe that the rejection is in error, please contact support at https://support.stripe.com/contact/ for assistance.
     */
    @SerializedName("disabled_reason")
    String disabledReason;
    ...
    /**
     * Fields that weren't collected by {@code current_deadline}. These fields need to be collected to enable the capability on the account.
     */
    @SerializedName("past_due")
    List<String> pastDue;
