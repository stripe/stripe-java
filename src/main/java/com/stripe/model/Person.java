...
public class Person extends ApiResource implements HasId, MetadataStore<Person> {
  ...
  public static class FutureRequirements extends StripeObject {
    ...
    /**
     * Fields that need to be collected to keep the person's account enabled. If not collected by the account's {@code future_requirements[current_deadline]}, these fields will transition to the main {@code requirements} hash, and may immediately become {@code past_due}, but the account may also be given a grace period depending on the account's enablement state prior to transition.
     */
    ...
    /**
     * Fields that need to be collected assuming all volume thresholds are reached. As they become required, they appear in {@code currently_due} as well, and the account's {@code future_requirements[current_deadline]} becomes set.
     */
    @SerializedName("eventually_due")
    List<String> eventuallyDue;

    /**
     * Fields that weren't collected by the account's {@code requirements.current_deadline}. These fields need to be collected to enable the person's account. New fields will never appear here; {@code future_requirements.past_due} will always be a subset of {@code requirements.past_due}.
     */
  ...
  public static class Requirements extends StripeObject {
    ...
    /**
     * Fields that need to be collected to keep the person's account enabled. If not collected by the account's {@code current_deadline}, these fields appear in {@code past_due} as well, and the account is disabled.
     */
    @SerializedName("currently_due")
    List<String> currentlyDue;
    ...
    /**
     * Fields that need to be collected assuming all volume thresholds are reached. As they become required, they appear in {@code currently_due} as well, and the account's {@code current_deadline} becomes set.
     */
    @SerializedName("eventually_due")
    List<String> eventuallyDue;

    /**
     * Fields that weren't collected by the account's {@code current_deadline}. These fields need to be collected to enable the person's account.
     */
    @SerializedName("past_due")
    List<String> pastDue;
  ...
  public static class Verification extends StripeObject {
    ...
    /**
     * The state of verification for the person. Possible values are {@code unverified}, {@code pending}, or {@code verified}.
     */
