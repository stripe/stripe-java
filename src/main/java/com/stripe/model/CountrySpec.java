...
public class CountrySpec extends ApiResource implements HasId {
  ...
  Map<String, Object> supportedBankAccountCurrencies;
  ...
  /**
   * Lists the types of verification data needed to keep an account open. Includes 'minimum' fields,
   * which every account must eventually provide, as well as a 'additional' fields, which are only
   * required for some users.
   */
  Map<String, Object> verificationFields;
