...
public class Payout extends ApiResource implements BalanceTransactionSource, MetadataStore<Payout> {
  ...
  @Getter(lombok.AccessLevel.NONE)
  @Setter(lombok.AccessLevel.NONE)
  ExpandableField<ExternalAccountSource> destination;
  ...
  public ExternalAccountSource getDestinationObject() {
    return (this.destination != null) ? this.destination.getExpanded() : null;
  }

  public void setDestinationObject(ExternalAccountSource expandableObject) {
    this.destination =
        new ExpandableField<ExternalAccountSource>(expandableObject.getId(), expandableObject);
  }
