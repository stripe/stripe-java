...
public class Customer extends ApiResource implements HasId, MetadataStore<Customer> {
   ...
   *
   * <p>If you are using payment methods created via the PaymentMethods API, see the <a href="https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.
   */
  ...
  /**
   * When the customer's latest invoice is billed by charging automatically, {@code delinquent} is {@code true} if the invoice's latest charge failed. When the customer's latest invoice is billed by sending an invoice, {@code delinquent} is {@code true} if the invoice isn't paid by its due date.
   *
   * <p>If an invoice is marked uncollectible by <a href="https://stripe.com/docs/billing/automatic-collection">dunning</a>, {@code delinquent} doesn't get reset to {@code false}.
   */
  ...
  /**
   * Describes the customer's tax exemption status. One of {@code none}, {@code exempt}, or {@code reverse}. When set to {@code reverse}, invoice and receipt PDFs include the text <strong>&quot;Reverse charge&quot;</strong>.
   */
  ...
  /**
   * <p>Search for customers you’ve previously created using Stripe’s <a href="https://stripe.com/docs/search#search-query-language">Search Query Language</a>.
   ...
   * to an hour behind during outages. Search functionality is not available to merchants in India.</p>
   */
  public static CustomerSearchResult search(
   ...
   */
  public PaymentMethodCollection listPaymentMethods(
      CustomerListPaymentMethodsParams params) throws StripeException {
    return listPaymentMethods(params, (RequestOptions) null);
  }
  ...
  public FundingInstructions createFundingInstructions(
    ...
    String url =
      String.format(
        ...
        Stripe.getApiBase(),
        String.format(
          "/v1/customers/%s/funding_instructions",
          ApiResource.urlEncodeId(this.getId())
        )
      );
    return ApiResource.request(
  ...
  public static class Tax extends StripeObject {
     ...
     *
     * <p>One of {@code failed}, {@code not_collecting}, {@code supported}, or {@code unrecognized_location}.
     */
    ...
    public static class Location extends StripeObject {
       ...
       *
       * <p>One of {@code billing_address}, {@code ip_address}, {@code payment_method}, or {@code shipping_destination}.
       */
  ...
  public static class TestHelpers {
     ...
     */
    public CustomerBalanceTransaction fundCashBalance(
        CustomerFundCashBalanceParams params) throws StripeException {
      return fundCashBalance(params, (RequestOptions) null);
    }
