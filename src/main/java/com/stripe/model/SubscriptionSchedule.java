...
public class SubscriptionSchedule extends ApiResource
  ...
  List<SubscriptionSchedule.BillingSchedule> billingSchedules;
  ...
  List<SubscriptionSchedule.PauseSchedule> pauseSchedules;
  ...
  public static class BillingSchedule extends StripeObject {
    ...
    List<SubscriptionSchedule.BillingSchedule.AppliesTo> appliesTo;
  ...
  public static class DefaultSettings extends StripeObject {
    ...
    public static class InvoiceSettings extends StripeObject {
      ...
      List<SubscriptionSchedule.DefaultSettings.InvoiceSettings.CustomField> customFields;
  ...
  public static class Phase extends StripeObject {
    ...
    public static class InvoiceSettings extends StripeObject {
      ...
      /** A list of up to 4 custom fields to be displayed on the invoice. */
      @SerializedName("custom_fields")
      List<SubscriptionSchedule.Phase.InvoiceSettings.CustomField> customFields;
