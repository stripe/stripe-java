...
public class PaymentMethod extends ApiResource implements HasId, MetadataStore<PaymentMethod> {
   ...
   *
   * <p>One of {@code acss_debit}, {@code affirm}, {@code afterpay_clearpay}, {@code alipay}, {@code au_becs_debit}, {@code bacs_debit}, {@code bancontact}, {@code boleto}, {@code card}, {@code card_present}, {@code customer_balance}, {@code eps}, {@code fpx}, {@code giropay}, {@code grabpay}, {@code ideal}, {@code interac_present}, {@code klarna}, {@code konbini}, {@code link}, {@code oxxo}, {@code p24}, {@code paynow}, {@code promptpay}, {@code sepa_debit}, {@code sofort}, {@code us_bank_account}, or {@code wechat_pay}.
   */
  @SerializedName("type")
  String type;
  ...
  /**
   * <p>Creates a PaymentMethod object. Read the <a href="https://stripe.com/docs/stripe-js/reference#stripe-create-payment-method">Stripe.js reference</a> to learn how to create PaymentMethods via Stripe.js.</p>
   *
   * <p>Instead of creating a PaymentMethod directly, we recommend using the <a href="https://stripe.com/docs/payments/accept-a-payment">PaymentIntents</a> API to accept a payment immediately or the <a href="https://stripe.com/docs/payments/save-and-reuse">SetupIntent</a> API to collect payment method details ahead of a future payment.</p>
   */
  ...
  /**
   * <p>Retrieves a PaymentMethod object attached to the StripeAccount. To retrieve a payment method attached to a Customer, you should use <a href="https://stripe.com/docs/api/payment_methods/customer">Retrieve a Customer’s PaymentMethods</a></p>
   */
  ...
  /**
   * <p>Returns a list of PaymentMethods attached to the StripeAccount. For listing a customer’s payment methods, you should use <a href="https://stripe.com/docs/api/payment_methods/customer_list">List a Customer’s PaymentMethods</a></p>
   */
   ...
   *
   * <p>To attach a new PaymentMethod to a customer for future payments, we recommend you use a <a href="https://stripe.com/docs/api/setup_intents">SetupIntent</a>
   * or a PaymentIntent with <a href="https://stripe.com/docs/api/payment_intents/create#create_payment_intent-setup_future_usage">setup_future_usage</a>.
   ...
   * See <a href="https://stripe.com/docs/payments/payment-intents#future-usage">Optimizing cards for future payments</a> for more information about setting up future payments.</p>
   *
   * <p>To use this PaymentMethod as the default for invoice or subscription payments,
   * set <a href="https://stripe.com/docs/api/customers/update#update_customer-invoice_settings-default_payment_method"><code>invoice_settings.default_payment_method</code></a>,
  ...
  public static class Ideal extends StripeObject {
    /**
     * The customer's bank, if provided. Can be one of {@code abn_amro}, {@code asn_bank}, {@code bunq}, {@code handelsbanken}, {@code ing}, {@code knab}, {@code moneyou}, {@code rabobank}, {@code regiobank}, {@code revolut}, {@code sns_bank}, {@code triodos_bank}, or {@code van_lanschot}.
     */
    @SerializedName("bank")
    String bank;
  ...
  public static class P24 extends StripeObject {
     ...
     *
     * <p>One of {@code alior_bank}, {@code bank_millennium}, {@code bank_nowy_bfg_sa}, {@code bank_pekao_sa}, {@code banki_spbdzielcze}, {@code blik}, {@code bnp_paribas}, {@code boz}, {@code citi_handlowy}, {@code credit_agricole}, {@code envelobank}, {@code etransfer_pocztowy24}, {@code getin_bank}, {@code ideabank}, {@code ing}, {@code inteligo}, {@code mbank_mtransfer}, {@code nest_przelew}, {@code noble_pay}, {@code pbac_z_ipko}, {@code plus_bank}, {@code santander_przelew24}, {@code tmobile_usbugi_bankowe}, {@code toyota_bank}, or {@code volkswagen_bank}.
     */
    @SerializedName("bank")
    String bank;
  }
