...
public class PaymentMethod extends ApiResource implements HasId, MetadataStore<PaymentMethod> {
   ...
   *
   * <p>One of {@code acss_debit}, {@code afterpay_clearpay}, {@code alipay}, {@code au_becs_debit}, {@code bacs_debit}, {@code bancontact}, {@code boleto}, {@code card}, {@code card_present}, {@code eps}, {@code fpx}, {@code giropay}, {@code grabpay}, {@code ideal}, {@code interac_present}, {@code klarna}, {@code oxxo}, {@code p24}, {@code sepa_debit}, {@code sofort}, or {@code wechat_pay}.
   */
  @SerializedName("type")
  String type;
  ...
  /**
   * <p>Returns a list of PaymentMethods. For listing a customer’s payment methods, you should use <a href="https://stripe.com/docs/api/payment_methods/customer_list">List a Customer’s PaymentMethods</a></p>
   */
