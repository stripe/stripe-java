...
public class Subscription extends ApiResource implements HasId, MetadataStore<Subscription> {
  ...
  /**
   * Determines the date of the first full invoice, and, for plans with {@code month} or {@code year} intervals, the day of the month for subsequent invoices. The timestamp is in UTC format.
   */
  ...
  /**
   * If the subscription has been canceled with the {@code at_period_end} flag set to {@code true}, {@code cancel_at_period_end} on the subscription will be true. You can use this attribute to determine whether a subscription that has a status of active is scheduled to be canceled at the end of the current period.
   */
  @SerializedName("cancel_at_period_end")
  Boolean cancelAtPeriodEnd;

  /**
   * If the subscription has been canceled, the date of that cancellation. If the subscription was canceled with {@code cancel_at_period_end}, {@code canceled_at} will reflect the time of the most recent update request, not the end of the subscription period when the subscription is automatically moved to a canceled state.
   */
  @SerializedName("canceled_at")
  Long canceledAt;

  /**
   * Either {@code charge_automatically}, or {@code send_invoice}. When charging automatically, Stripe will attempt to pay this subscription at the end of the cycle using the default source attached to the customer. When sending an invoice, Stripe will email your customer an invoice with payment instructions.
   *
  ...
  /**
   * Number of days a customer has to pay invoices generated by this subscription. This value will be {@code null} for subscriptions where {@code collection_method=charge_automatically}.
   */
  ...
  /**
   * Specifies the approximate timestamp on which any pending invoice items will be billed according to the schedule provided at {@code pending_invoice_item_interval}.
   */
  ...
  /**
   * If specified, <a href="https://stripe.com/docs/billing/subscriptions/pending-updates">pending updates</a> that will be applied to the subscription once the {@code latest_invoice} has been paid.
   */
  ...
  /**
   * <p>Search for subscriptions you’ve previously created using Stripe’s <a href="https://stripe.com/docs/search#search-query-language">Search Query Language</a>.
   ...
   */
  public static SubscriptionSearchResult search(
      SubscriptionSearchParams params) throws StripeException {
    return search(params, (RequestOptions) null);
  }
   ...
   *
   * <p>To start subscriptions where the first invoice always begins in a <code>draft</code> status, use <a href="https://stripe.com/docs/billing/subscriptions/subscription-schedules#managing">subscription schedules</a> instead.
  ...
  /**
   * <p>Updates an existing subscription on a customer to match the specified parameters. When changing plans or quantities, we will optionally prorate the price we charge next month to make up for any price changes. To preview how the proration will be calculated, use the <a href="https://stripe.com/docs/api#upcoming_invoice">upcoming invoice</a> endpoint.</p>
   */
  @Override
   ...
   *
   * <p>Note, however, that any pending invoice items that you’ve created will still be charged for at the end of the period, unless manually <a href="https://stripe.com/docs/api#delete_invoiceitem">deleted</a>. If you’ve set the subscription to cancel at the end of the period, any pending prorations will also be left in place and collected at the end of the period. But if the subscription is set to cancel immediately, pending prorations will be removed.</p>
   *
  ...
  public static class BillingThresholds extends StripeObject {
    ...
    /**
     * Indicates if the {@code billing_cycle_anchor} should be reset when a threshold is reached. If true, {@code billing_cycle_anchor} will be updated to the date/time the threshold was last reached; otherwise, the value will remain unchanged. This value may not be {@code true} if the subscription contains items with plans that have {@code aggregate_usage=last_ever}.
     */
  ...
  public static class PaymentSettings extends StripeObject {
    ...
    /**
     * The list of payment method types to provide to every invoice created by the subscription. If not set, Stripe attempts to automatically determine the types to use by looking at the invoice’s default payment method, the subscription’s default payment method, the customer’s default payment method, and your <a href="https://dashboard.stripe.com/settings/billing/invoice">invoice template settings</a>.
     */
  ...
  public static class PendingUpdate extends StripeObject {
    /**
     * If the update is applied, determines the date of the first full invoice, and, for plans with {@code month} or {@code year} intervals, the day of the month for subsequent invoices. The timestamp is in UTC format.
     */
    @SerializedName("billing_cycle_anchor")
    Long billingCycleAnchor;
