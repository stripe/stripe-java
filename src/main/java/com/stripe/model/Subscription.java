...
public class Subscription extends ApiResource implements HasId, MetadataStore<Subscription> {
  ...
  /**
   * Determines the date of the first full invoice, and, for plans with {@code month} or {@code year} intervals, the day of the month for subsequent invoices.
   */
  ...
  public static class PendingUpdate extends StripeObject {
    /**
     * If the update is applied, determines the date of the first full invoice, and, for plans with {@code month} or {@code year} intervals, the day of the month for subsequent invoices.
     */
    @SerializedName("billing_cycle_anchor")
    Long billingCycleAnchor;
