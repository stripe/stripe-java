...
/**
 * Creates type adapter for interface {@code BalanceTransactionSource}
 * able to deserialize raw JSON to subtype implementation based on discriminator field {@code object}.
 */
public class BalanceTransactionSourceTypeAdapterFactory implements TypeAdapterFactory {
  ...
  public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
    ...
    final TypeAdapter<com.stripe.model.BalanceTransactionSource> balanceTransactionSourceAdapter =
      gson.getDelegateAdapter(this, TypeToken.get(com.stripe.model.BalanceTransactionSource.class));
    ...
    final TypeAdapter<com.stripe.model.ConnectCollectionTransfer> connectCollectionTransferAdapter =
      gson.getDelegateAdapter(this, TypeToken.get(com.stripe.model.ConnectCollectionTransfer.class));
  ...
  /**
   * Unknown subtype of {@link com.stripe.model.BalanceTransactionSource}. If this
   * class is the outcome of deserialization, please contact support@stripe.com
   * for assistance and provide the id and object value. Do not integrate with
   * this object, but raise an exception and log its content instead.
   */
