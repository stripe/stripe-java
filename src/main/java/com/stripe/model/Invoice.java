...
public class Invoice extends ApiResource implements HasId, MetadataStore<Invoice> {
  ...
  /**
   * Final amount due at this time for this invoice. If the invoice's total is smaller than the minimum charge amount, for example, or if there is account credit that can be applied to the invoice, the {@code amount_due} may be 0. If there is a positive {@code starting_balance} for the invoice (the customer owes money), the {@code amount_due} will also take that into account. The charge that gets generated for the invoice will be for the amount specified in {@code amount_due}.
   */
  ...
  /**
   * Whether an attempt has been made to pay the invoice. An invoice is not attempted until 1 hour after the {@code invoice.created} webhook, for example, so you might not want to display that invoice as unpaid to your users.
   */
  ...
  /**
   * Either {@code charge_automatically}, or {@code send_invoice}. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
   *
  ...
  /**
   * The customer's address. Until the invoice is finalized, this field will equal {@code customer.address}. Once the invoice is finalized, this field will no longer be updated.
   */
  @SerializedName("customer_address")
  Address customerAddress;

  /**
   * The customer's email. Until the invoice is finalized, this field will equal {@code customer.email}. Once the invoice is finalized, this field will no longer be updated.
   */
  @SerializedName("customer_email")
  String customerEmail;

  /**
   * The customer's name. Until the invoice is finalized, this field will equal {@code customer.name}. Once the invoice is finalized, this field will no longer be updated.
   */
  @SerializedName("customer_name")
  String customerName;

  /**
   * The customer's phone number. Until the invoice is finalized, this field will equal {@code customer.phone}. Once the invoice is finalized, this field will no longer be updated.
   */
  @SerializedName("customer_phone")
  String customerPhone;

  /**
   * The customer's shipping information. Until the invoice is finalized, this field will equal {@code customer.shipping}. Once the invoice is finalized, this field will no longer be updated.
   */
  @SerializedName("customer_shipping")
  ShippingDetails customerShipping;

  /**
   * The customer's tax exempt status. Until the invoice is finalized, this field will equal {@code customer.tax_exempt}. Once the invoice is finalized, this field will no longer be updated.
   *
  ...
  /**
   * The customer's tax IDs. Until the invoice is finalized, this field will contain the same tax IDs as {@code customer.tax_ids}. Once the invoice is finalized, this field will no longer be updated.
   */
  ...
  /**
   * The discounts applied to the invoice. Line item discounts are applied before invoice discounts. Use {@code expand[]=discounts} to expand each discount.
   */
  @SerializedName("discounts")
  List<ExpandableField<Discount>> discounts;

  /**
   * The date on which payment for this invoice is due. This value will be {@code null} for invoices where {@code collection_method=charge_automatically}.
   */
  ...
  /**
   * The individual line items that make up the invoice. {@code lines} is sorted as follows: invoice items in reverse chronological order, followed by the subscription, if any.
   */
  ...
  /**
   * The time at which payment will next be attempted. This value will be {@code null} for invoices where {@code collection_method=send_invoice}.
   */
  ...
  /**
   * The status of the invoice, one of {@code draft}, {@code open}, {@code paid}, {@code uncollectible}, or {@code void}. <a href="https://stripe.com/docs/billing/invoices/workflow#workflow-overview">Learn more</a>
   */
  ...
  public void setAccountTaxIds(List<String> ids) {
    ...
    if (this.accountTaxIds != null && this.accountTaxIds
      .stream()
      .map(x -> x.getId())
    ...
    this.accountTaxIds =
      (ids != null)
       ? ids.stream().map(id -> new ExpandableField<TaxId>(id, null)).collect(Collectors.toList())
       : null;
  }
  ...
  /**
   * <p>Search for invoices you’ve previously created using Stripe’s <a href="https://stripe.com/docs/search#search-query-language">Search Query Language</a>.
   ...
   * to an hour behind during outages. Search functionality is not available to merchants in India.</p>
   */
  public static InvoiceSearchResult search(
  ...
  /**
   * <p>This endpoint creates a draft invoice for a given customer. The draft invoice created pulls in all pending invoice items on that customer, including prorations. The invoice remains a draft until you <a href="https://stripe.com/docs/api#finalize_invoice">finalize</a> the invoice, which allows you to <a href="https://stripe.com/docs/api#pay_invoice">pay</a> or <a href="https://stripe.com/docs/api#send_invoice">send</a> the invoice to your customers.</p>
   */
  ...
  /**
   * <p>Draft invoices are fully editable. Once an invoice is <a href="https://stripe.com/docs/billing/invoices/workflow#finalized">finalized</a>,
   * monetary values, as well as <code>collection_method</code>, become uneditable.</p>
   *
   * <p>If you would like to stop the Stripe Billing engine from automatically finalizing, reattempting payments on,
   * sending reminders for, or <a href="https://stripe.com/docs/billing/invoices/reconciliation">automatically reconciling</a> invoices, pass
  ...
  /**
   * <p>Permanently deletes a one-off invoice draft. This cannot be undone. Attempts to delete invoices that are no longer in a draft state will fail; once an invoice has been finalized or if an invoice is for a subscription, it must be <a href="https://stripe.com/docs/api#void_invoice">voided</a>.</p>
   */
  ...
  /**
   * <p>Mark a finalized invoice as void. This cannot be undone. Voiding an invoice is similar to <a href="https://stripe.com/docs/api#delete_invoice">deletion</a>, however it only applies to finalized invoices and maintains a papertrail where the invoice can still be found.</p>
   */
  ...
  public static class CustomerTaxId extends StripeObject {
    /**
     * The type of the tax ID, one of {@code eu_vat}, {@code br_cnpj}, {@code br_cpf}, {@code eu_oss_vat}, {@code gb_vat}, {@code nz_gst}, {@code au_abn}, {@code au_arn}, {@code in_gst}, {@code no_vat}, {@code za_vat}, {@code ch_vat}, {@code mx_rfc}, {@code sg_uen}, {@code ru_inn}, {@code ru_kpp}, {@code ca_bn}, {@code hk_br}, {@code es_cif}, {@code tw_vat}, {@code th_vat}, {@code jp_cn}, {@code jp_rn}, {@code li_uid}, {@code my_itn}, {@code us_ein}, {@code kr_brn}, {@code ca_qst}, {@code ca_gst_hst}, {@code ca_pst_bc}, {@code ca_pst_mb}, {@code ca_pst_sk}, {@code my_sst}, {@code sg_gst}, {@code ae_trn}, {@code cl_tin}, {@code sa_vat}, {@code id_npwp}, {@code my_frp}, {@code il_vat}, {@code ge_vat}, {@code ua_vat}, {@code is_vat}, {@code bg_uic}, {@code hu_tin}, {@code si_tin}, or {@code unknown}.
     */
    @SerializedName("type")
    String type;
  ...
  public static class PaymentMethodOptions extends StripeObject {
    ...
    public static class UsBankAccount extends StripeObject {
      ...
      public static class FinancialConnections extends StripeObject {
        /**
         * The list of permissions to request. The {@code payment_method} permission must be included.
         */
