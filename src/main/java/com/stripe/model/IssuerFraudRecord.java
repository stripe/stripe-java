...
public class IssuerFraudRecord extends ApiResource implements HasId {
  ...
  /**
   * The type of fraud labelled by the issuer. One of {@code card_never_received}, {@code fraudulent_card_application}, {@code made_with_counterfeit_card}, {@code made_with_lost_card}, {@code made_with_stolen_card}, {@code misc}, {@code unauthorized_use_of_card}.
   */
  @SerializedName("fraud_type")
  String fraudType;

  /**
   * If true, the associated charge is subject to <a href="https://stripe.com/docs/payments/3d-secure#disputed-payments">liability shift</a>.
   */
   ...
   *
   * <p>Please refer to the <a href="https://stripe.com/docs/api#issuer_fraud_record_object">issuer fraud record</a> object reference for more details.</p>
   */
  ...
  public static IssuerFraudRecord retrieve(
    ...
    String url =
      String.format(
        "%s%s",
        Stripe.getApiBase(),
        String.format("/v1/issuer_fraud_records/%s", ApiResource.urlEncodeId(issuerFraudRecord))
      );
