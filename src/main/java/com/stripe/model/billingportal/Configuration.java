...
public class Configuration extends ApiResource implements HasId, MetadataStore<Configuration> {
  ...
  /**
   * Whether the configuration is the default. If {@code true}, this configuration can be managed in the Dashboard and portal sessions will use this configuration unless it is overriden when creating the session.
   */
  ...
  public Configuration update(
    ...
    String url =
      String.format(
        "%s%s",
        Stripe.getApiBase(),
        String.format("/v1/billing_portal/configurations/%s", ApiResource.urlEncodeId(this.getId()))
      );
    return ApiResource.request(
      ApiResource.RequestMethod.POST,
      url,
  ...
  public static Configuration retrieve(
    ...
    String url =
      String.format(
        ...
        Stripe.getApiBase(),
        String.format(
          "/v1/billing_portal/configurations/%s",
  ...
  public static class Features extends StripeObject {
    ...
    public static class SubscriptionCancel extends StripeObject {
      ...
      /**
       * Whether to create prorations when canceling subscriptions. Possible values are {@code none} and {@code create_prorations}.
       *
    ...
    public static class SubscriptionUpdate extends StripeObject {
      /**
       * The types of subscription updates that are supported for items listed in the {@code products} attribute. When empty, subscriptions are not updateable.
       */
