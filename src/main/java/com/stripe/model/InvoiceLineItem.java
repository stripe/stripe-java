...
public class InvoiceLineItem extends StripeObject implements HasId {
  ...
  /**
   * The discounts applied to the invoice line item. Line item discounts are applied before invoice discounts. Use {@code expand[]=discounts} to expand each discount.
   */
  ...
  /**
   * The ID of the <a href="https://stripe.com/docs/api/invoiceitems">invoice item</a> associated with this line item if any.
   */
  ...
  /**
   * Set of <a href="https://stripe.com/docs/api/metadata">key-value pairs</a> that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Note that for line items with {@code type=subscription} this will reflect the metadata of the subscription that caused the line item to be created.
   */
  ...
  /**
   * A string identifying the type of the source of this line item, either an {@code invoiceitem} or a {@code subscription}.
   *
