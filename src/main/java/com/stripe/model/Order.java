...
public class Order extends ApiResource implements HasId, MetadataStore<Order> {
  ...
  /**
   * The ID of the payment used to pay for the order. Present if the order status is {@code paid}, {@code fulfilled}, or {@code refunded}.
   */
  ...
  /**
   * The shipping method that is currently selected for this order, if any. If present, it is equal to one of the {@code id}s of shipping methods in the {@code shipping_methods} array. At order creation time, if there are multiple shipping methods, Stripe will automatically selected the first method.
   */
  ...
  /**
   * Current order status. One of {@code created}, {@code paid}, {@code canceled}, {@code fulfilled}, or {@code returned}. More details in the <a href="https://stripe.com/docs/orders/guide#understanding-order-statuses">Orders Guide</a>.
   */
  ...
  public static class ShippingMethod extends StripeObject implements HasId {
    ...
    public static class DeliveryEstimate extends StripeObject {
      /**
       * If {@code type} is {@code "exact"}, {@code date} will be the expected delivery date in the format YYYY-MM-DD.
       */
      @SerializedName("date")
      String date;

      /**
       * If {@code type} is {@code "range"}, {@code earliest} will be be the earliest delivery date in the format YYYY-MM-DD.
       */
      @SerializedName("earliest")
      String earliest;

      /**
       * If {@code type} is {@code "range"}, {@code latest} will be the latest delivery date in the format YYYY-MM-DD.
       */
