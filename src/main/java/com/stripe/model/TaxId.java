...
public class TaxId extends ApiResource implements HasId {
   ...
   * jp_rn}, {@code jp_trn}, {@code ke_pin}, {@code kr_brn}, {@code li_uid}, {@code mx_rfc}, {@code
   * my_frp}, {@code my_itn}, {@code my_sst}, {@code no_vat}, {@code nz_gst}, {@code ru_inn}, {@code
   * ru_kpp}, {@code sa_vat}, {@code sg_gst}, {@code sg_uen}, {@code si_tin}, {@code th_vat}, {@code
   * tw_vat}, {@code ua_vat}, {@code us_ein}, or {@code za_vat}. Note that some legacy tax IDs have
   * type {@code unknown}
   */
  @SerializedName("type")
  String type;
