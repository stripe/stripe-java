...
public class OrderItem extends StripeObject {
  ...
  /**
   * Description of the line item, meant to be displayable to the user (e.g., {@code "Express shipping"}).
   */
  ...
  /**
   * A positive integer representing the number of instances of {@code parent} that are included in this order item. Applicable/present only if {@code type} is {@code sku}.
   */
