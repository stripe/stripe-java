...
public class Card
  ...
  /**
   * If {@code address_line1} was provided, results of the check: {@code pass}, {@code fail}, {@code unavailable}, or {@code unchecked}.
   */
  ...
  /**
   * If {@code address_zip} was provided, results of the check: {@code pass}, {@code fail}, {@code unavailable}, or {@code unchecked}.
   */
  @SerializedName("address_zip_check")
  String addressZipCheck;

  /**
   * A set of available payout methods for this card. Only values from this set should be passed as the {@code method} when creating a payout.
   */
  @SerializedName("available_payout_methods")
  List<String> availablePayoutMethods;

  /**
   * Card brand. Can be {@code American Express}, {@code Diners Club}, {@code Discover}, {@code JCB}, {@code MasterCard}, {@code UnionPay}, {@code Visa}, or {@code Unknown}.
   */
  ...
  /**
   * Three-letter <a href="https://stripe.com/docs/payouts">ISO code for currency</a>. Only applicable on accounts (not customers or recipients). The card can be used as a transfer destination for funds in this currency.
   */
  ...
  /**
   * If a CVC was provided, results of the check: {@code pass}, {@code fail}, {@code unavailable}, or {@code unchecked}. A result of unchecked indicates that CVC was provided but hasn't been checked yet. Checks are typically performed when attaching a card to a Customer object, or when creating a charge. For more details, see <a href="https://support.stripe.com/questions/check-if-a-card-is-valid-without-a-charge">Check if a card is valid without a charge</a>.
   */
  ...
  /**
   * For external accounts, possible values are {@code new} and {@code errored}. If a transfer fails, the status is set to {@code errored} and transfers are stopped until account details are updated.
   */
  @SerializedName("status")
  String status;

  /**
   * If the card number is tokenized, this is the method that was used. Can be {@code android_pay} (includes Google Pay), {@code apple_pay}, {@code masterpass}, {@code visa_checkout}, or null.
   */
