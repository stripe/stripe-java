...
public class EarlyFraudWarning extends ApiResource implements HasId {
   ...
   *
   * <p>Please refer to the <a href="https://stripe.com/docs/api#early_fraud_warning_object">early fraud warning</a> object reference for more details.</p>
   */
  ...
  public static EarlyFraudWarning retrieve(
    ...
    String url =
      String.format(
        ...
        Stripe.getApiBase(),
        String.format(
          "/v1/radar/early_fraud_warnings/%s",
