...
public class ValueList extends ApiResource implements HasId, MetadataStore<ValueList> {
  /** The name of the list for use in rules. */
  String alias;

  /** Time at which the object was created. Measured in seconds since the Unix epoch. */
  Long created;

  /** The name or email address of the user who created this list. */
  String createdBy;
  ...
  /**
   * The type of items in the list. One of `card_fingerprint`, `card_bin`, `email`, `ip_address`,
   * `country`, `string`, or `case_sensitive_string`.
   */
  String itemType;

  /** List of items contained within this list. */
  ...
  /** The name or email address of the user who last updated this list. */
  String updatedBy;
  ...
  /**
   * Deletes a <code>ValueList</code> object, also deleting any items contained within the list. To
   * be deleted, a list must not be referenced in any rules.
   */
