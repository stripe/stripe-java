...
public class ValueListItem extends ApiResource implements HasId {
  ...
  /** The name or email address of the user who added this item to the list. */
  String createdBy;
  ...
  /**
   * Creates a new <code>ValueListItem</code> object, which is added to the specified parent list.
   */
  ...
  /** Deletes a <code>ValueListItem</code> object, removing it from its parent list. */
