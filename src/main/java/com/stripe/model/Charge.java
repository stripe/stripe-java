...
public class Charge extends ApiResource implements MetadataStore<Charge>, BalanceTransactionSource {
  ...
  /**
   * <p>Search for charges you’ve previously created using Stripe’s <a href="https://stripe.com/docs/search#search-query-language">Search Query Language</a>.
   ...
   * to an hour behind during outages. Search functionality is not available to merchants in India.</p>
   */
  public static ChargeSearchResult search(
  ...
  public static class PaymentMethodDetails extends StripeObject {
    ...
    public static class CardPresent extends StripeObject {
      ...
      /**
       * Whether this <a href="https://stripe.com/docs/api/payment_intents">PaymentIntent</a> is eligible for incremental authorizations. Request support using <a href="https://stripe.com/docs/api/payment_intents/create#create_payment_intent-payment_method_options-card_present-request_incremental_authorization_support">request_incremental_authorization_support</a>.
       */
    ...
    public static class Klarna extends StripeObject {
      ...
      /**
       * Preferred language of the Klarna authorization page that the customer is redirected to. Can be one of {@code de-AT}, {@code en-AT}, {@code nl-BE}, {@code fr-BE}, {@code en-BE}, {@code de-DE}, {@code en-DE}, {@code da-DK}, {@code en-DK}, {@code es-ES}, {@code en-ES}, {@code fi-FI}, {@code sv-FI}, {@code en-FI}, {@code en-GB}, {@code en-IE}, {@code it-IT}, {@code en-IT}, {@code nl-NL}, {@code en-NL}, {@code nb-NO}, {@code en-NO}, {@code sv-SE}, {@code en-SE}, {@code en-US}, {@code es-US}, {@code fr-FR}, {@code en-FR}, {@code en-AU}, or {@code en-NZ}
       */
