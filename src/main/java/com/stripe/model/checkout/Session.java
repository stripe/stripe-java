...
import com.stripe.model.LineItem.Discount;
import com.stripe.model.LineItem.Tax;
...
public class Session extends ApiResource implements HasId {
  ...
  /**
   * The ID of the customer for this Session. For Checkout Sessions in {@code payment} or {@code subscription} mode, Checkout will create a new customer object based on information provided during the payment flow unless an existing customer was provided when the Session was created.
   */
  ...
  /**
   * The customer details including the customer's tax exempt status and the customer's tax IDs. Only the customer's email is present on Sessions in {@code setup} mode.
   */
  @SerializedName("customer_details")
  CustomerDetails customerDetails;

  /**
   * If provided, this value will be used when the Customer object is created. If not provided, customers will be asked to enter their email address. Use this parameter to prefill customer data if you already have an email on file. To access information about the customer once the payment flow is complete, use the {@code customer} attribute.
   */
   ...
   *
   * <p>One of {@code auto}, {@code bg}, {@code cs}, {@code da}, {@code de}, {@code el}, {@code en}, {@code en-GB}, {@code es}, {@code es-419}, {@code et}, {@code fi}, {@code fil}, {@code fr}, {@code fr-CA}, {@code hr}, {@code hu}, {@code id}, {@code it}, {@code ja}, {@code ko}, {@code lt}, {@code lv}, {@code ms}, {@code mt}, {@code nb}, {@code nl}, {@code pl}, {@code pt}, {@code pt-BR}, {@code ro}, {@code ru}, {@code sk}, {@code sl}, {@code sv}, {@code th}, {@code tr}, {@code vi}, {@code zh}, {@code zh-HK}, or {@code zh-TW}.
   */
  ...
  /**
   * The payment status of the Checkout Session, one of {@code paid}, {@code unpaid}, or {@code no_payment_required}. You can use this value to decide when to fulfill your customer's order.
   */
  ...
  /**
   * The URL to the Checkout Session. Redirect customers to this URL to take them to Checkout. If you’re using <a href="https://stripe.com/docs/payments/checkout/custom-domains">Custom Domains</a>, the URL will use your subdomain. Otherwise, it’ll use {@code checkout.stripe.com.}
   */
  @SerializedName("url")
  String url;
   ...
   * <p>Returns a list of Checkout Sessions.</p>
   */
  public static SessionCollection list(
   ...
   */
  public LineItemCollection listLineItems(
      SessionListLineItemsParams params) throws StripeException {
    return listLineItems(params, (RequestOptions) null);
  }
  ...
  public static class AfterExpiration extends StripeObject {
    ...
    public static class Recovery extends StripeObject {
      ...
      /**
       * If {@code true}, a recovery url will be generated to recover this Checkout Session if it expires before a transaction is completed. It will be attached to the Checkout Session object upon expiration.
       */
  ...
  public static class Consent extends StripeObject {
    /**
     * If {@code opt_in}, the customer consents to receiving promotional communications from the merchant about this Checkout Session.
     *
  ...
  public static class PaymentMethodOptions extends StripeObject {
    ...
    public static class AcssDebit extends StripeObject {
      ...
      public static class MandateOptions extends StripeObject {
        ...
        /**
         * List of Stripe products where this mandate can be selected automatically. Returned when the Session is in {@code setup} mode.
         */
    ...
    public static class Konbini extends StripeObject {
      /**
       * The number of calendar days (between 1 and 60) after which Konbini payment instructions will expire. For example, if a PaymentIntent is confirmed with Konbini and {@code expires_after_days} set to 2 on Monday JST, the instructions will expire on Wednesday 23:59:59 JST.
       */
      @SerializedName("expires_after_days")
      Long expiresAfterDays;
