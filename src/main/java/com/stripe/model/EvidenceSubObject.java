...
public final class EvidenceSubObject extends StripeObject {
  ...
  public boolean equals(Object o) {
    ...
    if (accessActivityLog != null ? !accessActivityLog.equals(that.accessActivityLog)
        : that.accessActivityLog != null) {
      return false;
    }
    if (billingAddress != null ? !billingAddress.equals(that.billingAddress)
        : that.billingAddress != null) {
      return false;
    }
    if (cancellationPolicy != null ? !cancellationPolicy.equals(that.cancellationPolicy)
        : that.cancellationPolicy != null) {
      return false;
    }
    if (cancellationPolicyDisclosure != null
        ? !cancellationPolicyDisclosure.equals(that.cancellationPolicyDisclosure)
        : that.cancellationPolicyDisclosure != null) {
      return false;
    }
    if (cancellationRebuttal != null ? !cancellationRebuttal.equals(that.cancellationRebuttal)
        : that.cancellationRebuttal != null) {
      return false;
    }
    if (customerCommunication != null ? !customerCommunication.equals(that.customerCommunication)
        : that.customerCommunication != null) {
      return false;
    }
    if (customerEmailAddress != null ? !customerEmailAddress.equals(that.customerEmailAddress)
        : that.customerEmailAddress != null) {
      return false;
    }
    if (customerName != null ? !customerName.equals(that.customerName)
        : that.customerName != null) {
      return false;
    }
    if (customerPurchaseIp != null ? !customerPurchaseIp.equals(that.customerPurchaseIp)
        : that.customerPurchaseIp != null) {
      return false;
    }
    if (customerSignature != null ? !customerSignature.equals(that.customerSignature)
        : that.customerSignature != null) {
      return false;
    }
    if (duplicateChargeDocumentation != null
        ? !duplicateChargeDocumentation.equals(that.duplicateChargeDocumentation)
        : that.duplicateChargeDocumentation != null) {
      return false;
    }
    if (duplicateChargeExplanation != null
        ? !duplicateChargeExplanation.equals(that.duplicateChargeExplanation)
        : that.duplicateChargeExplanation != null) {
      return false;
    }
    if (duplicateChargeId != null ? !duplicateChargeId.equals(that.duplicateChargeId)
        : that.duplicateChargeId != null) {
      return false;
    }
    if (productDescription != null ? !productDescription.equals(that.productDescription)
        : that.productDescription != null) {
      return false;
    }
    if (receipt != null ? !receipt.equals(that.receipt) : that.receipt != null) {
      return false;
    }
    if (refundPolicy != null ? !refundPolicy.equals(that.refundPolicy)
        : that.refundPolicy != null) {
      return false;
    }
    if (refundPolicyDisclosure != null
        ? !refundPolicyDisclosure.equals(that.refundPolicyDisclosure)
        : that.refundPolicyDisclosure != null) {
      return false;
    }
    if (refundRefusalExplanation != null
        ? !refundRefusalExplanation.equals(that.refundRefusalExplanation)
        : that.refundRefusalExplanation != null) {
      return false;
    }
    if (serviceDate != null ? !serviceDate.equals(that.serviceDate) : that.serviceDate != null) {
      return false;
    }
    if (serviceDocumentation != null ? !serviceDocumentation.equals(that.serviceDocumentation)
        : that.serviceDocumentation != null) {
      return false;
    }
    if (shippingAddress != null ? !shippingAddress.equals(that.shippingAddress)
        : that.shippingAddress != null) {
      return false;
    }
    if (shippingDate != null ? !shippingDate.equals(that.shippingDate)
    ...
    if (shippingTrackingNumber != null
        ? !shippingTrackingNumber.equals(that.shippingTrackingNumber)
        : that.shippingTrackingNumber != null) {
      return false;
    }
    if (uncategorizedFile != null ? !uncategorizedFile.equals(that.uncategorizedFile)
        : that.uncategorizedFile != null) {
      return false;
    }
    return uncategorizedText != null ? uncategorizedText.equals(that.uncategorizedText)
        : that.uncategorizedText == null;
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result
        + (duplicateChargeExplanation != null ? duplicateChargeExplanation.hashCode() : 0);
    result = 31 * result
        + (duplicateChargeDocumentation != null ? duplicateChargeDocumentation.hashCode() : 0);
    ...
    result = 31 * result
        + (refundRefusalExplanation != null ? refundRefusalExplanation.hashCode() : 0);
    result = 31 * result + (cancellationPolicy != null ? cancellationPolicy.hashCode() : 0);
    result = 31 * result
        + (cancellationPolicyDisclosure != null ? cancellationPolicyDisclosure.hashCode() : 0);
