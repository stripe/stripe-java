...
public class PaymentIntent extends ApiResource implements HasId, MetadataStore<PaymentIntent> {
  ...
  /**
   * Settings to configure compatible payment methods from the <a href="https://dashboard.stripe.com/settings/payment_methods">Stripe Dashboard.</a>
   */
  @SerializedName("automatic_payment_methods")
  AutomaticPaymentMethodsPaymentIntent automaticPaymentMethods;

  /**
   * Populated when {@code status} is {@code canceled}, this is the time at which the PaymentIntent was canceled. Measured in seconds since the Unix epoch.
   */
  @SerializedName("canceled_at")
  Long canceledAt;

  /**
   * Reason for cancellation of this PaymentIntent, either user-provided ({@code duplicate}, {@code fraudulent}, {@code requested_by_customer}, or {@code abandoned}) or generated by Stripe internally ({@code failed_invoice}, {@code void_invoice}, or {@code automatic}).
   *
   * <p>One of {@code abandoned}, {@code automatic}, {@code duplicate}, {@code failed_invoice}, {@code fraudulent}, {@code requested_by_customer}, or {@code void_invoice}.
   */
   ...
   *
   * <p>The client secret can be used to complete a payment from your frontend. It should not be stored, logged, or exposed to anyone other than the customer. Make sure that you have TLS enabled on any page that includes the client secret.
   *
   * <p>Refer to our docs to <a href="https://stripe.com/docs/payments/accept-a-payment?ui=elements">accept a payment</a> and learn about how {@code client_secret} should be handled.
   */
  ...
  /**
   * The account (if any) for which the funds of the PaymentIntent are intended. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
   */
  ...
  /**
   * Status of this PaymentIntent, one of {@code requires_payment_method}, {@code requires_confirmation}, {@code requires_action}, {@code processing}, {@code requires_capture}, {@code canceled}, or {@code succeeded}. Read more about each PaymentIntent <a href="https://stripe.com/docs/payments/intents#intent-statuses">status</a>.
   */
  @SerializedName("status")
  String status;

  /**
   * The data with which to automatically create a Transfer when the payment is finalized. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
   */
  ...
  /**
   * <p>Search for PaymentIntents you’ve previously created using Stripe’s <a href="https://stripe.com/docs/search#search-query-language">Search Query Language</a>.
   ...
   */
  public static PaymentIntentSearchResult search(
      PaymentIntentSearchParams params) throws StripeException {
    return search(params, (RequestOptions) null);
  }
   ...
   *
   * <p>After the PaymentIntent is created, attach a payment method and <a href="https://stripe.com/docs/api/payment_intents/confirm">confirm</a>
   * to continue the payment. You can read more about the different payment flows
   * available via the Payment Intents API <a href="https://stripe.com/docs/payments/payment-intents">here</a>.</p>
   *
   * <p>When <code>confirm=true</code> is used during creation, it is equivalent to creating
   * and confirming the PaymentIntent in the same call. You may use any parameters
   * available in the <a href="https://stripe.com/docs/api/payment_intents/confirm">confirm API</a> when <code>confirm=true</code>
   * is supplied.</p>
   */
   ...
   *
   * <p>When retrieved with a publishable key, only a subset of properties will be returned. Please refer to the <a href="https://stripe.com/docs/api#payment_intent_object">payment intent</a> object reference for more details.</p>
   */
   ...
   * the <a href="https://stripe.com/docs/api/payment_intents/confirm">confirm API</a> instead.</p>
   */
  @Override
   ...
   * using our <a href="https://stripe.com/docs/stripe-js/reference#stripe-handle-card-payment">client SDKs</a>
   * and the PaymentIntent’s <a href="https://stripe.com/docs/api#payment_intent_object-client_secret">client_secret</a>.
   ...
   * attempt. Read the <a href="https://stripe.com/docs/payments/payment-intents/web-manual">expanded documentation</a>
   ...
   *
   * <p>You cannot cancel the PaymentIntent for a Checkout Session. <a href="https://stripe.com/docs/api/checkout/sessions/expire">Expire the Checkout Session</a> instead</p>
   */
   ...
   *
   * <p>Learn more about <a href="https://stripe.com/docs/payments/capture-later">separate authorization and capture</a>.</p>
   */
   ...
   * <a href="https://stripe.com/docs/api/payment_intents/object">PaymentIntent</a>. To be eligible, the
   * PaymentIntent’s status must be <code>requires_capture</code> and
   * <a href="https://stripe.com/docs/api/charges/object#charge_object-payment_method_details-card_present-incremental_authorization_supported">incremental_authorization_supported</a>
   ...
   * <a href="https://stripe.com/docs/api/payment_intents/object#payment_intent_object-amount">amount</a>.
   * If the incremental authorization fails, a
   * <a href="https://stripe.com/docs/error-codes#card-declined">card_declined</a> error is returned, and no
   ...
   *
   * <p>Learn more about <a href="https://stripe.com/docs/terminal/features/incremental-authorizations">incremental authorizations</a>.</p>
   */
   ...
   */
  public PaymentIntent incrementAuthorization(
      PaymentIntentIncrementAuthorizationParams params) throws StripeException {
    return incrementAuthorization(params, (RequestOptions) null);
  }
   ...
   */
  public PaymentIntent verifyMicrodeposits(
      PaymentIntentVerifyMicrodepositsParams params) throws StripeException {
    return verifyMicrodeposits(params, (RequestOptions) null);
  }
   ...
   */
  public PaymentIntent applyCustomerBalance(
      PaymentIntentApplyCustomerBalanceParams params) throws StripeException {
    return applyCustomerBalance(params, (RequestOptions) null);
  }
  ...
  public static class NextAction extends StripeObject {
    ...
    /**
     * Type of the next action to perform, one of {@code redirect_to_url}, {@code use_stripe_sdk}, {@code alipay_handle_redirect}, {@code oxxo_display_details}, or {@code verify_with_microdeposits}.
     */
    @SerializedName("type")
    String type;
  ...
  public static class NextActionDisplayBankTransferInstructions extends StripeObject {
    ...
    List<PaymentIntent.NextActionDisplayBankTransferInstructions.FinancialAddresses> financialAddresses;
     ...
     *
     * <p>One of {@code eu_bank_transfer}, {@code gb_bank_transfer}, {@code jp_bank_transfer}, or {@code mx_bank_transfer}.
     */
    @SerializedName("type")
    String type;
  ...
  public static class PaymentMethodOptions extends StripeObject {
    ...
    public static class BankTransfer extends StripeObject {
      ...
      /**
       * The bank transfer type that this PaymentIntent is allowed to use for funding Permitted values include: {@code eu_bank_transfer}, {@code gb_bank_transfer}, {@code jp_bank_transfer}, or {@code mx_bank_transfer}.
       *
       * <p>One of {@code eu_bank_transfer}, {@code gb_bank_transfer}, {@code jp_bank_transfer}, or {@code mx_bank_transfer}.
       */
      @SerializedName("type")
    ...
    public static class Sofort extends StripeObject {
       ...
       *
       * <p>One of {@code de}, {@code en}, {@code es}, {@code fr}, {@code it}, {@code nl}, or {@code pl}.
       */
      @SerializedName("preferred_language")
      String preferredLanguage;
  ...
  public static class Processing extends StripeObject {
    ...
    /**
     * Type of the payment method for which payment is in {@code processing} state, one of {@code card}.
     */
    @SerializedName("type")
    String type;
