...
public class TaxRate extends ApiResource implements HasId, MetadataStore<TaxRate> {
  /**
   * Defaults to {@code true}. When set to {@code false}, this tax rate cannot be used with new applications or Checkout Sessions, but will still work for subscriptions and invoices that already have it set.
   */
   ...
   *
   * <p>One of {@code gst}, {@code hst}, {@code jct}, {@code pst}, {@code qst}, {@code rst}, {@code sales_tax}, or {@code vat}.
   */
