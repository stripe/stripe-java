...
public class TaxRate extends ApiResource implements HasId, MetadataStore<TaxRate> {
   ...
   *
   * <p>One of {@code amusement_tax}, {@code communications_tax}, {@code digital_excise_tax}, {@code
   * gst}, {@code hst}, {@code igst}, {@code jct}, {@code lease_tax}, {@code
   * mass_transit_parking_tax}, {@code parking_tax}, {@code pst}, {@code qst}, {@code
   * retail_delivery_fee}, {@code rst}, {@code sales_tax}, {@code service_tax}, {@code
   * utility_users_tax}, or {@code vat}.
   */
