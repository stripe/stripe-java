...
public class QuotePreviewSubscriptionSchedule extends ApiResource implements HasId {
  ...
  public static class DefaultSettings extends StripeObject {
    ...
    public static class InvoiceSettings extends StripeObject {
      ...
      List<QuotePreviewSubscriptionSchedule.DefaultSettings.InvoiceSettings.CustomField>
          customFields;
  ...
  public static class LastPriceMigrationError extends StripeObject {
    ...
    List<QuotePreviewSubscriptionSchedule.LastPriceMigrationError.FailedTransition>
        failedTransitions;
  ...
  public static class Phase extends StripeObject {
    ...
    public static class InvoiceSettings extends StripeObject {
      ...
      /** A list of up to 4 custom fields to be displayed on the invoice. */
      @SerializedName("custom_fields")
      List<QuotePreviewSubscriptionSchedule.Phase.InvoiceSettings.CustomField> customFields;
