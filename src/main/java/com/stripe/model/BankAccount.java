...
import com.stripe.param.BankAccountDeleteParams;
...
public class BankAccount
  ...
  /**
   * A set of available payout methods for this bank account. Only values from this set should be passed as the {@code method} when creating a payout.
   */
  ...
  /**
   * Three-letter <a href="https://stripe.com/docs/payouts">ISO code for the currency</a> paid out to the bank account.
   */
   ...
   * optionally sets it as the default for its currency. Other bank account details are not
   * editable by design.
   *
