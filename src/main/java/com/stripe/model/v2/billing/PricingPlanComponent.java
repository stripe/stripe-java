 ...
 * Components can be Rate Cards for usage-based charges, License Fees for recurring fixed charges,
 * or Service Actions for recurring credit grants. Each component is associated with a specific
 * version of the Pricing Plan and defines one aspect of how customers are billed.
 */
@Getter
@Setter
