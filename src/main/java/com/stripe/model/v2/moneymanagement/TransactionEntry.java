...
public class TransactionEntry extends StripeObject implements HasId {
  ...
  public static class TransactionDetails extends StripeObject {
     ...
     * {@code dispute_reversal}, {@code financing_paydown}, {@code financing_paydown_reversal},
     * {@code inbound_payment}, {@code inbound_payment_failure}, {@code inbound_transfer}, {@code
