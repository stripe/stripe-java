...
public class Transaction extends StripeObject implements HasId {
   ...
   * {@code inbound_transfer}, {@code inbound_transfer_reversal}, {@code india_mdr_processing_fee},
   ...
   * {@code minimum_balance_hold}, {@code network_cost}, {@code obligation}, {@code
   * outbound_payment}, {@code outbound_payment_reversal}, {@code outbound_transfer}, {@code
  ...
  public static class Flow extends StripeObject {
     ...
     * reserve_release}, {@code topup}, {@code transfer}, {@code transfer_reversal}, {@code
