...
public class Report extends StripeObject implements HasId {
  ...
  public static class Parameter extends StripeObject {
    ...
    /**
     * For more details about ArrayDetails, please refer to the <a
    ...
    public static class ArrayDetails extends StripeObject {
      ...
      /**
       * For more details about EnumDetails, please refer to the <a
       * href="https://docs.stripe.com/api">API Reference.</a>
       */
      @Getter
      @Setter
    ...
    /**
     * For more details about TimestampDetails, please refer to the <a
     * href="https://docs.stripe.com/api">API Reference.</a>
     */
    @Getter
    @Setter
