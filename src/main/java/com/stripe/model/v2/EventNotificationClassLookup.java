...
public final class EventNotificationClassLookup {
  ...
  static {
    eventClassLookup.put(
        ...
        com.stripe.events.V1AccountApplicationAuthorizedEventNotification.class);
    eventClassLookup.put(
        "v1.account.application.deauthorized",
        com.stripe.events.V1AccountApplicationDeauthorizedEventNotification.class);
    eventClassLookup.put(
        "v1.account.external_account.created",
        com.stripe.events.V1AccountExternalAccountCreatedEventNotification.class);
    eventClassLookup.put(
        "v1.account.external_account.deleted",
        com.stripe.events.V1AccountExternalAccountDeletedEventNotification.class);
    eventClassLookup.put(
        "v1.account.external_account.updated",
        com.stripe.events.V1AccountExternalAccountUpdatedEventNotification.class);
    eventClassLookup.put(
        "v1.account.updated", com.stripe.events.V1AccountUpdatedEventNotification.class);
    eventClassLookup.put(
        "v1.account_signals[delinquency].created",
        com.stripe.events.V1AccountSignalsIncludingDelinquencyCreatedEventNotification.class);
    eventClassLookup.put(
    ...
    eventClassLookup.put(
        ...
        com.stripe.events.V1ApplicationFeeRefundUpdatedEventNotification.class);
    eventClassLookup.put(
    ...
    eventClassLookup.put(
        ...
        com.stripe.events.V1BillingPortalSessionCreatedEventNotification.class);
    eventClassLookup.put(
        "v1.capability.updated", com.stripe.events.V1CapabilityUpdatedEventNotification.class);
    eventClassLookup.put(
        "v1.cash_balance.funds_available",
        com.stripe.events.V1CashBalanceFundsAvailableEventNotification.class);
    eventClassLookup.put(
    ...
    eventClassLookup.put(
        ...
        com.stripe.events.V1CustomerCashBalanceTransactionCreatedEventNotification.class);
    eventClassLookup.put(
    ...
    eventClassLookup.put(
        "v1.tax.settings.updated", com.stripe.events.V1TaxSettingsUpdatedEventNotification.class);
    eventClassLookup.put(
    ...
    eventClassLookup.put(
        ...
        com.stripe.events.V2BillingRateCardCustomPricingUnitOverageRateCreatedEventNotification
            .class);
    eventClassLookup.put(
    ...
    eventClassLookup.put(
        ...
        com.stripe.events.V2CoreAccountSignalsFraudulentWebsiteReadyEventNotification.class);
    eventClassLookup.put(
    ...
    eventClassLookup.put(
        ...
        com.stripe.events.V2CoreClaimableSandboxUpdatedEventNotification.class);
    eventClassLookup.put(
    ...
    eventClassLookup.put(
        ...
        com.stripe.events.V2CoreHealthElementsErrorFiringEventNotification.class);
    eventClassLookup.put(
        "v2.core.health.elements_error.resolved",
        com.stripe.events.V2CoreHealthElementsErrorResolvedEventNotification.class);
    eventClassLookup.put(
    ...
    eventClassLookup.put(
        ...
        com.stripe.events.V2CoreHealthInvoiceCountDroppedFiringEventNotification.class);
    eventClassLookup.put(
        "v2.core.health.invoice_count_dropped.resolved",
        com.stripe.events.V2CoreHealthInvoiceCountDroppedResolvedEventNotification.class);
    eventClassLookup.put(
    ...
    eventClassLookup.put(
        ...
        com.stripe.events.V2CoreHealthMeterEventSummariesDelayedFiringEventNotification.class);
    eventClassLookup.put(
    ...
    eventClassLookup.put(
        ...
        com.stripe.events.V2IamStripeAccessGrantApprovedEventNotification.class);
    eventClassLookup.put(
        "v2.iam.stripe_access_grant.canceled",
        com.stripe.events.V2IamStripeAccessGrantCanceledEventNotification.class);
    eventClassLookup.put(
        "v2.iam.stripe_access_grant.denied",
        com.stripe.events.V2IamStripeAccessGrantDeniedEventNotification.class);
    eventClassLookup.put(
        "v2.iam.stripe_access_grant.removed",
        com.stripe.events.V2IamStripeAccessGrantRemovedEventNotification.class);
    eventClassLookup.put(
        "v2.iam.stripe_access_grant.requested",
        com.stripe.events.V2IamStripeAccessGrantRequestedEventNotification.class);
    eventClassLookup.put(
        "v2.iam.stripe_access_grant.updated",
        com.stripe.events.V2IamStripeAccessGrantUpdatedEventNotification.class);
    eventClassLookup.put(
