...
public class FinancialAddress extends StripeObject implements HasId {
   ...
   * tzs}, {@code uah}, {@code ugx}, {@code usd}, {@code usdc}, {@code usn}, {@code uyi}, {@code
   * uyu}, {@code uzs}, {@code vef}, {@code ves}, {@code vnd}, {@code vuv}, {@code wst}, {@code
   * xaf}, {@code xcd}, {@code xcg}, {@code xof}, {@code xpf}, {@code yer}, {@code zar}, {@code
   * zmk}, {@code zmw}, {@code zwd}, {@code zwg}, or {@code zwl}.
   */
