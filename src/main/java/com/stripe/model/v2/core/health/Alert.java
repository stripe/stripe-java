...
public class Alert extends StripeObject implements HasId {
  ...
  @SerializedName("documentation_links")
  List<Alert.DocumentationLink> documentationLinks;
   ...
   *
   * <p>One of {@code incident}, or {@code standalone}.
   */
   ...
   * object field.
   *
   * <p>Equal to {@code v2.core.health.alert}.
   */
  ...
  /**
   * The time when the user experience has returned to expected levels. Null if the alert is still
   * open.
   */
   ...
   *
   * <p>One of {@code critical}, or {@code non_critical}.
   */
   ...
   *
   * <p>One of {@code open}, or {@code resolved}.
   */
  ...
  public static class ApiError extends StripeObject {
    ...
    List<Alert.ApiError.TopImpactedAccount> topImpactedAccounts;
  ...
  public static class ApiLatency extends StripeObject {
    ...
    /** The top impacted connected accounts (only for platforms). */
    @SerializedName("top_impacted_accounts")
    List<Alert.ApiLatency.TopImpactedAccount> topImpactedAccounts;
  ...
  public static class AuthorizationRateDrop extends StripeObject {
    ...
    List<Alert.AuthorizationRateDrop.Dimension> dimensions;
  ...
  /**
   * For more details about DocumentationLink, please refer to the <a
   * href="https://docs.stripe.com/api">API Reference.</a>
   */
  @Getter
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class DocumentationLink extends StripeObject {
  ...
  public static class PaymentMethodError extends StripeObject {
    ...
    /** The top impacted connected accounts (only for platforms). */
    @SerializedName("top_impacted_accounts")
    List<Alert.PaymentMethodError.TopImpactedAccount> topImpactedAccounts;
