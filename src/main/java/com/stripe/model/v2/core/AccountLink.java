...
public class AccountLink extends StripeObject {
  ...
  public static class UseCase extends StripeObject {
     ...
     *
     * <p>One of {@code account_onboarding}, {@code account_update}, {@code recipient_onboarding},
     * or {@code recipient_update}.
     */
    @SerializedName("type")
    String type;
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class RecipientOnboarding extends StripeObject {
      /**
       * Specifies the requirements that Stripe collects from v2/core/accounts in the Onboarding
       * flow.
       */
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class RecipientUpdate extends StripeObject {
      /**
