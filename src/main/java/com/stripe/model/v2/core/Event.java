 ...
 * most API v1 include a versioned snapshot of an API object in their payload. You can access events
 * through the <a href="https://docs.stripe.com/api/v2/core/events/retrieve">Retrieve Event API</a>
 * for 30 days.
 */
@Getter
@Setter
