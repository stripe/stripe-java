...
public class Topup extends ApiResource implements MetadataStore<Topup>, BalanceTransactionSource {
  ...
  /**
   * Error code explaining reason for top-up failure if available (see <a href="https://stripe.com/docs/api#errors">the errors section</a> for a list of codes).
   */
  ...
  /**
   * The status of the top-up is either {@code canceled}, {@code failed}, {@code pending}, {@code reversed}, or {@code succeeded}.
   *
   * <p>One of {@code canceled}, {@code failed}, {@code pending}, {@code reversed}, or {@code succeeded}.
   */
  ...
  public static Topup retrieve(
    ...
    String url =
      String.format(
        "%s%s",
        Stripe.getApiBase(),
        String.format("/v1/topups/%s", ApiResource.urlEncodeId(topup))
      );
