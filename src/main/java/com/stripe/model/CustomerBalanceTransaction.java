...
public class CustomerBalanceTransaction
  ...
  /**
   * The amount of the transaction. A negative value is a credit for the customer's balance, and a positive value is a debit to the customer's {@code balance}.
   */
  ...
  /**
   * The customer's {@code balance} after the transaction was applied. A negative value decreases the amount due on the customer's next invoice. A positive value increases the amount due on the customer's next invoice.
   */
  ...
  /**
   * Transaction type: {@code adjustment}, {@code applied_to_invoice}, {@code credit_note}, {@code initial}, {@code invoice_too_large}, {@code invoice_too_small}, {@code unspent_receiver_credit}, or {@code unapplied_from_invoice}. See the <a href="https://stripe.com/docs/billing/customer/balance#types">Customer Balance page</a> to learn more about transaction types.
   *
   * <p>One of {@code adjustment}, {@code applied_to_invoice}, {@code credit_note}, {@code initial}, {@code invoice_too_large}, {@code invoice_too_small}, {@code migration}, {@code unapplied_from_invoice}, or {@code unspent_receiver_credit}.
   */
  @SerializedName("type")
  String type;
