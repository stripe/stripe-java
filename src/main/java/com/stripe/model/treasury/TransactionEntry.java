...
public class TransactionEntry extends ApiResource implements HasId {
   ...
   *
   * <p>One of {@code credit_reversal}, {@code credit_reversal_posting}, {@code debit_reversal}, {@code inbound_transfer}, {@code inbound_transfer_return}, {@code issuing_authorization_hold}, {@code issuing_authorization_release}, {@code other}, {@code outbound_payment}, {@code outbound_payment_cancellation}, {@code outbound_payment_failure}, {@code outbound_payment_posting}, {@code outbound_payment_return}, {@code outbound_transfer}, {@code outbound_transfer_cancellation}, {@code outbound_transfer_failure}, {@code outbound_transfer_posting}, {@code outbound_transfer_return}, {@code received_credit}, or {@code received_debit}.
   */
  @SerializedName("type")
  String type;
  ...
  public static TransactionEntry retrieve(
      String id,
      TransactionEntryRetrieveParams params,
      RequestOptions options) throws StripeException {
    String url =
      String.format(
        "%s%s",
   ...
   */
  public static TransactionEntryCollection list(
      TransactionEntryListParams params) throws StripeException {
    return list(params, (RequestOptions) null);
  }
