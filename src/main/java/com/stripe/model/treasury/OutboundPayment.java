...
public class OutboundPayment extends ApiResource implements HasId {
  ...
  /**
   * ID of the <a href="https://stripe.com/docs/api/customers">customer</a> to whom an OutboundPayment is sent.
   */
  ...
  /**
   * The PaymentMethod via which an OutboundPayment is sent. This field can be empty if the OutboundPayment was created using {@code destination_payment_method_data}.
   */
  ...
  /**
   * Current status of the OutboundPayment: {@code processing}, {@code failed}, {@code posted}, {@code returned}, {@code canceled}. An OutboundPayment is {@code processing} if it has been created and is pending. The status changes to {@code posted} once the OutboundPayment has been &quot;confirmed&quot; and funds have left the account, or to {@code failed} or {@code canceled}. If an OutboundPayment fails to arrive at its destination, its status will change to {@code returned}.
   *
  ...
  public static OutboundPayment retrieve(
      String id,
      OutboundPaymentRetrieveParams params,
      RequestOptions options) throws StripeException {
    String url =
      String.format(
        "%s%s",
   ...
   */
  public static OutboundPaymentCollection list(
      OutboundPaymentListParams params) throws StripeException {
    return list(params, (RequestOptions) null);
  }
  ...
  public OutboundPayment cancel(
    ...
    String url =
      String.format(
        ...
        Stripe.getApiBase(),
        String.format(
          "/v1/treasury/outbound_payments/%s/cancel",
   ...
   */
  public OutboundPayment cancel(
      OutboundPaymentCancelParams params,
      RequestOptions options) throws StripeException {
    String url =
      String.format(
        "%s%s",
  ...
  public static class EndUserDetails extends StripeObject {
    /**
     * IP address of the user initiating the OutboundPayment. Set if {@code present} is set to {@code true}. IP address collection is required for risk and compliance reasons. This will be used to help determine if the OutboundPayment is authorized or should be blocked.
     */
    @SerializedName("ip_address")
    String ipAddress;

    /**
     * {@code true`` if the OutboundPayment creation request is being made on behalf of an end user by a platform. Otherwise, }false`.
     */
  ...
  public class TestHelpers {
     ...
     */
    public OutboundPayment fail(
        OutboundPaymentFailParams params,
        RequestOptions options) throws StripeException {
      String url =
        String.format(
          "%s%s",
     ...
     */
    public OutboundPayment post(
        OutboundPaymentPostParams params,
        RequestOptions options) throws StripeException {
      String url =
        String.format(
          "%s%s",
     ...
     */
    public OutboundPayment returnOutboundPayment(
        OutboundPaymentReturnOutboundPaymentParams params) throws StripeException {
      return returnOutboundPayment(params, (RequestOptions) null);
    }
     ...
     */
    public OutboundPayment returnOutboundPayment(
        OutboundPaymentReturnOutboundPaymentParams params,
        RequestOptions options) throws StripeException {
      String url =
        String.format(
          "%s%s",
