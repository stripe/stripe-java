...
public class SetupIntent extends ApiResource implements HasId, MetadataStore<SetupIntent> {
  ...
  /**
   * Reason for cancellation of this SetupIntent, one of {@code abandoned}, {@code requested_by_customer}, or {@code duplicate}.
   */
   ...
   *
   * <p>The client secret can be used to complete payment setup from your frontend. It should not be stored, logged, or exposed to anyone other than the customer. Make sure that you have TLS enabled on any page that includes the client secret.
   */
  ...
  /**
   * <a href="https://stripe.com/docs/payments/intents#intent-statuses">Status</a> of this SetupIntent, one of {@code requires_payment_method}, {@code requires_confirmation}, {@code requires_action}, {@code processing}, {@code canceled}, or {@code succeeded}.
   */
   ...
   *
   * <p>Use {@code on_session} if you intend to only reuse the payment method when the customer is in your checkout flow. Use {@code off_session} if your customer may or may not be in your checkout flow. If not provided, this value defaults to {@code off_session}.
   */
   ...
   *
   * <p>After the SetupIntent is created, attach a payment method and <a href="https://stripe.com/docs/api/setup_intents/confirm">confirm</a>
   ...
   *
   * <p>When retrieved with a publishable key, only a subset of properties will be returned. Please refer to the <a href="https://stripe.com/docs/api#setup_intent_object">SetupIntent</a> object reference for more details.</p>
   */
   ...
   */
  public SetupIntent verifyMicrodeposits(
      SetupIntentVerifyMicrodepositsParams params) throws StripeException {
    return verifyMicrodeposits(params, (RequestOptions) null);
  }
