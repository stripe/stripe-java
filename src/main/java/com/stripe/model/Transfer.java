...
public class Transfer
  ...
  /**
   * The source balance this transfer came from. One of {@code card}, {@code fpx}, or {@code bank_account}.
   */
  ...
  /**
   * <p>To send funds from your Stripe account to a connected account, you create a new transfer object. Your <a href="https://stripe.com/docs/api#balance">Stripe balance</a> must be able to cover the transfer amount, or you’ll receive an “Insufficient Funds” error.</p>
   */
