...
[![Maven Central](https://img.shields.io/badge/maven--central-v32.2.0-beta.2-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
```groovy
implementation "com.stripe:stripe-java:32.2.0-beta.2"
```
