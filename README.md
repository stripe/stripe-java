...
[![Maven Central](https://img.shields.io/badge/maven--central-v33.4.0-alpha.1-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
```groovy
implementation "com.stripe:stripe-java:33.4.0-alpha.1"
```
...
<dependency>
  ...
  <version>33.4.0-alpha.1</version>
</dependency>
```
