...
[![Maven Central](https://img.shields.io/badge/maven--central-v23.7.0-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
- [The Stripe JAR](https://search.maven.org/remotecontent?filepath=com/stripe/stripe-java/23.7.0/stripe-java-23.7.0.jar)
