...
[![Maven Central](https://img.shields.io/badge/maven--central-v32.3.0-alpha.2-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
```groovy
implementation "com.stripe:stripe-java:32.3.0-alpha.2"
```
...
<dependency>
  ...
  <version>32.3.0-alpha.2</version>
</dependency>
```
