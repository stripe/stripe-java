...
[![Maven Central](https://img.shields.io/badge/maven--central-v29.6.0-alpha.1-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
```groovy
implementation "com.stripe:stripe-java:29.6.0-alpha.1"
```
...
<dependency>
  ...
  <version>29.6.0-alpha.1</version>
</dependency>
```
...
- [The Stripe JAR](https://search.maven.org/remotecontent?filepath=com/stripe/stripe-java/29.6.0-alpha.1/stripe-java-29.6.0-alpha.1.jar)
