...
[![Maven Central](https://img.shields.io/badge/maven--central-v33.5.0-alpha.3-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
```groovy
implementation "com.stripe:stripe-java:33.5.0-alpha.3"
```
...
<dependency>
  ...
  <version>33.5.0-alpha.3</version>
</dependency>
```
