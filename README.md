...
[![Maven Central](https://img.shields.io/badge/maven--central-v33.5.0-alpha.5-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
```groovy
implementation "com.stripe:stripe-java:33.5.0-alpha.5"
```
...
<dependency>
  ...
  <version>33.5.0-alpha.5</version>
</dependency>
```
