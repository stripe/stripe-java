...
[![Maven Central](https://img.shields.io/badge/maven--central-v26.0.0-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
- [The Stripe JAR](https://search.maven.org/remotecontent?filepath=com/stripe/stripe-java/26.0.0/stripe-java-26.0.0.jar)
