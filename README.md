...
[![Maven Central](https://img.shields.io/badge/maven--central-v21.13.0-beta.1-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
<dependency>
  ...
  <version>21.13.0-beta.1</version>
</dependency>
```
...
- [The Stripe JAR](https://search.maven.org/remotecontent?filepath=com/stripe/stripe-java/21.13.0-beta.1/stripe-java-21.13.0-beta.1.jar)
