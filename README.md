...
[![Maven Central](https://img.shields.io/badge/maven--central-v22.22.0-beta.1-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
```groovy
implementation "com.stripe:stripe-java:22.22.0-beta.1"
```
...
<dependency>
  ...
  <version>22.22.0-beta.1</version>
</dependency>
```
...
- [The Stripe JAR](https://search.maven.org/remotecontent?filepath=com/stripe/stripe-java/22.22.0-beta.1/stripe-java-22.22.0-beta.1.jar)
