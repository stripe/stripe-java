...
```groovy
implementation "com.stripe:stripe-java:22.18.0-beta.1"
```
...
<dependency>
  ...
  <version>22.18.0-beta.1</version>
</dependency>
```
...
- [The Stripe JAR](https://search.maven.org/remotecontent?filepath=com/stripe/stripe-java/22.18.0-beta.1/stripe-java-22.18.0-beta.1.jar)
