...
[![Maven Central](https://img.shields.io/badge/maven--central-v33.2.0-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
1. The Stripe JAR:
   - Download the latest release version from [Maven Central](https://repo1.maven.org/maven2/com/stripe/stripe-java/33.2.0/stripe-java-33.2.0.jar)
   - Current release version: 33.2.0
