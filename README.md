...
[![Maven Central](https://img.shields.io/badge/maven--central-v25.9.0-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
```groovy
implementation "com.stripe:stripe-java:25.9.0"
```
...
- [The Stripe JAR](https://search.maven.org/remotecontent?filepath=com/stripe/stripe-java/25.9.0/stripe-java-25.9.0.jar)
