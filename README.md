...
```groovy
implementation "com.stripe:stripe-java:25.4.0"
```
...
- [The Stripe JAR](https://search.maven.org/remotecontent?filepath=com/stripe/stripe-java/25.4.0/stripe-java-25.4.0.jar)
