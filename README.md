...
[![Maven Central](https://img.shields.io/badge/maven--central-v31.4.0-alpha.4-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
```groovy
implementation "com.stripe:stripe-java:31.4.0-alpha.4"
```
...
<dependency>
  ...
  <version>31.4.0-alpha.4</version>
</dependency>
```
