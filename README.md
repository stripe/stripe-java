...
[![Maven Central](https://img.shields.io/badge/maven--central-v32.1.0-alpha.1-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
```groovy
implementation "com.stripe:stripe-java:32.1.0-alpha.1"
```
...
<dependency>
  ...
  <version>32.1.0-alpha.1</version>
</dependency>
```
