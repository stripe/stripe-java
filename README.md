...
[![Maven Central](https://img.shields.io/badge/maven--central-v23.1.1-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
- [The Stripe JAR](https://search.maven.org/remotecontent?filepath=com/stripe/stripe-java/23.1.1/stripe-java-23.1.1.jar)
