...
[![Maven Central](https://img.shields.io/badge/maven--central-v25.2.0-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
- [The Stripe JAR](https://search.maven.org/remotecontent?filepath=com/stripe/stripe-java/25.2.0/stripe-java-25.2.0.jar)
