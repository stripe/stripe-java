...
[![Maven Central](https://img.shields.io/badge/maven--central-v22.17.0-beta.3-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
```groovy
implementation "com.stripe:stripe-java:22.17.0-beta.3"
```
...
<dependency>
  ...
  <version>22.17.0-beta.3</version>
</dependency>
```
...
- [The Stripe JAR](https://search.maven.org/remotecontent?filepath=com/stripe/stripe-java/22.17.0-beta.3/stripe-java-22.17.0-beta.3.jar)
