...
[![Maven Central](https://img.shields.io/badge/maven--central-v33.2.0-alpha.1-blue)](https://mvnrepository.com/artifact/com.stripe/stripe-java)
...
```groovy
implementation "com.stripe:stripe-java:33.2.0-alpha.1"
```
...
<dependency>
  ...
  <version>33.2.0-alpha.1</version>
</dependency>
```
